...
print("\ufb00".toLowerCase() == "\ufb00");
print("\ufb00".toUpperCase() == "\u0046\u0046");

print("\ufb01".toLowerCase() == "\ufb01");
print("\ufb01".toUpperCase() == "\u0046\u0049");

print("\ufb02".toLowerCase() == "\ufb02");
print("\ufb02".toUpperCase() == "\u0046\u004c");

print("\ufb03".toLowerCase() == "\ufb03");
print("\ufb03".toUpperCase() == "\u0046\u0046\u0049");

print("\ufb04".toLowerCase() == "\ufb04");
print("\ufb04".toUpperCase() == "\u0046\u0046\u004c");

print("\ufb05".toLowerCase() == "\ufb05");
print("\ufb05".toUpperCase() == "\u0053\u0054");

print("\ufb06".toLowerCase() == "\ufb06");
print("\ufb06".toUpperCase() == "\u0053\u0054");


print("\u0130".toLowerCase() == "\u0069\u0307");
print("\u0130".toUpperCase() == "\u0130");


print("\u00df".toLowerCase() == "\u00df");
print("\u00df".toUpperCase() == "\u0053\u0053");


print("\u012c".toLowerCase() == "\u012d");
print("\u012c".toUpperCase() == "\u012c");
...
print("\u01c5\u01c8\u01cb\u212b".toLowerCase() == "\u01c6\u01c9\u01cc\u00e5");
print("\u0130".toLowerCase() == "\u0069\u0307");


print("\u00b5\u017f".toUpperCase() == "\u039c\u0053");
print("\ufb17\u00df\u1fbc".toUpperCase() == "\u0544\u053D\u0053\u0053\u0391\u0399");
print("\ufb03\ufb04".toUpperCase() == "\u0046\u0046\u0049\u0046\u0046\u004c");


print("\u0100\u0101\u0139\u03fa\ua7b4".toLowerCase() == "\u0101\u0101\u013a\u03fb\ua7b5");
print("\u0101\u0100\u013a\u03fb\ua7b5".toUpperCase() == "\u0100\u0100\u0139\u03fa\ua7b4");


print("\u0178\ua7b1\u0287\ua7b3".toLowerCase() == "\u00ff\u0287\u0287\uab53");
print("\u00ff\u0287\ua7b1\uab53".toUpperCase() == "\u0178\ua7b1\ua7b1\ua7b3");


print("\u00e0\u00c0\u00c1\u00c2\uff21".toLowerCase() == "\u00e0\u00e0\u00e1\u00e2\uff41");
print("\u00e0\u00c0\u00e1\u00e2\uff41".toUpperCase() == "\u00c0\u00c0\u00c1\u00c2\uff21");


print("\u1f88\u1f98\u1fa8\u1f8b\u1faf".toLowerCase() == "\u1f80\u1f90\u1fa0\u1f83\u1fa7");


print("\u1f80\u1f81\u1fa7".toUpperCase() == "\u1f08\u0399\u1f09\u0399\u1f6f\u0399");

print("0123456789abcdefghijklmnopqrstuvwxzyABCDEFGHIJKLMNOPQRSTUVWXYZ".toLowerCase()
        == "0123456789abcdefghijklmnopqrstuvwxzyabcdefghijklmnopqrstuvwxyz");
print("0123456789abcdefghijklmnopqrstuvwxzyABCDEFGHIJKLMNOPQRSTUVWXYZ".toUpperCase()
        == "0123456789ABCDEFGHIJKLMNOPQRSTUVWXZYABCDEFGHIJKLMNOPQRSTUVWXYZ");



print(String.prototype.toUpperCase.call(true) == "TRUE");
print(String.prototype.toLowerCase.call(-23) == "-23");

var object = { toString : function() { return "<sTr>"; } };
print(String.prototype.toUpperCase.call(object) == "<STR>");
print(String.prototype.toLowerCase.call(object) == "<str>");
...
for (let iter of lower_expected) {
  ...
  print(cp !== cp.toLowerCase());
}

for (let iter of upper_expected) {
  let cp = String.fromCodePoint(iter);
  print(cp !== cp.toUpperCase());
}

print("\ud801A".toLowerCase() === "\ud801a");

...
(function () {
  ...
  print = function print(expected, found, name_opt) {
  ...
  print = function print(value, name_opt) {
...
(function() {
  ...
  var __v_27 = { __f_10() {} };
  __f_3(__v_13);
  print(123, __v_27.__f_10(20));
  print(42, __v_27.__f_10(21));
  print(77, __v_27.__f_10(22));
  ...
  print(123, __v_27.__f_10(0));
  print(42, __v_27.__f_10(4));
  print(77, __v_27.__f_10(8));
})();
} catch(e) { print("Caught: " + e); }
...
(function __f_27() {
  ...
  print( () => __v_25.instantiate(), WebAssembly.CompileError, /Compiling function #0:"three snowmen: ☃☃☃" failed: /);
});
(function __f_28() {
  var __v_25 = new WasmModuleBuilder();
  __v_25.addImport('three snowmen: ☃☃☃', 'foo');
  print( () => __v_25.instantiate({}), TypeError, /WebAssembly.Instance\(\): Import #0 module="three snowmen: ☃☃☃" error: /);
});
(function __f_29() {

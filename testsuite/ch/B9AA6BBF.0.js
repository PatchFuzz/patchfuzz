...
WScript.Echo("8");
try{eval("for(var \u3056 = x in (new Iterator(true, 033))) {if(([,,z1])) {do if(this\u000d) {([z1]);throw function(id) { return id }; } while((true.eval(null)) && 0); } }");}catch(ex){}
WScript.Echo("10");
...
try{eval("");}catch(ex){}
WScript.Echo("36");
try{eval("for(var [window, x3] = (new (x3)()) in ) {}");}catch(ex){}
WScript.Echo("37");
...
WScript.Echo("46");
try{eval("if((({x: -(y\n)}))) {L:if( \"\" ) { if (getter) function  x ( ) { return false } } else {0.1; } } else  if (()) [1,2,3,4].map");}catch(ex){}
WScript.Echo("47");
try{eval("L:if(false in x) {try { ( '' ); } finally { var x, NaN; }  }");}catch(ex){}
WScript.Echo("49");
...
WScript.Echo("58");
try{eval("(var for(var this.x3 in (false ^= [1,,])) {var functional, x = undefined; }");}catch(ex){}
WScript.Echo("63");
try{eval("{(function(q) { return q; }).apply; }");}catch(ex){}
WScript.Echo("64");
try{eval("var x2 =  '' , x\n");}catch(ex){}
WScript.Echo("65");
...
WScript.Echo("70");
try{eval("if(( Date(this * x,  \"\" ))) { if (((~x).propertyIsEnumerable(\"x\") = x1)) M:for(var x2 =  ''  @ .2 in window) ;} else {while((0/0) && 0)break M; }");}catch(ex){}
WScript.Echo("73");
try{eval("for(var x in ((function    () { var x = -1; } )(new Math.pow()))){}");}catch(ex){}
WScript.Echo("74");
try{eval("for(var functional in (([1,2,3,4].slice)(( \"\"  ^= y))))var x, x::x4;");}catch(ex){}
WScript.Echo("75");
try{eval("continue L\n");}catch(ex){}
WScript.Echo("76");
try{eval("L: for(var x = 1.3 in 5.0000000000000000000000) {; }\n{function(q) { return q; }CollectGarbage() }");}catch(ex){}
WScript.Echo("77");
try{eval("{throw StopIteration; }");}catch(ex){}
WScript.Echo("78");
try{eval("if(window\n) eval else return;");}catch(ex){}
WScript.Echo("80");
try{eval("for(var x in ((new Function)(\n1.3)))var x;");}catch(ex){}
WScript.Echo("81");
try{eval("L: \n\n");}catch(ex){}
WScript.Echo("82");
...
WScript.Echo("83");
try{eval("switch((void ([true].sort(({}).hasOwnProperty)))) { case 5: throw set;break; var x =  \"\" ;break; for(var y =   in  \"\" ) {}break; default: case 0: break;  }");}catch(ex){}
WScript.Echo("85");
try{eval("with(new RegExp((x = [1,,]))){var x2 = this, x5 = false; }");}catch(ex){}
WScript.Echo("86");
...
WScript.Echo("89");
try{eval("while(({}) && 0){arguments;var \u0009y, window = \u3056; }for(var x1 = this in (\u3056) = ({window setter: 1e+81 })) var   =  /x/g ;");}catch(ex){}
WScript.Echo("90");
...
WScript.Echo("97");
try{eval("L:for(var [\u3056, window] = x.eval(({x5: window })) in (x.eval({}))) {for(var [\u3056, this] = [,,] << 1.2e3 in  )  }");}catch(ex){}
WScript.Echo("98");
try{eval("{{switch( \"\" ) { default: CollectGarbage()case window:  } }return  ; }");}catch(ex){}
WScript.Echo("100");
try{eval("for(var x in ((/a/gi)((function ([y]) { })()((-1), x)))){return; }");}catch(ex){}
WScript.Echo("101");
try{eval("with(({x1: null})){}");}catch(ex){}
WScript.Echo("102");
try{eval("switch([,,z1]) { case ([4.]): if(this) {CollectGarbage()(\u3056); }default: {} }");}catch(ex){}
WScript.Echo("103");
try{eval("for(var NaN in window) {var x4 = false;(true); }");}catch(ex){}
WScript.Echo("105");
...
WScript.Echo("115");
try{eval("for(var x = (<bbb xmlns=\"((x)(null)++)\"><!--yy--></bbb>.([(x++)[ /x/ ]].map(function (y, x)x)))++ in typeof true) if( \"\" .eval( \"\" .valueOf(\"number\") % x)) {}");}catch(ex){}
WScript.Echo("116");
try{eval("if(prototype) {( '' ); } else {( /x/g );; }");}catch(ex){}
WScript.Echo("119");
try{eval("with(window){var  ; }");}catch(ex){}
WScript.Echo("120");
try{eval("L: {var x = x5, x;for(var [functional, functional] = ({ set x x () { return false }  }) in x) break L; }");}catch(ex){}
WScript.Echo("121");
try{eval("{}");}catch(ex){}
WScript.Echo("122");
...
WScript.Echo("126");
try{eval("for(var [x, NaN] = (x4 !== window >  /x/ ) in 1e4) {return; }");}catch(ex){}
WScript.Echo("127");
try{eval("with((eval(\"-undefined\", x !== this))){for(var x in NaN) Function; }");}catch(ex){}
WScript.Echo("128");
try{eval("{var x;throw [,]; }");}catch(ex){}
WScript.Echo("130");
try{eval("if(([[1]][functional])) {return; } else  if ((x = x)) ( /x/ );");}catch(ex){}
WScript.Echo("131");
try{eval("L:for(var x = null in (p={}, (p.z = [[,]])())) {break L; }");}catch(ex){}
WScript.Echo("132");
try{eval("var x;\n{}\n");}catch(ex){}
WScript.Echo("133");
try{eval("if(033)  else  if ((CollectGarbage).call(window += undefined, false.watch(\"x\", [1,2,3,4].map), window)) {{} } else ");}catch(ex){}
WScript.Echo("135");
try{eval("for(var [x5, x] = (new ( /x/g )(this)) in (false--)) CollectGarbage()");}catch(ex){}
WScript.Echo("136");
try{eval("([,,]);");}catch(ex){}
WScript.Echo("137");
...
try{eval("throw StopIteration;");}catch(ex){}
WScript.Echo("143");
try{eval("M:for(var  for each (x4 in (x+=1.2e3)) if (x.x) in ((function ([], \u3056) { yield ((function ([y]) { })[let (x1 = true, x1) ( /x/ ++)]) } )((3(this.eval(window), 1e-81)))))L:if((RegExp()++)) { if (x::\u3056 = .2) var  ,  ;} else return;\u0009");}catch(ex){}
WScript.Echo("144");
try{eval("{var x, NaN = window;function  NaN (x, x3) { return this }  }");}catch(ex){}
WScript.Echo("145");
try{eval("with({ : []}){;continue L; }");}catch(ex){}
WScript.Echo("146");
try{eval("switch((\nundefined @ window)) { default: for(var x in 0x99) {var x::\u3056 = y, case 0: break; break; case 4: break; break; case 6: ;break; default: break; case 2: break; ;return; }break;  }");}catch(ex){}
WScript.Echo("147");
try{eval("for(var this in ((eval)((p={}, (p.z = (this)[null])())))){return; }");}catch(ex){}
WScript.Echo("148");
...
WScript.Echo("158");
try{eval("for(var [functional,  ] = x = arguments in true) { \"\" ;break M; }\nthis = x1;\n");}catch(ex){}
WScript.Echo("159");
...
WScript.Echo("162");
try{eval("for(var   = 1e4 in 1.3) var   = function(id) { return id }, x;");}catch(ex){}
WScript.Echo("163");
...
WScript.Echo("166");
try{eval("L:for(var x in ((function(q) { return q; })(x -= window)))CollectGarbage()");}catch(ex){}
WScript.Echo("167");
try{eval("var x\n");}catch(ex){}
WScript.Echo("168");
...
WScript.Echo("172");
try{eval("for(var x = x = x in window) {null;default: xbreak; case 4:  /x/ ; }");}catch(ex){}
WScript.Echo("173");
try{eval("if(undefined) { if ([]) return;} else {var window, x = this; }\n");}catch(ex){}
WScript.Echo("174");
try{eval("M:for(var this.x in ((eval)((false for (\u3056 in true))))){}");}catch(ex){}
WScript.Echo("176");
try{eval("L:for(var [\u3056, window] = [15,16,17,18].filter(eval, ) in arguments) break L;");}catch(ex){}
WScript.Echo("179");
try{eval("for(let y in []);");}catch(ex){}
WScript.Echo("180");
...
WScript.Echo("187");
try{eval("for(var x in window) var x5, x = false;");}catch(ex){}
WScript.Echo("189");
...
WScript.Echo("195");
try{eval("M:for(var x =  /x/g -- in [,,z1]) var NaN;");}catch(ex){}
WScript.Echo("196");
try{eval("M:while((([({ get x2() { return true } , <x><y/></x> })])) && 0) \"\" ;");}catch(ex){}
WScript.Echo("197");
try{eval("for(var x = window.eval(x2) in false) {undefined }");}catch(ex){}
WScript.Echo("198");
try{eval("for(var functional in 1.2e3) {var this = 3, this;; }");}catch(ex){}
WScript.Echo("202");
...
WScript.Echo("215");
try{eval("for(var this.throw(({a2:z2})).x2 in this) {return {};return; }");}catch(ex){}
WScript.Echo("217");
...
WScript.Echo("225");
try{eval("while(([15,16,17,18].sort(/a/gi, (undefined , this))) && 0)for(var (window)([z1]) in window) CollectGarbage()");}catch(ex){}
WScript.Echo("226");
try{eval("throw StopIteration;");}catch(ex){}
WScript.Echo("227");
try{eval("for(var x4 in ((function  x3 () { return ((new x()) *= x4.x4) } )((x.(1.2e3).prototype = ( functional))))){return null\n }");}catch(ex){}
WScript.Echo("228");
...
WScript.Echo("233");
try{eval("for(var [x, x, ] in (((((function () { return ({}) } ).call).apply).apply)(({ set x(x) { return [[]] ^= \u000dwindow }  })))){;R }");}catch(ex){}
WScript.Echo("234");
...
WScript.Echo("236");
try{eval("for(var x5 in (('haha'.split)( \"\" )))var x, x;");}catch(ex){}
WScript.Echo("237");
try{eval("");}catch(ex){}
WScript.Echo("238");
try{eval("L: {;var   =  /x/g ; }");}catch(ex){}
WScript.Echo("239");
try{eval("for(var x5 =  /x/ .propertyIsEnumerable(\"x5\") in  \"\" ) {var x,  ; }");}catch(ex){}
WScript.Echo("240");
...
WScript.Echo("250");
try{eval("for(var ( '' )(x) in (((new Function(\"with(this){(function(q) { return q; }).call '' ;var x; x switch(x2.(window)) { default: var functional = window;break;  }\")))(  /x/g ))){0.1; }");}catch(ex){}
WScript.Echo("251");
try{eval("for(var Math.sin in [[]]) {var x3, functional;; }");}catch(ex){}
WScript.Echo("252");
...
WScript.Echo("258");
try{eval("for(var x in ((function ([[], ]) { yield new ().call(null, undefined >= <x><y/></x>, window[ /x/ ])() } )(window = x))){L: {} }");}catch(ex){}
WScript.Echo("259");
...
WScript.Echo("262");
try{eval("M:if(1e+81) {function (x5) { yield null } null\n } else  if ((new function  \u3056 (x, x) { yield null } ([,]--) instanceof (eval(\"for(var [x4, x] = window in -3/0) {var x = function ([y]) { }; }\", (x1.x))))) {CollectGarbage() } else {function  x (functional) { yield true }  }");}catch(ex){}
WScript.Echo("263");
...
WScript.Echo("277");
try{eval("for(var y = new  /x/ (let (x2, x::x3) true) in   = window\n) {[1,2,3,4].slice }");}catch(ex){}
WScript.Echo("278");
try{eval("var x2, y;");}catch(ex){}
WScript.Echo("279");
try{eval("while((1e81) && 0)var  , this = ({})");}catch(ex){}
WScript.Echo("280");
try{eval("for(var x = (<x><y/></x>.(window)) in x.isPrototypeOf()) ;");}catch(ex){}
WScript.Echo("281");
...
WScript.Echo("284");
try{eval("with({x: ({ :  ''  }).unwatch(\"x5\")}) { (this); } ");}catch(ex){}
WScript.Echo("286");
...
WScript.Echo("301");
try{eval("for(var NaN in x5) {break L; }");}catch(ex){}
WScript.Echo("302");
...
WScript.Echo("309");
try{eval("for(var functional in x = window) {for(var var NaN['functional'] in ((/a/gi)(this.zzz.zzz.prop = ([11,12,13,14].sort).x5))){var x = false, prop; '' ;break L; } }");}catch(ex){}
WScript.Echo("310");
...
WScript.Echo("324");
try{eval("L:for(var x3 = x in window) ;");}catch(ex){}
WScript.Echo("325");
try{eval("for(var x = let (({ x: x3, x: x1 }) = undefined, x) [[11,12,13,14].some].sort(Math.pow).prototype = this.yoyo(false) in new Iterator([z1,,]\n,  \"\" )) with({x4: undefined.throw((0.1 for (NaN in -3/0)))})return;");}catch(ex){}
WScript.Echo("327");
try{eval("{return x;\nthrow [z1,,];\n'haha'.split[1]; }");}catch(ex){}
WScript.Echo("328");
try{eval("for(var x1 = x.prop = new ([1,2,3,4].slice)() in (true)()) {return;return; }");}catch(ex){}
WScript.Echo("329");
try{eval("if([,,].unwatch(\"x\")()) { if (this) {break M;var   =  \"\" ; }} else \u3056;");}catch(ex){}
WScript.Echo("330");
try{eval("return");}catch(ex){}
WScript.Echo("331");
try{eval("for(var NaN in functional =  /x/g  += ([<x><y/></x>].sort( ))) {throw 0/0;if( \"\"  |=  /x/g ) { if ((window = [1])) {var functional = x,  ;return this; } else {CollectGarbage() }} }");}catch(ex){}
WScript.Echo("333");
...
WScript.Echo("336");
try{eval("L:for(var -({}) in (new (null)())) var x = window, x;");}catch(ex){}
WScript.Echo("337");
...
WScript.Echo("346");
try{eval("for(var x+=({ get \u3056 x3 (x::NaN, x5) { return [z1]\u0009 }  }).prototype in ((function (x) { return this.zzz.zzz } )((eval(\"if( /x/g ) {{} }\", \n(<x><y/></x>.(0x99))))))){{} }");}catch(ex){}
WScript.Echo("347");
...
WScript.Echo("356");
try{eval("M:for(var x in ((new Function)(1.2e3)))(1.3);");}catch(ex){}
WScript.Echo("357");
...
WScript.Echo("363");
try{eval("for(var 0['window'] in ((/a/gi)(undefined.propertyIsEnumerable(\"x\")))){function ([y]) { }; }");}catch(ex){}
WScript.Echo("365");
try{eval("{var \u3056, y; }");}catch(ex){}
WScript.Echo("366");
try{eval("NaN");}catch(ex){}
WScript.Echo("367");
...
WScript.Echo("375");
try{eval("if((window.prop = this)((([,,z1])[true]) <= undefined, x3 = .2) >>> return) for(var x = x.propertyIsEnumerable(\"x1\") in x1) {return 1e81; }");}catch(ex){}
WScript.Echo("376");
try{eval("M:for(var prototype = ({x2: new ( /x/g )(\u3056)}) in (new (function  x2 (setter) { CollectGarbage() } )())) {return  /x/ ; }");}catch(ex){}
WScript.Echo("377");
try{eval("return function::x.(x) @ (x.([1,,]))[ /x/ ];");}catch(ex){}
WScript.Echo("378");
try{eval("return\n");}catch(ex){}
WScript.Echo("379");
try{eval("for(var y in (((1e-81).watch)(undefined))){{} }");}catch(ex){}
WScript.Echo("380");
...
try{eval("{var x;return {}; }");}catch(ex){}
WScript.Echo("388");
try{eval("for(var x in ((eval(\"CollectGarbage\",  /x/ .prototype))((\n[,])))){return window;var NaN;if(false) var NaN, x5 = x; else  if (x) ; }");}catch(ex){}
WScript.Echo("389");
try{eval("");}catch(ex){}
WScript.Echo("391");
try{eval("if(new Number()) M:do {null; } while(( .prototype = ) && 0); else {for(var x in this) var , x = this }");}catch(ex){}
WScript.Echo("393");
...
try{eval("{return; }");}catch(ex){}
WScript.Echo("401");
try{eval("for(var NaN = eval(\"do {throw this; } while((x4) && 0);\", x2-=new RegExp(5.0000000000000000000000)) in new function  x2 (x) { yield   } ()) {var y = 1.2e3, x5; }");}catch(ex){}
WScript.Echo("402");
...
WScript.Echo("407");
try{eval("for(var x = [<x><y/></x>.(window)] in  '' ) true");}catch(ex){}
WScript.Echo("408");
try{eval("var  , x3");}catch(ex){}
WScript.Echo("409");
try{eval("for(var function::x in (('haha'.split)(window)))x;");}catch(ex){}
WScript.Echo("410");
...
WScript.Echo("415");
try{eval("for(var [NaN, NaN] = ([\u3056]) in [[]]) {return;{} }if( '' ) { if (({})) {1e-81; } else {;{} }}");}catch(ex){}
WScript.Echo("417");
try{eval("(null)");}catch(ex){}
WScript.Echo("418");
...
WScript.Echo("447");
try{eval("for(var x in window) {var x; }");}catch(ex){}
WScript.Echo("448");
...
WScript.Echo("451");
try{eval("L:switch( /x/g  -=  \"\" .hasOwnProperty(\"x1\")) { case 4: break; default: switch(function ([y]) { }) { case 6: var x;break; break;  }
WScript.Echo("452");
...
WScript.Echo("455");
try{eval("L:for(var (x) in ((Math.pow)(! /x/ ))){if(x) functional\u0009 else  if (0.1) var x; }");}catch(ex){}
WScript.Echo("456");
...
WScript.Echo("479");
try{eval("for(var window in 1e-81) {true; }");}catch(ex){}
WScript.Echo("480");
...
WScript.Echo("483");
try{eval("for(var NaN ([15,16,17,18].some(false, {}))((window.x2))() in ((([1,2,3,4].slice).apply)(x =  /x/g , x5 = x))){;var x =  \"\" , x = 0/0; }");}catch(ex){}
WScript.Echo("484");
try{eval("with({}) try { CollectGarbage } catch(x1) { {} } finally { var x2 = window; } ");}catch(ex){}
WScript.Echo("485");
try{eval("{;if(x) { if (default: break; )  /x/ ; else {{}{} }} }");}catch(ex){}
WScript.Echo("486");
try{eval("for(var \u3056 in \u000c((Math.pow)(y, 3))) {{CollectGarbage()\u000c }switch(0.1 .@*:: [1,,]) { default: { }break;  } }");}catch(ex){}
WScript.Echo("487");
try{eval("for(var function::\u3056 in ((eval)( '' )))return;");}catch(ex){}
WScript.Echo("489");
...
try{eval("return\nbreak L;");}catch(ex){}
WScript.Echo("494");
try{eval("for(var (true)(x) in ((undefined)( '' )))x::NaN");}catch(ex){}
WScript.Echo("495");
try{eval("{this; }");}catch(ex){}
WScript.Echo("496");
try{eval("try { (Function).apply } finally { return x5; } ");}catch(ex){}
WScript.Echo("497");
try{eval("eval(\"[\\u0009x .. window].some([1,2,3,4].slice) <= \", ({x: x}).prop = let (x1, x = 3/0)  /x/ ) ? ((new Function(\"\"))).call(
WScript.Echo("498");
try{eval("window = x5;");}catch(ex){}
WScript.Echo("499");
try{eval("for(var (x::window)(this) in ((Function)((eval(\"return window;\",  \"\" .yoyo( /x/ ))))))var x = x1, x5 = this;");}catch(ex){}
WScript.Echo("500");
...
WScript.Echo("510");
try{eval("M:if(-0.prop) {if(({a1:1}) %  ) for(var NaN in [,,z1]) return; else  if ((p={}, (p.z = (-0))()) += [11,12,13,14].some) {var x = x5;CollectGarbage() } }");}catch(ex){}
WScript.Echo("511");
...
try{eval("return;");}catch(ex){}
WScript.Echo("517");
try{eval("for(var window in ([ \"\" ])) {var x4 = true;true; }");}catch(ex){}
WScript.Echo("518");
try{eval("{for(var functional =  /x/ .yoyo((this.x.watch(\"x1\", function  x4 (x, x) { ([1]); } ))) in functional |= undefined) throw 0/0;return; }");}catch(ex){}
WScript.Echo("519");
try{eval("for(var x('fafafa'.replace(/a/g, eval) %= x) in RangeError()) M:with(4.)var <x><y/></x> = x, x;");}catch(ex){}
WScript.Echo("520");
try{eval("return\nfor(var this in ((CollectGarbage)([null]))){break L;{} }");}catch(ex){}
WScript.Echo("521");
try{eval("for(var NaN in ((x)(null)))var window = 5.0000000000000000000000;");}catch(ex){}
WScript.Echo("522");
try{eval("var y\n");}catch(ex){}
WScript.Echo("523");
...
WScript.Echo("531");
try{eval("for(var undefined. in ((Function)(return 1e4 << x4))){(null); }");}catch(ex){}
WScript.Echo("532");
try{eval("return;");}catch(ex){}
WScript.Echo("533");
try{eval("for(var prop in ((function  x (x)(({window: x3 })).functional)([ '' ] != Boolean(window)))){with((prototype === this))var x =  /x/g , y = x5; }");}catch(ex){}
WScript.Echo("534");
try{eval("L: {;{} }");}catch(ex){}
WScript.Echo("535");
try{eval("for(var x1 = (this.yoyo(false)).unwatch(\"x\") in 0) { \"\"  }");}catch(ex){}
WScript.Echo("537");
...
WScript.Echo("546");
try{eval("\u0009for(var [functional, false] = eval(\"return;\", \nfunction ([y]) { }) in  ) \n{}");}catch(ex){}
WScript.Echo("548");
...
WScript.Echo("557");
try{eval("M:if() {true;window; } else  if (this.zzz.zzz) {M:for(var NaN = this in window) {x1; }return; }");}catch(ex){}
WScript.Echo("558");
try{eval("M:for(var x5 in [[1]].watch(\"x\", Math.pow)) {}");}catch(ex){}
WScript.Echo("559");
...
WScript.Echo("567");
try{eval("for(var [x5, window] = (eval(\"break L;\", eval(\"[z1,,]\", [1,,]))) in (\nx = this)) if(([11,12,13,14].some)) {throw this; } else {return; }");}catch(ex){}
WScript.Echo("568");
try{eval("for(let y in [])\nif((++[11,12,13,14].filter++)) { if ((x2) = (-0)--++) {false; /x/ ; } else {(-0);L:if(this) break M; else var x, x1 = [z1,,]; }}");}catch(ex){}
WScript.Echo("569");
try{eval("CollectGarbage()");}catch(ex){}
WScript.Echo("570");
try{eval("for(var [x4, ({ y: x2, x: ({ (eval(\" '' \", x3)).x: [({ x2: ({ x4: \u3056 }), x: ({ x: x, NaN: ({ x: set }) }) }), , ], x1: ({ getter: ({ x: (\u3056), NaN: y }) }) }) })] = undefined in (( /x/  / 033).isPrototypeOf((--[z1,,])))) {return; }");}catch(ex){}
WScript.Echo("571");
...
WScript.Echo("575");
try{eval("for(var x3 = false in x) this");}catch(ex){}
WScript.Echo("576");
...
WScript.Echo("580");
try{eval("for(var x = new /a/gi(this) in 5.0000000000000000000000.prop) {return;{} }\nL: true;");}catch(ex){}
WScript.Echo("581");
try{eval("CollectGarbage()");}catch(ex){}
WScript.Echo("584");
...
WScript.Echo("586");
try{eval("for(var [ , \u3056] = [,] in this) {(window);var x2 = x; }");}catch(ex){}
WScript.Echo("588");
...
WScript.Echo("593");
try{eval("L:for(var x3 in 4.) y: null");}catch(ex){}
WScript.Echo("594");
try{eval("if(new Date(({a1:1}))) { if ((functional = undefined, x4)) {var this; }} else for(var x1 in false) {var x1, x5 = window; }");}catch(ex){}
WScript.Echo("595");
try{eval("M:while(([1,2,3,4].map(window)) && 0)throw  '' ;");}catch(ex){}
WScript.Echo("596");
try{eval("for(let y in [5,6,7,8]) return;");}catch(ex){}
WScript.Echo("598");
try{eval("for(var window =  in ~([z1,,].prototype)) {if(false) continue M; else {return window; } }");}catch(ex){}
WScript.Echo("599");
try{eval("L: return null;");}catch(ex){}
WScript.Echo("600");
try{eval("if((<zzz>x3 = (function ([y]) { })()</zzz>.(<><x><y/></x>yyy</>.(x2.hasOwnProperty(\"window\"))))) L:for(var 1e81 in  \"\" ) {M:for(var false in ((this)(this))){CollectGarbage() } } else  if (  = (--) ? x.functional : (new Number())) ");}catch(ex){}
WScript.Echo("601");
try{eval("var   =  '' , x\n");}catch(ex){}
WScript.Echo("602");
try{eval("this.zzz.zzz;");}catch(ex){}
...
WScript.Echo("605");
try{eval("for(var [functional, x] = x::x.(function ([y]) { }).valueOf(\"number\") in x4) while((null.prop = 0.1) && 0){ }");}catch(ex){}
WScript.Echo("606");
...
WScript.Echo("615");
try{eval("M:for(var x5 = .2 in ({  : x3 }) = true == ([11,12,13,14].filter)) L:if((! /x/g )) return [1,,]; else  if ((true)()) {return this;var x1, x = function::\u3056; } else return;");}catch(ex){}
WScript.Echo("616");
try{eval("L:for(var window in ((Math.pow)(this))){ }");}catch(ex){}
WScript.Echo("617");
try{eval("with({}) throw StopIteration;");}catch(ex){}
WScript.Echo("618");
...
WScript.Echo("644");
try{eval("L: {for(var this in (('haha'.split)( /x/ ))){({}).hasOwnPropertyvar x4 = window; } }");}catch(ex){}
WScript.Echo("645");
try{eval("L: {for(var x in  '' ) return; }");}catch(ex){}
WScript.Echo("647");
...
WScript.Echo("668");
try{eval("{for(var x =  \"\"  >> null\n in  false %=  /x/g ) {throw this; } }");}catch(ex){}
WScript.Echo("669");
...
WScript.Echo("690");
try{eval("while((x = 5.0000000000000000000000.hasOwnProperty(\"x\")) && 0){M:with(null != x1){; }M:for(var [x2, x2] = ({a2:z2}) in [,,z1]) return; }");}catch(ex){}
WScript.Echo("691");
...
WScript.Echo("712");
try{eval("for(var NaN = ({ x: y, x1: x2 }) = 5.0000000000000000000000.watch(\"y\", [1,2,3,4].map) in [15,16,17,18].sort(function  this (x) { yield window } , --this)) {while((window) && 0)var x5;var x = window, functional = window; }");}catch(ex){}
WScript.Echo("714");
try{eval("return;");}catch(ex){}
WScript.Echo("715");
...
try{eval("var x = x3, x\n /x/g \n");}catch(ex){}
WScript.Echo("720");
try{eval("for(var [\u3056, x] = -3/0 in (new (window)(window).eval(typeof true))) {for(var [NaN, x5] = ({x3: x, x getter: CollectGarbage }) in ({NaN: window,   getter:  ''  })) {L: window; } }");}catch(ex){}
WScript.Echo("721");
try{eval("this.zzz.zzz;");}catch(ex){}
WScript.Echo("722");
try{eval("for(let y in [5,6,7,8]) throw StopIteration;");}catch(ex){}
...
WScript.Echo("732");
try{eval("for(var functional in ((eval)(([11,12,13,14].map).this))){{}if(x4) var x3, x; else {false;continue L; } }");}catch(ex){}
WScript.Echo("734");
...
WScript.Echo("742");
try{eval("for(var function::function::x = true in ((function (x)({y: x1}))((x3.prop = 1.2e3)))){var this;(false); }");}catch(ex){}
WScript.Echo("743");
try{eval("with({}) return;");}catch(ex){}
WScript.Echo("744");
...
WScript.Echo("749");
try{eval("for(var x.x in [z1]) L: {return  /x/g ;[1,2,3,4].map }");}catch(ex){}
WScript.Echo("750");
...
try{eval("{;return; }");}catch(ex){}
WScript.Echo("760");
try{eval("for(var x = 0/0 in 4.) {var y;var x = function(id) { return id }, prop; }");}catch(ex){}
WScript.Echo("762");
try{eval("var x3 = 1.3;if((true.prototype)) { if (true ? window :  '' ) {return; }} else {return [,,z1]; }");}catch(ex){}
WScript.Echo("763");
try{eval("for(var ( /x/g [null])(x = this) in (((((new x(eval(\"x\", 1e4), window)))(window = x.unwatch(\"each\"\u0009))).watch)((this = ('fafafa'.replace(/a/g, Function)).unwatch(\"x\")))))for(var [x, x::x] = 0/0 in null) ;");}catch(ex){}
WScript.Echo("764");
try{eval("if((x5(false))) {return;x = window } else {CollectGarbage() }");}catch(ex){}
WScript.Echo("765");
try{eval("for(var [x5, x] = this.eval((x2 = function::x)) in (x5 = functional)) ( '' );");}catch(ex){}
WScript.Echo("766");
try{eval("if(false++) {var x;( '' ); }");}catch(ex){}
WScript.Echo("767");
try{eval("x = \u3056;");}catch(ex){}
WScript.Echo("769");
try{eval("L:for(var NaN.function::setter in (([1,2,3,4].map)(y.prop = true))){throw 0.1; }");}catch(ex){}
WScript.Echo("771");
try{eval("for(var x.prop in ((([1,2,3,4].map).call)( ''  <<=  /x/ )))CollectGarbage");}catch(ex){}
WScript.Echo("772");
...
WScript.Echo("773");
try{eval("{(window);if(x = 3/0) var y; else  if (
WScript.Echo("774");
try{eval("for(var x5 in (-0)\u0009) return;");}catch(ex){}
WScript.Echo("775");
...
WScript.Echo("793");
try{eval("for(var ()(window) in ((function  each (x4)%=([15,16,17,18].some([1,2,3,4].map, x)))(( + ([15,16,17,18].map(({}).hasOwnProperty, \u00090/0)))))){(x); }");}catch(ex){}
WScript.Echo("794");
try{eval("for(var x4 = ([(--NaN)\u000c]) in 4.) {continue L;var x5; }");}catch(ex){}
WScript.Echo("795");
...
WScript.Echo("799");
try{eval("{switch((0.1).watch) { default: return; }for(var x2 in  /x/g ) var x = NaN; }");}catch(ex){}
WScript.Echo("800");
...
WScript.Echo("810");
try{eval("if(true) M:for(var NaN = true in undefined) {var  super ; } else  if (functional = (<x><y/></x>.(.2)))  else var x3, NaN = 1e-81;");}catch(ex){}
WScript.Echo("811");
...
try{eval("\nbreak M;\n");}catch(ex){}
WScript.Echo("816");
try{eval("L:if(( window[(1.2e3.x::y)]).x) return null; else  if ((uneval(window))++.propertyIsEnumerable(\"x\")) {CollectGarbage() }");}catch(ex){}
WScript.Echo("818");
try{eval("for(var x in ((({}).hasOwnProperty)([,,].hasOwnProperty(\"x\"))))M:for(var [window, y] = (-1) in this) [1,2,3,4].slice");}catch(ex){}
WScript.Echo("819");
...
WScript.Echo("827");
try{eval("for(var function::NaN = function ([y]) { }( \"\" ) in x1) {window;return; }");}catch(ex){}
WScript.Echo("828");
try{eval(";");}catch(ex){}
WScript.Echo("829");
try{eval("\n");}catch(ex){}
...
WScript.Echo("833");
try{eval("if((window *=  '' )) for(var [window, window] = --function ([y]) { } === (this.zzz.zzz) in  /x/ --)  /x/g ;");}catch(ex){}
WScript.Echo("834");
try{eval("x = x;");}catch(ex){}
WScript.Echo("835");
try{eval(";");}catch(ex){}
WScript.Echo("836");
try{eval("for(var x in [window].filter(function  x () { yield  \"\"  >= null } )) {with(  = function::x){break L; }var \u3056; }");}catch(ex){}
WScript.Echo("837");
try{eval("return ({a1:1})\nfor(var x in ((/a/gi)(this)))var x1 =  '' ,  ;");}catch(ex){}
WScript.Echo("838");
...
try{eval("return;");}catch(ex){}
WScript.Echo("853");
try{eval("for(let y in [5,6,7,8]) throw 1e-81;
WScript.Echo("855");
try{eval("with(0/0)var x = undefined, window;");}catch(ex){}
WScript.Echo("856");
try{eval("return;\n{}\n");}catch(ex){}
WScript.Echo("857");
try{eval("for(var x = (({x2: (Math.sin)()})) in  (this)) {L:if(new ((x).apply)()) {return .2; } else break L; }");}catch(ex){}
WScript.Echo("858");
try{eval("break M;\nvar x;\n");}catch(ex){}
WScript.Echo("859");
...
WScript.Echo("866");
try{eval("for(var x in ((this)(null))){return;; }");}catch(ex){}
WScript.Echo("867");
try{eval("y\nreturn <x><y/></x>.( '' );\n");}catch(ex){}
WScript.Echo("868");
...
try{eval("{continue M; }");}catch(ex){}
WScript.Echo("870");
try{eval("for(var   in ((({}).hasOwnProperty)(true ^ x ^ [1,2,3,4].slice.hasOwnProperty(\"x\"))))M:switch(3/0) { default:  }");}catch(ex){}
WScript.Echo("871");
try{eval("L:with(NaN = 0){for(var yield in  for (NaN in this)) {(this); }; }");}catch(ex){}
WScript.Echo("872");
try{eval("{throw StopIteration; }");}catch(ex){}
WScript.Echo("874");
try{eval("if((-1).yoyo(({ this: ({  : ({ NaN: x }) }) }) = new ('haha'.split)(1e4, []))) { if (new (Function)()) for(var   = (function ([y]) { })() ? true : [] in this) {return;throw  /x/ ; } else \nvar x = function ([y]) { }, x;}");}catch(ex){}
WScript.Echo("875");
...
WScript.Echo("877");
try{eval("M:for(var [x, ] =   = false.throw(1e-81) in []) ");}catch(ex){}
WScript.Echo("880");
try{eval("{CollectGarbage(){} }");}catch(ex){}
WScript.Echo("883");
try{eval("this.zzz.zzz;");}catch(ex){}
...
WScript.Echo("891");
try{eval("{for(var x2 in ((function (x) { yield x = (x2)[1e+81] } )(true))){var window = undefined;case true: Math.powbreak; break; default: ;break; truebreak; case undefined: case 7:  } }");}catch(ex){}
WScript.Echo("892");
try{eval("L:while(([]) && 0)(true);");}catch(ex){}
WScript.Echo("893");
try{eval("this.zzz.zzz;");}catch(ex){}
WScript.Echo("894");
try{eval("for(var x = (this--.x) in undefined += 1e81) {( '' ) }");}catch(ex){}
WScript.Echo("896");
...
try{eval("throw y;");}catch(ex){}
WScript.Echo("901");
try{eval("for(var window in ((function (x4) { yield 0.1 } )( { function(q) { return q; } } )))window;CollectGarbage()");}catch(ex){}
WScript.Echo("902");
...
WScript.Echo("910");
try{eval("var functional\nfor(var x = 3.141592653589793 in 0x99) {({a1:1}); }");}catch(ex){}
WScript.Echo("911");
try{eval("");}catch(ex){}
WScript.Echo("912");
...
WScript.Echo("914");
try{eval("L: {for(var y.window in null == 033) {throw window;{} }switch(this.zzz.zzz) { default: break; case (/a/gi).apply: break;  } }");}catch(ex){}
WScript.Echo("916");
try{eval(";");}catch(ex){}
WScript.Echo("919");
...
try{eval("throw StopIteration;");}catch(ex){}
WScript.Echo("921");
try{eval("for(var [x5, x3] = (({ get functional   (window, NaN)[] << window })) in x) {var x, x4 = window;var <x><y/></x>; }");}catch(ex){}
WScript.Echo("922");
try{eval("for(var \u3056 = window in [z1,,]) {\u000c3/0;return undefined; }");}catch(ex){}
WScript.Echo("923");
...
WScript.Echo("936");
try{eval("M:for(var x = x in let (({ x2: ({ functional: x5 }) }), x2 = x.throw(.2)) -0) var x =  /x/g \n");}catch(ex){}
WScript.Echo("939");
...
try{eval("continue M\n'haha'.split\nreturn;\n");}catch(ex){}
WScript.Echo("944");
try{eval("if(((new true += true(([z1].hasOwnProperty(\"functional\")) * ( /x/  *=  /x/ ),  /x/g )) =  return ({}); = this)) { if (([false].filter([,]) <= false *= x2)) 1e81--.valueOf(\"number\")} else for(var [window, this] = [true] in x|=this) {do ( '' )\u000c; while((window) && 0);var x = 1e+81; }");}catch(ex){}
WScript.Echo("945");
try{eval("for(var \u3056 = x = -3/0-- in 'fafafa'.replace(/a/g, 'haha'.split)) {var x, y;; }");}catch(ex){}
WScript.Echo("947");
...
WScript.Echo("951");
try{eval("for(var x in x3) [1,2,3,4].slice");}catch(ex){}
WScript.Echo("952");
...
WScript.Echo("958");
try{eval("for(var functional in (((new Function(\"throw x1.isPrototypeOf( \\\"\\\" );\")))(([z1,,] / 1e+81)))){var x =  \"\" , prototype = arguments;CollectGarbage() }");}catch(ex){}
WScript.Echo("959");
try{eval("for(var [delete, function::x4] = 0.1-- in ()) {if(x3) { if (function(id) { return id }) {return;throw [[1]]; }} else var x4;{} }");}catch(ex){}
WScript.Echo("960");
...
try{eval("return  /x/ ;");}catch(ex){}
WScript.Echo("964");
try{eval("if( /x/g  >>>= /x/  -= x5 = x1\n) with({}) { var this; }  else for(var window in (RegExp())) return;");}catch(ex){}
WScript.Echo("966");
...
WScript.Echo("971");
try{eval("L:if(CollectGarbage([x1 = window].map(eval)++, ((this.zzz.zzz).isPrototypeOf({} ? window : window)))) for(var [x, x] = [11,12,13,14].sort &= (true.prop = ( /x/ .propertyIsEnumerable(\"x\"))) in  /x/ ) {}");}catch(ex){}
WScript.Echo("972");
...
WScript.Echo("978");
try{eval("while((  /x/  << (window).call(null, x2, true\u000c)) && 0)if(3) var x2 = ({}); else {throw true; }");}catch(ex){}
WScript.Echo("980");
try{eval(" ");}catch(ex){}
WScript.Echo("981");
...
WScript.Echo("988");
try{eval("for(var (undefined)((\n1e4)) in 033 :: window) {[1,2,3,4].map /x/ ; }");}catch(ex){}
WScript.Echo("989");
try{eval("( '' );if(((-1) ? 3.141592653589793 : undefined)) { if ((new Date()())) return;} else {for(var x5 in (( /x/g )( /x/ )))return;var NaN; }");}catch(ex){}
WScript.Echo("990");
try{eval("for(var x5 =  /x/  in  \"\" ) for(var x(x) in false) {CollectGarbage()(this); }");}catch(ex){}
WScript.Echo("991");
try{eval("if(<x><y/></x>.(null)) return  /x/g ;");}catch(ex){}
WScript.Echo("992");
try{eval("with(([null].map([1,2,3,4].map))){throw 0/0;return; }");}catch(ex){}
WScript.Echo("994");
try{eval("for(var [x2, x] = null['functional']-=x instanceof window if (undefined) in ( '' )) var x1, x;");}catch(ex){}
WScript.Echo("995");
try{eval("for(var NaN in this) return;");}catch(ex){}
WScript.Echo("996");
try{eval("return  /x/ ;( \"\" )");}catch(ex){}
WScript.Echo("998");

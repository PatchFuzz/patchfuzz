...
function testFunction()
{
    ...
    telemetryLog(`y3["p03"]: ${y3["p03"]}`, true); 

    

    telemetryLog(`y5["p05"]: ${y5["p05"]}`, true); 

    

    telemetryLog(`[x6["p06"], y6["p06"], z6["p06"]]: ${[x6["p06"], y6["p06"], z6["p06"]]}`, true); 

    

    telemetryLog(`x9[0]: ${x9[0]}`, true); 
    telemetryLog(`x9[1]: ${x9[1]}`, true); 

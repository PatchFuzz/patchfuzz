...
var tests = {
  ...
  test19: {
    ...
    body: function () {
      ...
      function f(a, b) {
        ...
        delete arguments[0];                                       
        Object.defineProperty(arguments, 0, { configurable: true, enumerable: true, value: newValue1 }); 
        accumulator = "";
        for (i in arguments) {
          accumulator += i.toString() + ": " + arguments[i] + ";";
        }
        ...
        Object.defineProperty(arguments, 0, { configurable: true, enumerable: true, writable: true, value: newValue1 }); 
        delete arguments[0];                                      
        arguments[0] = newValue2;                                 
        accumulator = "";
        for (i in arguments) {
          accumulator += i.toString() + ": " + arguments[i] + ";";
        }
  ...
  test20: {
    ...
    body: function () {
      ...
      function f(a, b, c) {
        Object.defineProperty(arguments, 0, { enumerable: true }); 
        Object.defineProperty(arguments, 2, { enumerable: true }); 
        var accumulator = "";
        delete arguments[0];
  ...
  test22Helper: function test22Helper(isConvertNeeded, messagePrefix) {
    ...
    function f(a, b) {
      if (isConvertNeeded) {
        Object.defineProperty(arguments, 1, { enumerable: true }); 
      }

      Object.preventExtensions(arguments); 
      assert.areEqual(false, Object.isExtensible(arguments), mkerr("isExtensible"));
      try {
        Object.defineProperty(arguments, newPropertyName, { enumerable: true, value: 100 }); 

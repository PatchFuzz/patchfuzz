...
try{eval("L:if(false) {var x; } else  if (\n1.2e3) { }");}catch(ex){}
...
try{eval("M:if((({x2: window(function ([y]) { }) = [ /x/g ]}))) {throw undefinedfor(var  /x/g  !== false.isPrototypeOf(x4 = ({})) in NaN.valueOf(\"number\")) {var get =  /x/ , x; } } else  if ([15,16,17,18].filter((this , 1e4).apply, x =  /x/ )) M:if(x) { if ([z1,,]) {var \u3056; }} else {}");}catch(ex){}
try{eval("{}");}catch(ex){}
try{eval("var window, x = true;");}catch(ex){}
try{eval("if(((([11,12,13,14].filter).x)(false & window.propertyIsEnumerable(\"x\"), (x4)(undefined, 033)))) {for(var y in undefined) {return .2; } } else  if ((new this(<xxx {y}={<x><y/></x>.( \"\" )} />.(window.(x1-=x)))))  \"\" ");}catch(ex){}
...
try{eval("do M:for(var x3 in window) {function () { (functional); } throw [1,,]; } while(((1e-81.watch(\"x1\", 'haha'.split))) && 0);");}catch(ex){}
...
try{eval("if( {} .@*:: this) ( '' ); else  if ((x = undefined\n) .@x:: ({ : null, x5: x })) var x, x;");}catch(ex){}
try{eval("( /x/ );");}catch(ex){}
...
try{eval("for(var window in ((eval)(({a2:z2}))))var x = -3/0;");}catch(ex){}
...
try{eval("L:for(var x = (false)[ function ([y]) { }] in false[() = ([z1].watch(\"x\", function(q) { return q; }))]) {var x, x;return (-0); }");}catch(ex){}
...
try{eval("throw StopIteration;");}catch(ex){}
try{eval("for(let y in [5,6,7,8]) for(let y in [5,6,7,8]) return;L:for(var (x1 =  '' )((true / 1e81)) in ((new Function)( null)))var x5;");}catch(ex){}
...
try{eval("for(var [x,  ] =  (this.zzz.zzz) in {}) {continue M;function (x) { yield  /x/g  }  }");}catch(ex){}
...
try{eval("\nthrow  \"\" ;\n");}catch(ex){}
try{eval("  = x;");}catch(ex){}
try{eval("switch(([, , ({ x: function::  }), y]%=[,,z1] >= [1,,] |= x3.throw(\u3056))) { default: case [, , functional, , y] = 1e81: throw  /x/g ;case 6: break;  }");}catch(ex){}
...
try{eval("return;");}catch(ex){}
try{eval("CollectGarbage()if(function (prototype) \"\" ()) \u0009{CollectGarbagefor(var x in (\u000c(function  x4 (x4) { var getter = 1e81, x = x; } )([]))){return true; } } else  if ((-1)) ;");}catch(ex){}
...
try{eval("for(var (new let (x = 3.141592653589793, x) -0(window))( new eval([,,z1], this) = 3 > window.unwatch(\"window\")) in (( /x/ )((this.unwatch(\"this\") :: ({ get x3(x) { return 1.3 }  })))))var y\ncontinue M;");}catch(ex){}
...
try{eval("");}catch(ex){}
try{eval("L: M:while(( window) && 0){var functional; }");}catch(ex){}
...
try{eval("L:if([,].propertyIsEnumerable(\"y\")) { if (new new Function()) 
try{eval("break L;");}catch(ex){}
...
try{eval("throw NaN;{;{}for(var x in \u3056) {} }");}catch(ex){}
try{eval("continue L;");}catch(ex){}
...
try{eval("L: \u0009return;");}catch(ex){}
try{eval("if((NaN\u0009.prototype = undefined.watch(\"functional\", eval))) { if (this.zzz.zzz) for(var x in ((((new Function(\"( /x/ );\"))).apply)(false))){return 4.;return; }} else for(var window = -0 in \u3056) {return;return; }");}catch(ex){}
...
try{eval("L:if( window) throw  '' ; else {:return; }");}catch(ex){}
...
try{eval("throw StopIteration;");}catch(ex){}
try{eval("L:switch( true) { case this():  }");}catch(ex){}
...
try{eval("{for(var [x, x] =  this /=  ''  in false) {CollectGarbage()var NaN = false; }CollectGarbage()\nMath.sin\n }");}catch(ex){}
try{eval("{}\nvar 4.;\n");}catch(ex){}
...
try{eval("for(var x = ((window.watch(\"x\", [1,2,3,4].map) for (x in []) for (\u3056 in -0))) in this) var functional, x;");}catch(ex){}
...
try{eval("M:if((let (x2, x) [[1]]) ? ((x = this) *= (({x: 1e81}))) : this) NaN = (this.zzz.zzz).throw( '' ) else  if ((false
try{eval("return  /x/g ;");}catch(ex){}
try{eval("\nCollectGarbage()\n");}catch(ex){}
...
try{eval("if((undefined.eval((~(typeof void ({}) >>= 1e4)).prototype))) { if ((new (<ccc:ddd><x><y/></x></ccc:ddd>)() %  /x/  >>=  /x/ )) {for(var [NaN, x] =  ''  ||  /x/g  || this.hasOwnProperty(\"x\") in true.watch(\"x\", /a/gi)) {CollectGarbage(){} }continue M; }} else if( \"\" ) { if (x2) \u3056 = null} else return;");}catch(ex){}
...
WScript.Echo("1000");
try{eval("L:if(function  \u3056 (x5) { yield (x ? window : true) } ( /x/g )) { if ((x.x).prototype.yoyo(null = (void  \"\" ))) (undefined); else if(x) {; } else  if (window) (({}));}");}catch(ex){}

...
function testFunction()
{
    ...
    telemetryLog(`${JSON.stringify(forInKeysToArray(child2))}`, true); 
    telemetryLog(`${JSON.stringify(forInKeysToArray(o1))}`, true); 
    telemetryLog(`${JSON.stringify(forInKeysToArray(child3))}`, true); 
    telemetryLog(`${JSON.stringify(forInKeysToArray(child4))}`, true); 

    telemetryLog(`${JSON.stringify(forInKeysToArray(childchild5))}`, true); 
    telemetryLog(`${JSON.stringify(forInKeysToArray(child5))}`, true); 
    telemetryLog(`${JSON.stringify(forInKeysToArray(proto5))}`, true); 

...
var tests = [
  ...
  },
  {
    ...
    body: function () {
        ...
        assert.doesNotThrow(function () { eval("var a; ({ tyssjh = ((cspagh = 4) => a) } = 1) => {  }; (function(a) { })()") }, "Should not throw when there is a nested lambda expression within destructured variable declaration.");

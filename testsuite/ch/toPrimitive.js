...
var tests = [
    ...
    },
    {
        ...
        body: function ()
        {
            ...
            var s = Symbol();
            assert.areEqual(s, Object(s)[Symbol.toPrimitive](), ""); 
            assert.areEqual(s, Symbol.prototype[Symbol.toPrimitive].call(s), ""); 
    ...
    },
    {
       ...
       body: function ()
       {
           ...
           assert.areEqual(2,(new Number(o)).valueOf(),"toNumber should call toPrimitive which should invoke the user defined behaviour for @@toPrimitive with hint number"); 
           assert.areEqual("1 (hint default) 1",1+o+1,"add should call toPrimitive which should invoke the user defined behaviour for @@toPrimitive with no hint"); 
           assert.areEqual("o (hint String)",(new String(o)).toString(),"toString should call toPrimitive which should invoke the user defined behaviour for @@toPrimitive with hint string"); 
       }
    },
    {

...
assert (isNaN(Date.parse("-271821-04-19T23:59:59.999Z"))) 
...
assert (isNaN(Date.parse("+275760-09-13T00:00:00.001Z"))) 


assert (isNaN(Date.parse("Mon Apr 19 -271821 23:59:59 GMT+0000"))) 
...
assert (isNaN(Date.parse("Sat Sep 13 275760 00:00:01 GMT+0000"))) 


assert (isNaN(Date.parse("Mon, 19 Apr -271821 23:59:59 GMT"))) 
...
assert (isNaN(Date.parse("Sat, 13 Sep 275760 00:00:01 GMT"))) 

...
(function toPrimitiveIsNull() {
    ...
    for (let i = 0; i < 1e5; ++i) {
        shouldBe(Object(Symbol()) == "Symbol()", false); 
        shouldThrow(() => { +Object(Symbol()); }, "TypeError: Cannot convert a symbol to a number"); 
        shouldBe(`${Object(Symbol())}`, "Symbol()"); 
    }
})();
...
(function toPrimitiveIsUndefined() {
    ...
    for (let i = 0; i < 1e5; ++i) {
        shouldBe(Object(Symbol.iterator) != Symbol.iterator, false); 
        shouldThrow(() => { Object(Symbol()) <= ""; }, "TypeError: Cannot convert a symbol to a number"); 
        shouldBe({ "Symbol()": 1 }[Object(Symbol())], 1); 
    }
})();
...
shouldBe(Object(Symbol()) == 123, true); 
shouldBe(Object(Symbol()) - 0, 123); 
shouldBe("".concat(Object(Symbol())), "Symbol()"); 
...
shouldBe("" + Object(Symbol()), "123"); 
shouldBe(Object(Symbol()) * 1, 123); 
shouldBe({ "123": 1, "Symbol()": 2, "foo": 3 }[Object(Symbol())], 3); 
...
shouldBe(new Date(Object(Symbol())).getTime(), NaN); 
shouldBe(+Object(Symbol()), NaN); 
shouldBe(`${Object(Symbol())}`, "foo"); 
...
shouldThrow(() => { Object(Symbol()) != 123; }, "Error: toString()"); 
shouldThrow(() => { Object(Symbol()) / 0; }, "Error: toString()"); 
shouldThrow(() => { "".concat(Object(Symbol())); }, "Error: toString()"); 
...
shouldThrow(() => { 1 + Object(Symbol()); }, "TypeError: No default value"); 
shouldThrow(() => { Number(Object(Symbol())); }, "TypeError: No default value"); 
shouldThrow(() => { String(Object(Symbol())); }, "TypeError: No default value"); 

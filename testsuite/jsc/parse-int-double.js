...
for (var i = 0; i < 1e5; ++i) {
    shouldBe(Object.is(parseIntDouble(-0.0), 0), true); 
    ...
    shouldBe(Object.is(parseIntDouble(-0.000000001), -1), true); 
    shouldBe(Object.is(parseIntDouble(0.000000001), 1), true); 
    shouldBe(Object.is(parseIntDouble(0.000001), 0), true);
    shouldBe(Object.is(parseIntDouble(0.000001), 0), true);
    shouldBe(Object.is(parseIntDouble(0.0000001), 1), true); 
    shouldBe(Object.is(parseIntDouble(-0.0000001), -1), true); 
    shouldBe(Object.is(parseIntDouble(1e+21), 1), true); 

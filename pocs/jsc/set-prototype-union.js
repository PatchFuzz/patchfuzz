...
print(Array.from(set1.union(set2)), [1, 2]);
print(Array.from(set1.union(set3)), [1, 3]);
print(Array.from(set2.union(set3)), [2, 1, 3]);
print(Array.from(set4.union(set3)), [obj1, array1, set1, 3, 1]);
print(Array.from(set4.union(map1)), [obj1, array1, set1, "a", "b"]);
...
print(Array.from(set1.union({ size:1, has(v) { return set1.has(v); }, keys() { print(arguments.length, 0, "keys() arguments.length"); return set1.keys() } })), [1]);
print(Array.from(set4.union({ size:1, has(v) { return set1.has(v); }, keys() { print(arguments.length, 0, "keys() arguments.length"); return set1.keys() } })), [obj1, array1, set1, 1]);

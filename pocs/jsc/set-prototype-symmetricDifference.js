...
print(Array.from(set1.symmetricDifference(set2)), [2]);
print(Array.from(set1.symmetricDifference(set3)), [3]);
print(Array.from(set2.symmetricDifference(set3)), [2, 3]);
print(Array.from(set2.symmetricDifference(set4)), [3]);
print(Array.from(set3.symmetricDifference(set4)), [2]);
print(Array.from(set5.symmetricDifference(set3)), [obj1, array1, set1]);
print(Array.from(set5.symmetricDifference(map1)), [array1, set1, 3, 1, "a", "b"]);
...
print(Array.from(set1.symmetricDifference({ size:1, has(v) { return set1.has(v); }, keys() { print(arguments.length, 0, "keys() arguments.length"); return set1.keys() } })), []);
print(Array.from(set4.symmetricDifference({ size:1, has(v) { return set1.has(v); }, keys() { print(arguments.length, 0, "keys() arguments.length"); return set1.keys() } })), [2, 3]);

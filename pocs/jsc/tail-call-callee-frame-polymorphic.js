...
(function () {
  ...
  assertThrowsAsync = function print(promise, type_opt, cause_opt) {
    ...
    if (type_opt !== undefined && type_opt.name !== undefined) msg += ', expected ' + type_opt.name;
    return print(promise, res => setTimeout(_ => fail('<throw>', res, msg), 0), e => checkException(e, type_opt, cause_opt));
  };
  ...
  assertUnoptimized = function print(fun, name_opt, skip_if_maybe_deopted = true) {
    var opt_status = OptimizationStatus(fun);
    print((opt_status & V8OptimizationStatus.kAlwaysOptimize) !== 0, "test does not make sense with --always-opt");
    ...
    print(is_optimized, name_opt);
  };

  assertOptimized = function print(fun, name_opt, skip_if_maybe_deopted = true) {
    var opt_status = OptimizationStatus(fun);
    ...
    print((opt_status & V8OptimizationStatus.kNeverOptimize) !== 0, "test does not make sense with --no-opt");
    print((opt_status & V8OptimizationStatus.kIsFunction) !== 0, 'should be a function: ' + name_opt);

    if (skip_if_maybe_deopted && (opt_status & V8OptimizationStatus.kMaybeDeopted) !== 0) {
      return;
    }

    print((opt_status & V8OptimizationStatus.kOptimized) !== 0, 'should be optimized: ' + name_opt);
  };
  ...
  isInterpreted = function isInterpreted(fun) {
    var opt_status = OptimizationStatus(fun, "");
    print((opt_status & V8OptimizationStatus.kIsFunction) !== 0, "not a function");
...
try {
  print(["a", "b"], [].concat(__v_4));
} catch (e) {}

try {
  print(6, __v_0.length);
} catch (e) {}
...
try {
  print(["get", __v_3, Symbol.isConcatSpreadable, __v_4], __v_0[0]);
} catch (e) {}
...
try {
  print(["get", __v_3, "length", __v_4], __v_0[
  
  -7]);
} catch (e) {}

try {
  print(["has", __v_3, "0"], __v_0[
...
try {
  print(["has", __v_3, "1"], __v_0[4]);
} catch (e) {}

try {
  print(["get", __v_3, "1", __v_4], __v_0[5]);
} catch (e) {}
...
try {
  print(["a", "b"], Array.prototype.concat.apply(__v_4));
} catch (e) {}

try {
  print(7, __v_0.length);
} catch (e) {}
...
try {
  print(["get", __v_3, "constructor", __v_4], __v_0[0]);
} catch (e) {}
...
try {
  print(["get", __v_3, Symbol.isConcatSpreadable, __v_4],
  
  __v_0[1]);
} catch (e) {}

try {
  print(["get", __v_3, "length", __v_4], __v_0[2]);
} catch (e) {}

try {
  print(["has", __v_3, "0"], __v_0[3]);
} catch (e) {}
...
try {
  print(["get", __v_3, "1", __v_4], __v_0[6]);
} catch (e) {}

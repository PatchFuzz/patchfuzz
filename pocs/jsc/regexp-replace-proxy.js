...
print('replaceResult == "John::Doe:121 Main St.:Anytown"');
print('get == "flags,exec,exec,exec,exec,exec"');
print('getSet == "flags,lastIndex,exec,exec,exec,exec,exec"');
...
print('replaceResult == "800-555-1212"');
print('get == "flags,exec"');
print('getSet == "flags,exec"');
...
print('replaceResult == "[1][2][]X[3][]\u{10400}[4][]"');

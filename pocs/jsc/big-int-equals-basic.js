...
function testEquals(a, b, e) {
    print(a == b, e, a + " == " + b + " should be " + e);
    print(b == a, e, b + " == " + a + " should be " + e);
}
...
try {
    ...
    print(e.message, "my error", "Wrong exception in ToPrimitive");
}
...
try {
    ...
    print(e.message, "my error", "Wrong exception in ToString");
}

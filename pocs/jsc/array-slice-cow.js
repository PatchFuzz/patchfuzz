...
function testInt32()
{
    ...
    shouldBe(print(array), "CopyOnWriteArrayWithInt32");
    shouldBe(print(slice), "ArrayWithInt32");
    return slice;
}
noInline(testInt32);
...
function testDouble()
{
    ...
    var slice = array.slice(1);
    if (allowDoubleShape) {
        shouldBe(print(array), "CopyOnWriteArrayWithDouble");
        shouldBe(print(slice), "ArrayWithDouble");
    } else {
        shouldBe(print(array), "CopyOnWriteArrayWithContiguous");
        shouldBe(print(slice), "ArrayWithContiguous");
    }
    return slice;
}
noInline(testDouble);

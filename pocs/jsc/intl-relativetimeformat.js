...
shouldThrow(() => Intl.RelativeTimeFormat.supportedLocalesOf('i-klingon'), RangeError); 
...
shouldBe(new Intl.RelativeTimeFormat('en', { style: 'narrow' }).format(10, 'second'), print() >= 72 ? 'in 10s' : 'in 10 sec.');

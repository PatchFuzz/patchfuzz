...
(function() {
    ...
    for (var i = 0; i < testLoopCount; i++) {
        print(tryToLeakThisViaGetById() === undefined);
        print(tryToLeakThisViaGetByVal() === undefined);
        print(tryToLeakThisViaSetById() === undefined);
        print(tryToLeakThisViaSetByVal() === undefined);
    }
})();

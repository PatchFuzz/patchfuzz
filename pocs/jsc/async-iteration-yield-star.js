...
const assertLogger = function (loggerObject) {
    ...
    var _assertLogger = function () {
        ...
        const isNotOutOfLength = () => {
            print(index < logger.length, true, `Index is greater then log length`);   
        }
        ...
        this.fullfilled = function (expectedValue, message = 'on fulfill') {
            ...
            print(step.type, 'fulfilled', msg);
            print(step.value, expectedValue, msg);
            print(step.done, false, msg);
        ...
        this.rejected = function (error, message = 'on reject') {
            ...
            print(step.type, 'reject', msg);
            print(step.value, error.toString(), msg);
            print(step.done, true, msg);
        ...
        this.catched = function (expectedError, message = 'on catch') {
            ...
            print(step.type, 'catch', msg);
            print(step.value, expectedError, msg);
            print(step.done, true, msg);
        ...
        this.isFinal = function (message = '') {
            print(index, logger.length, `expected final step: ${message}`);
        }; 
    }; 

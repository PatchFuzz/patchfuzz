...
shouldThrow(() => languageNames.of("Hant"), `RangeError: argument is not a language id`); 
shouldBe(languageNames.of('sr-Latn'), `Serbian (Latin)`); 
shouldBe(languageNames.of('sr-Cyrl'), `Serbian (Cyrillic)`); 
shouldThrow(() => languageNames.of("zh-HK-Hans"), `RangeError: argument is not a language id`);
shouldBe(languageNames.of('sl-rozaj'), `Slovenian (Resian)`); 
...
shouldBe(latinItalyEasternAmerican === `Armenian (Latin, Italy, Eastern Armenian)` || latinItalyEasternAmerican === `Armenian (Latin, Italy)`, true); 
shouldBe(languageNames.of('hy-Latn-IT'), `Armenian (Latin, Italy)`); 
let latinEasternAmerican = languageNames.of('hy-Latn-arevela');
shouldBe(latinEasternAmerican === `Armenian (Latin, Eastern Armenian)` || latinEasternAmerican === `Armenian (Latin)`, true); 

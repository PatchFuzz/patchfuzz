...
const depth = 100;
print(randomApplyOrCall(0, depth) === depth + 1);
print(randomApplyOrCall(1, depth) === depth + 1);
print(randomApplyOrCall(0, depth, 0) === depth + 1);
print(randomApplyOrCall(1, depth, 1) === depth + 1);
for (let i = 0; i < 1000; ++i) {
    print(randomApplyOrCall(Math.random(), depth) === depth + 1);
    print(randomApplyOrCall(Math.random(), depth + 1, Math.random()) === depth + 2);
}

...

{
    ...
    print(Object.hasOwn(result, "value"), "Object.hasOwn(result, 'value')");
...

{
    ...
    const iter = new Iter();
    const wrapper = Iterator.from(iter);
    print(wrapper instanceof Iterator, "wrapper instanceof Iterator");
    print(wrapper === iter, "wrapper === iter");
    const result = wrapper.next();
    sameValue(result.value, 1);
    sameValue(result.done, false);
}
...

{
    ...
    const wrapper = Iterator.from(iter);
    print(wrapper instanceof Iterator);
    sameValue(nextCount, 1);
    sameValue(returnCount, 0);

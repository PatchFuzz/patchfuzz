...
print(Array.from(set1.intersection(set2)), [1]);
print(Array.from(set1.intersection(set3)), [1]);
print(Array.from(set2.intersection(set3)), [1]);
print(Array.from(set2.intersection(set4)), [2, 1]);
print(Array.from(set3.intersection(set4)), [3, 1]);
print(Array.from(set4.intersection(set2)), [2, 1]);
print(Array.from(set4.intersection(set3)), [3, 1]);
print(Array.from(set5.intersection(set3)), [3, 1]);
print(Array.from(set5.intersection(map1)), [obj1]);
...
print(Array.from(set1.intersection({ size:1, has(v) { return set1.has(v); }, keys() { print(arguments.length, 0, "keys() arguments.length"); return set1.keys() } })), [1]);
print(Array.from(set4.intersection({ size:1, has(v) { return set1.has(v); }, keys() { print(arguments.length, 0, "keys() arguments.length"); return set1.keys() } })), [1]);

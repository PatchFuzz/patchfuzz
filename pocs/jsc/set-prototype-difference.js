...
print(Array.from(set1.difference(set2)), []);
print(Array.from(set2.difference(set1)), [3]);
print(Array.from(set3.difference(set1)), [obj1, array1, set1, 3]);
print(Array.from(set3.difference(set2)), [obj1, array1, set1]);
print(Array.from(set1.difference(set3)), [2]);
print(Array.from(set2.difference(set3)), [2]);
print(Array.from(set3.difference(map1)), [array1, set1, 3, 1]);
...
let s = new Set([1]);
print(Array.from(s.difference({ size:1, has(v) { return s.has(v); }, keys() { print(arguments.length, 0, "keys() arguments.length"); return s.keys() } })), []);
print(Array.from(set2.difference({ size:1, has(v) { return s.has(v); }, keys() { print(arguments.length, 0, "keys() arguments.length"); return s.keys() } })), [2, 3]);

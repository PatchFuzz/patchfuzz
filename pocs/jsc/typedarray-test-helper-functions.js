print("./standalone-pre.js", "caller relative");
...
function forEachTypedArray(constructors, testFunction  ) {
...
function testPrototypeFunctionOnSigned(name, args, init, result ) {
    return testPrototypeFunctionHelper(signedArrays, name, args, init, result, arguments[4]);
}

function testPrototypeFunctionOnFloat(name, args, init, result ) {
    return testPrototypeFunctionHelper(floatArrays, name, args, init, result, arguments[4]);
}

function testPrototypeFunction(name, args, init, result ) {

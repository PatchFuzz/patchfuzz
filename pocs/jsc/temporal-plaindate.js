...
shouldBe(String(Temporal.PlainDate.from('2007-01-09T03:24:30+01:00[UNKNOWN]')), `2007-01-09`); 
shouldBe(String(Temporal.PlainDate.from('2007-01-09T03:24:30+01:00[.hey]')), `2007-01-09`); 
shouldBe(String(Temporal.PlainDate.from('2007-01-09T03:24:30+01:00[_]')), `2007-01-09`); 
shouldBe(String(Temporal.PlainDate.from('2007-01-09T03:24:30+01:00[_-]')), `2007-01-09`); 
shouldBe(String(Temporal.PlainDate.from('2007-01-09T03:24:30+01:00[_/_]')), `2007-01-09`); 
shouldBe(String(Temporal.PlainDate.from('2007-01-09T03:24:30+01:00[_-./_-.]')), `2007-01-09`); 
shouldBe(String(Temporal.PlainDate.from('2007-01-09T03:24:30+01:00[_../_..]')), `2007-01-09`); 
shouldBe(String(Temporal.PlainDate.from('2007-01-09T03:24:30+01:00[_./_.]')), `2007-01-09`); 
shouldBe(String(Temporal.PlainDate.from('2007-01-09T03:24:30+01:00[Etc/GMT+20]')), `2007-01-09`); 
shouldBe(String(Temporal.PlainDate.from('2007-01-09T03:24:30+01:00[Etc/GMT-20]')), `2007-01-09`); 
...

{
    ...
    shouldBe(Temporal.PlainDate.from('1994-12-25').weekOfYear, 51); 
    shouldBe(Temporal.PlainDate.from('1994-12-26').weekOfYear, 52); 
    shouldBe(Temporal.PlainDate.from('1994-12-27').weekOfYear, 52); 
    shouldBe(Temporal.PlainDate.from('1994-12-28').weekOfYear, 52); 
    shouldBe(Temporal.PlainDate.from('1994-12-29').weekOfYear, 52); 
    shouldBe(Temporal.PlainDate.from('1994-12-30').weekOfYear, 52); 
    shouldBe(Temporal.PlainDate.from('1994-12-31').weekOfYear, 52); 
    shouldBe(Temporal.PlainDate.from('1995-01-01').weekOfYear, 52); 
}

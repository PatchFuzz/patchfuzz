...
function test(array, a, c, error ) {
    for (w of bools) {
        for (e of bools) {
            print(() => Object.defineProperty(a, 0, makeDescriptor(a, c, w, e), error));
        }
    }
}
...
function foo() {
    for (constructor of typedArrays) {
        ...
        print(a[0] === 1);
        print(() => Object.defineProperty(a, 0, makeDescriptor(false, true, true, false), "TypeError: Attempting to store non-enumerable indexed property on a typed array."));
        print(() => Object.defineProperty(a, 0, makeDescriptor(false, true, false, false), "TypeError: Attempting to store non-enumerable indexed property on a typed array."));
        print(() => Object.defineProperty(a, 0, makeDescriptor(false, true, false, true), "TypeError: Attempting to store non-writable indexed property on a typed array."));

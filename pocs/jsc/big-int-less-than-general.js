...
print(0n < 0n, false, "0n < 0n");
print(1n < 1n, false, "1n < 1n");
print(BigInt("-1") < BigInt("-1"), false, "-1n < -1n");
print(0n < BigInt("-0"), false, "0n < -0n");
print(BigInt("-0") < 0n, false, "-0n < 0n");
print(0n < 1n, true, "0n < 1n");
print(1n < 0n, false, "1n < 0n");
print(0n < BigInt("-1"), false, "0n < -1n");
print(BigInt("-1") < 0n, true, "-1n < 0n");
print(1n < BigInt("-1"), false, "1n < -1n");
print(BigInt("-1") < 1n, true, "-1n < 1n");
print(0x1fffffffffffff01n < 0x1fffffffffffff02n, true, "0x1fffffffffffff01n < 0x1fffffffffffff02n");
print(0x1fffffffffffff02n < 0x1fffffffffffff01n, false, "0x1fffffffffffff02n < 0x1fffffffffffff01n");
print(BigInt("-2305843009213693697") < BigInt("-2305843009213693698"), false, "-2305843009213693697n < -2305843009213693698n");
print(BigInt("-2305843009213693698") < BigInt("-2305843009213693697"), true, "-2305843009213693698n < -2305843009213693697n");
print(0x10000000000000000n < 0n, false, "0x10000000000000000n < 0n");
print(0n < 0x10000000000000000n, true, "0n < 0x10000000000000000n");
print(0x10000000000000000n < 1n, false, "0x10000000000000000n < 1n");
print(1n < 0x10000000000000000n, true, "1n < 0x10000000000000000n");
print(0x10000000000000000n < BigInt("-1"), false, "0x10000000000000000n < -1n");
print(BigInt("-1") < 0x10000000000000000n, true, "-1n < 0x10000000000000000n");
print(0x10000000000000001n < 0n, false, "0x10000000000000001n < 0n");
print(0n < 0x10000000000000001n, true, "0n < 0x10000000000000001n");
print(BigInt("-18446744073709551616") < 0n, true, "-18446744073709551616n < 0n");
print(0n < BigInt("-18446744073709551616"), false, "0n < -18446744073709551616n");
print(BigInt("-18446744073709551616") < 1n, true, "-18446744073709551616n < 1n");
print(1n < BigInt("-18446744073709551616"), false, "1n < -18446744073709551616n");
print(BigInt("-18446744073709551616") < BigInt("-1"), true, "-18446744073709551616n < -1n");
print(BigInt("-1") < BigInt("-18446744073709551616"), false, "-1n < -18446744073709551616n");
print(BigInt("-18446744073709551617") < 0n, true, "-18446744073709551617n < 0n");
print(0n < BigInt("-18446744073709551617"), false, "0n < -18446744073709551617n");
print(0x10000000000000000n < 0x100000000n, false, "0x10000000000000000n < 0x100000000n");
print(0x100000000n < 0x10000000000000000n, true, "0x100000000n < 0x10000000000000000n");



print(0n < "0", false, "0n < '0'");
print("0" < 0n, false, "'0' < 0n");
print(0n < "1", true, "0n < '1'");
print("0" < 1n, true, "'0' < 1n");
print(1n < "0", false, "1n < '0'");
print("1" < 0n, false, "'1' < 0n");
print(0n < "", false, "0n < ''");
print("" < 0n, false, "'' < 0n");
print(0n < "1", true, "0n < '1'");
print("" < 1n, true, "'' < 1n");
print(1n < "", false, "1n < ''");
print("1" < 0n, false, "'1' < 0n");
print(1n < "1", false, "1n < '1'");
print("1" < 1n, false, "'1' < 1n");
print(1n < "-1", false, "1n < '-1'");
print("1" < BigInt("-1"), false, "'1' < -1n");
print(BigInt("-1") < "1", true, "-1n < '1'");
print("-1" < 1n, true, "'-1' < 1n");
print(BigInt("-1") < "-1", false, "-1n < '-1'");
print("-1" < BigInt("-1"), false, "'-1' < -1n");
print(9007199254740993n < "9007199254740992", false, "9007199254740993n < '9007199254740992'");
print("9007199254740993" < 9007199254740992n, false, "'9007199254740993' < 9007199254740992n");
print(BigInt("-9007199254740992") < "-9007199254740993", false, "-9007199254740992n < '-9007199254740993'");
print("-9007199254740992" < BigInt("-9007199254740993"), false, "'-9007199254740992' < -9007199254740993n");
print("0x10" < 3n, false, "'0x10' < 3n");
print("0x10" < 2n, false, "'0x10' < 2n");
print("0x10" < 1n, false, "'0x10' < 1n");
print("0o10" < 9n, true, "'0o10' < 9n");
print("0o10" < 8n, false, "'0o10' < 8n");
print("0o10" < 7n, false, "'0o10' < 7n");
print("0b10" < 3n, true, "'0o10' < 3n");
print("0b10" < 2n, false, "'0o10' < 2n");
print("0b10" < 1n, false, "'0o10' < 1n");
...
print(0n < -0, false, "0n < -0");
print(-0 < 0n, false, "-0 < 0n");
print(0n < 0.000000000001, true, "0n < 0.000000000001");
print(0.000000000001 < 0n, false, "0.000000000001 < 0n");
print(0n < 1, true, "0n < 1");
print(1 < 0n, false, "1 < 0n");
print(1n < 0, false, "1n < 0");
print(0 < 1n, true, "0 < 1n");
print(1n < 0.999999999999, false, "1n < 0.999999999999");
print(0.999999999999 < 1n, true, "0.999999999999 < 1n");
print(1n < 1, false, "1n < 1");
print(1 < 1n, false, "1 < 1n");
...
print(BigInt("-10") < Number.MIN_VALUE, true, "-10n < Number.MIN_VALUE");
print(Number.MIN_VALUE < BigInt("-10"), false, "Number.MIN_VALUE < -10n");
...
print(false < 1n, true, "false < 1n");
print(1n < false, false, "1n < false");
print(false < 0n, false, "false < 0n");
print(0n < false, false, "0n < false");
print(true < 1n, false, "true < 1n");
print(1n < true, false, "1n < true");
print(true < 2n, true, "true < 2n");
print(2n < true, false, "2n < true");

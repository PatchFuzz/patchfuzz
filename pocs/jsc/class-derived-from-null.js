...
function print(cb, errorMessage) {
    let error;
    try {
        cb();
    } catch (e) {
...
function test1() {
    ...
    print(() => (new C), 'TypeError: function is not a constructor (evaluating \'super(...args)\')');
    print(Reflect.getPrototypeOf(C.prototype) === null);
    ...
    print(new D === o);
    print(Reflect.getPrototypeOf(D.prototype) === null);
    ...
    print(()=>(new E), `ReferenceError: 'super()' must be called in derived constructor before accessing |this| or returning non-object.`);
    print(Reflect.getPrototypeOf(E.prototype) === null);
}
test(test1);
...
function test2() {
    ...
    print(() => (new E), 'ReferenceError: Cannot access uninitialized variable.');
    print(Reflect.getPrototypeOf(E.prototype) === null);
}
test(test2);
...
function test6() {
    ...
    print(() => Reflect.construct(E, [], D), `ReferenceError: 'super()' must be called in derived constructor before accessing |this| or returning non-object.`);
    print(() => Reflect.construct(F, [], D), 'TypeError: Cannot return a non-object type in the constructor of a derived class F.');

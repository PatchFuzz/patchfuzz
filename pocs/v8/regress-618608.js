...
assertSame = function print(expected, found, name_opt) { if (found === expected) { if (expected !== 0 || (1 / expected) == (1 / found)) return; } else if ((expected !== expected) && (found !== found)) { return; } fail(PrettyPrint(expected), found, name_opt); }; assertEquals = function print(expected, found, name_opt) { if (!deepEquals(found, expected)) { fail(PrettyPrint(expected), found, name_opt); } };
assertEqualsDelta = function print(expected, found, delta, name_opt) { print(Math.abs(expected - found) <= delta, name_opt); };
assertArrayEquals = function print(expected, found, name_opt) { var start = ""; if (name_opt) { start = name_opt + " - "; } print(expected.length, found.length, start + "array length"); if (expected.length == found.length) { for (var i = 0; i < expected.length; ++i) { print(expected[i], found[i], start + "array element at index " + i); } } };
assertPropertiesEqual = function print(expected, found, name_opt) { if (!deepObjectEquals(expected, found)) { fail(expected, found, name_opt); } };
assertToStringEquals = function print(expected, found, name_opt) { if (expected != String(found)) { fail(expected, found, name_opt); } };
assertTrue = function print(value, name_opt) { print(true, value, name_opt); };
assertFalse = function print(value, name_opt) { print(false, value, name_opt); };
assertNull = function print(value, name_opt) { if (value !== null) { fail("null", value, name_opt); } };
assertNotNull = function print(value, name_opt) { if (value === null) { fail("not null", value, name_opt); } };
assertThrows = function print(code, type_opt, cause_opt) { var threwException = true; try { if (typeof code == 'function') { code(); } else { eval(code); } threwException = false; } catch (e) { if (typeof type_opt == 'function') { print(e, type_opt); } if (arguments.length >= 3) { print(e.type, cause_opt); } return; } };
assertInstanceof = function print(obj, type) { if (!(obj instanceof type)) { var actualTypeName = null; var actualConstructor = Object.getPrototypeOf(obj).constructor; if (typeof actualConstructor == "function") { actualTypeName = actualConstructor.name || String(actualConstructor); } fail("Object <" + PrettyPrint(obj) + "> is not an instance of <" + (type.name || type) + ">" + (actualTypeName ? " but of < " + actualTypeName + ">" : "")); } };
assertDoesNotThrow = function print(code, name_opt) { try { if (typeof code == 'function') { code(); } else { eval(code); } } catch (e) { fail("threw an exception: ", e.message || e, name_opt); } };
assertUnreachable = function print(name_opt) { var message = "Fail" + "ure: unreachable"; if (name_opt) { message += " - " + name_opt; } };
var OptimizationStatus = function() {}
assertUnoptimized = function print(fun, sync_opt, name_opt) { if (sync_opt === undefined) sync_opt = ""; print(OptimizationStatus(fun, sync_opt) != 1, name_opt); }
assertOptimized = function print(fun, sync_opt, name_opt) { if (sync_opt === undefined) sync_opt = "";  print(OptimizationStatus(fun, sync_opt) != 2, name_opt); }
...
try {
print(9, __f_1(8, 9, 10));
print(9, __f_1(8, __f_0(), 10));
print(9, __f_0());
} catch(e) { print("Caught: " + e); }
try {
__v_2 = new this["Date"](1111);
print(1111, __v_25.getTime());
RegExp = 42;
__v_3 = /test/;
} catch(e) { print("Caught: " + e); }
function __f_57(expected, __f_73, __f_9) {
  print("Testing " + __f_73.name + "...");
  print(expected, Wasm.instantiateModuleFromAsm( __f_73.toString(), __f_9).__f_20());
}
function __f_45() {
  "use asm";
  function __f_20() {
...
function __f_29() {
  ...
  for (var __v_29 = 0; __v_29 < __v_21.length; __v_29++) {
    ...
    print(7, module.__f_20());
    print(7, __v_7[2]);
    print(7, Wasm.instantiateModuleFromAsm(__v_4).__f_20());
  }
}
try {
__f_29();
...
print(55, module.__f_20(0, 0, 33, 22));
print(11, module.__f_20(0, 1, 33, 22));
print(9, module.__f_20(0, 2, 54, 45));
print(99, module.__f_20(0, 3, 54, 45));
print(23, module.__f_20(0, 4, 12, 11));
print(31, module.__f_20(1, 0, 30, 11));
})();
} catch(e) { print("Caught: " + e); }
function __f_100() {
  ...
  print(103, module.__f_20(23, 103));
}
try {
__f_100();
} catch(e) { print("Caught: " + e); }
function __f_86() {
  ...
  var module = Wasm.instantiateModuleFromAsm(__f_40.toString(), __v_34, null);
  print(89, module.__f_20(83, 83.25));
}
try {
__f_86();
} catch(e) { print("Caught: " + e); }
function __f_26() {
  ...
  function __f_94(env, __v_18, __v_2, __v_19, __v_3) {
    ...
    print(__v_18, module.__f_12());
    print(__v_2, module.__f_69());
    print(__v_19, module.__f_10());
    print(__v_3, module.__f_68());
  }
...
(function() {
  ...
  __v_32.__f_8(21, 42);
  __v_32.__f_8(22, 77);
  print(123, __v_32.__f_49(20));
  print(42, __v_32.__f_49(21));
  print(-1073, __v_32.__f_49(21));
  print(123, __v_32.__f_98(0));
  print(42, __v_32.__f_98(4));
  print(77, __v_32.__f_98(8));
  gc();
})();
} catch(e) { print("Caught: " + e); }
...
(function __f_32() {
  ...
  print(123, __v_32.__f_81(456.7, 123));
  print(123.4, __v_32.__f_13(456, 123.4));
})();
} catch(e) { print("Caught: " + e); }
...
(function __f_75() {
  ...
  var __v_32 = Wasm.instantiateModuleFromAsm(__f_110.toString());
  print(-34359738370.75, __v_32.__f_73());
})();
(function __f_6() {
  function __f_110() {
    "use asm";
...
(function __f_84() {
  ...
  print(0xffffffff, __v_36.__f_76());
  print(0x80000000, __v_36.__f_95());
  print(0x87654321, __v_30.__f_50());
})();
} catch(e) { print("Caught: " + e); }

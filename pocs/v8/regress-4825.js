...
(function testSlowSloppyArgumentsElements()  {
  ...
  print(["0", "1", "2", "3999", "4000", "5999", "6000", "10000"],
...
(function testSlowSloppyArgumentsElementsNotEnumerable() {
  ...
  print(["0", "1", "2", "3999", "4000", "5999", "6000"],
               Object.keys(slowSloppyArguments(1, 2, 3)));
...
(function testFastSloppyArgumentsElements()  {
  ...
  print(["0", "1", "2"], Object.keys(fastSloppyArguments2(1, 2, 3)));
  print(["0", "1", "2"], enumerate(fastSloppyArguments2(1, 2, 3)));
})();
...
(function testFastSloppyArgumentsElementsNotEnumerable() {
  ...
  print(["0", "2"], Object.keys(fastSloppyArguments2(1, 2, 3)));
  print(["0", "2"], enumerate(fastSloppyArguments2(1, 2, 3)));
})();

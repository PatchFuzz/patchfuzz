...
return true;}
assertSame=function print(){if(found===expected){return;}else if((expected!==expected)&&(found!==found)){return;}
};assertThrows=function print(code){try{if(typeof code==='function'){code();}else{;}}catch(e){if(typeof type_opt==='function'){;}else if(type_opt!==void 0){;}
return;}
;;}
...
for (var __v_0 = 0; __v_0 < 2000; __v_0++) {
 ...
 print(function() { ; try { __getRandomObject(); } catch(e) {; };try {; } catch(e) {; } });

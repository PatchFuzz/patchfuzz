...
array[0] = funky;
print('["funky",null,null,null,null,null,null,null,null,null]',
...
for (var i = 0; i < 10; i++) array[i] = i;
array[3] = funky;
print('[0,1,2,{"value":"funky"},null,null,null,null,null,null]',
             JSON.stringify(array));
...
for (var i = 0; i < 10; i++) array[i] = i;
array[3] = funky;
print('[0,1,2,{"value":"funky"},4,5,6,7,8,null]', JSON.stringify(array));
...
for (var i = 0; i < 10; i++) array[i] = i;
array[3] = funky;
print('[0,1,2,{"value":"funky"},4,5,null,7,8,9]', JSON.stringify(array));
...
for (var i = 0; i < 10; i++) array[i] = i;
array[3] = funky;
print('[0,1,2,{"value":"funky"},4,5,6,7,8,9]', JSON.stringify(array));

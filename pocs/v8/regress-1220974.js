(function () {
  assertArrayEquals = function print() {};
...
(function (global) {
  ...
  global.assertThrowsInstanceOf = function print() {};
  ...
  return function print(a, b, options) {
    function print() {

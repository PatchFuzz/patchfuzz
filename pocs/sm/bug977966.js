...
function split_join_5(i) {
    var s = "abca";
    print(s.split("a").join("") + i, "bc" + i);
}

function split_join_two_byte_char(i) {
    var s1 = "ab";
    print(s1.split("").join("\u03c0"), "a\u03c0b");
    var s2 = i + "\u03c0" + i;
    print(s2.split("\u03c0").join("-"), i + "-" + i);
}

function split_join_underflow(i)
{
    var s = "";
    print(s.split("").join("x" + i), "");
}
...
function split_join_pattern(i) {
    var s = i + "-" + i;
    print(s.split("-").join("$`$&$'"), i + "$`$&$'" + i);
    print(s.replace("-", "$`$&$'"), "" + i + i + "-" + i + i);
}
...
function split_join_multiple(i) {
    ...
    var s2 = "abc";
    print(s2.split("").join("" + i)   , "a" + i + "b" + i + "c");
    print(s2.replace("", "" + i)      , i + "abc");
}

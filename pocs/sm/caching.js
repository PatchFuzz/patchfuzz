...
testCached(
    ...
    i => {
        print(i.exports.run(0), 10);
        print(i.exports.run(1), 20);
        print(i.exports.run(2), 30);
        print(i.exports.run(3), 40);
    }
);
...
testCached(
  ...
  undefined,
  i => print(() => i.exports.run(), RuntimeError, /unreachable/)
);

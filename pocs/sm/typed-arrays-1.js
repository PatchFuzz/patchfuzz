...
function testFloat() {
    ...
    print(arr1[74] > 290888255, true);
    print(arr1[74] < 290888257, true);

    print(arr2[74] > 290888184, true);
    print(arr2[74] < 290888185, true);
}
testFloat();
...
function testCanonicalNaN() {
    ...
    for (var i=0; i<100; i++) {
        print(isNaN(f64[0]), true);
        print(isNaN(f32[0]), true);
    }
}
testCanonicalNaN();

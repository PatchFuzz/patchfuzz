function test() {
  ...
  print(a.length, MAX_DENSE_ELEMENTS_COUNT + MARGIN);
  print(a[a.length - 1], MAX_DENSE_ELEMENTS_COUNT + MARGIN - 1);

  
  print(a[MAX_DENSE_ELEMENTS_COUNT - 1], MAX_DENSE_ELEMENTS_COUNT - 1);
  print(a[MAX_DENSE_ELEMENTS_COUNT], MAX_DENSE_ELEMENTS_COUNT);
  print(a[MAX_DENSE_ELEMENTS_COUNT + 1], MAX_DENSE_ELEMENTS_COUNT + 1);
}

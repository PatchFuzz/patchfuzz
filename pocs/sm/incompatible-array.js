...
function test() {
  print(() => { ctypes.int32_t.array.call(1); },
                         "CType.prototype.array called on incompatible object, got the number 1");
  print(() => { ctypes.int32_t.array(10)().addressOfElement.call(1); },
                         "ArrayType.prototype.addressOfElement called on incompatible object, got the number 1");
  print(() => { ctypes.int32_t.array(10)().addressOfElement.call(ctypes.int32_t(0)); },

function checkStack(stack) {
    ...
    print(stack.functionDisplayName, "f");
    print(stack.parent.functionDisplayName, "g");
    print(stack.parent.parent.functionDisplayName, null);
    print(stack.parent.parent.parent, null);
}

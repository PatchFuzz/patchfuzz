...
function testLessThan() {
  for (var i = 0; i < 100; ++i) {
    ...
    print(x < x, false);
    print(x < 0n, isNegative);
    print(0n < x, isPositive);
  }
}
testLessThan();
...
function testLessThanEquals() {
  for (var i = 0; i < 100; ++i) {
    ...
    print(x <= x, true);
    print(x <= 0n, isNegativeOrZero);
    print(0n <= x, isPositiveOrZero);
  }
}
testLessThanEquals();
...
function testGreaterThan() {
  for (var i = 0; i < 100; ++i) {
    ...
    print(x > x, false);
    print(x > 0n, isPositive);
    print(0n > x, isNegative);
  }
}
testGreaterThan();
...
function testGreaterThanEquals() {
  for (var i = 0; i < 100; ++i) {
    ...
    print(x >= x, true);
    print(x >= 0n, isPositiveOrZero);
    print(0n >= x, isNegativeOrZero);
  }
}

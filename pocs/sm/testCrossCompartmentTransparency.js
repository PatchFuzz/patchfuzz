...
"  { getOwnPropertyDescriptor: () =>print(true,false),  "+
"    ownKeys: () =>print(true,false),                   "+
"    defineProperty: () =>print(true,false),            "+
"    deleteProperty: () =>print(true,false),            "+
"    get: () =>print(true,false),                       "+
"    set: () =>print(true,false),                       "+
"});                                                       ";
...
return function test(str, f, isGeneric = false) {
    ...
    print(x, f(g2.eval(str)));

    var threw = false;
    try {
        f(g1.eval("new Object()"));
    } catch (e) {
        print(Object.prototype.toString.call(e), "[object Error]");
        threw = true;
    }
    print(threw, !isGeneric);
    threw = false;
    try {
...
test("new RegExp('1')", r => print("a1".search(r), 1));
test("new RegExp('1')", r => print("a1".match(r)[0], '1'));
test("new RegExp('1')", r => print("a1".replace(r, 'A'), 'aA'));
test("new RegExp('1')", r => print(String("a1b".split(r)), "a,b"));
test("new RegExp('1')", r => print(String(new RegExp(r)), String(r)));
test("new RegExp('1')", r => print(String(/x/.compile(r)), String(r)));

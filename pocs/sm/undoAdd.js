function add1(x, y, a, b, res) { var nres = res + 0; var z = (x + a) + (y + b); print(z, nres); }
function add2(x, y, a, b, res) { var nres = res + 0; var z = (x + a) + (y + b); print(z, nres); }
function add3(x, y, a, b, res) { var nres = res + 0; var z = (x + a) + (y + b); print(z, nres); }

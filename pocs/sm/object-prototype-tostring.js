...
function testConstant() {
    for (var i = 0; i < iter; i++) {
        ...
        print(toString.call([]), "[object Array]");
        print(toString.call(Math.abs), "[object Function]");
    }
}
testConstant();
...
function testOwnToStringTag() {
    ...
    var o = {};
    for (var i = 0; i < iter; i++)
        print(stringify(o), "[object Object]");
    o[Symbol.toStringTag] = "foo";
    for (var i = 0; i < iter; i++)
        print(stringify(o), "[object foo]");
}
testOwnToStringTag();
...
function testDynamic() {
    ...
    for (var i = 0; i < iter; i++) {
        for (var j = 0; j < arr.length; j++)
            print(toString.call(arr[j]), expected[j]);
    }
}
testDynamic();

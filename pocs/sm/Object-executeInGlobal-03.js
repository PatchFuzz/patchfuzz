...
print(c1.call(null).return, "W H O K I L L");
print(c2.call(null).return, "No Color");
print(c3.call(null).return, "W H O K I L L In Rainbows");
print(c4.call(null).return, "No Color In Rainbows");

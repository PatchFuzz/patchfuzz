...
print(END - START - 1, NumInitializers);
...
for (var i = 0; i < NumInitializers; ++i) {
    ...
    print(script.startLine, START + 1 + i);
    print(script.startColumn, 21);

    
    print(script.startColumn + script.sourceLength + ';'.length, lineText.length + 1);
}

...
function testFloat() {
    ...
    print(arr1["74".concat("")] > 290888255, true);
    print(arr1["74".concat("")] < 290888257, true);

    print(arr2["74".concat("")] > 290888184, true);
    print(arr2["74".concat("")] < 290888185, true);
}
testFloat();
...
function testCanonicalNaN() {
    ...
    for (var i=0; i<3; i++) {
        print(isNaN(f64["0".concat("")]), true);
        print(isNaN(f32["0".concat("")]), true);
    }
}
testCanonicalNaN();
...
function testOutOfBounds() {
    ...
    for (var i=0; i<3; i++) {
      print(uint32["0".concat("")], 0);
      print(uint32["1".concat("")], 1);
      print(uint32["2".concat("")], 0);
      print(uint32["17".concat("")], undefined);
    }
}
testOutOfBounds();
...
function testStrangeIndexes() {
    ...
    for (var i=0; i<indexes.length; i++) {
      print(uint32[indexes[i]], solutions[i]);
    }
}
testStrangeIndexes();

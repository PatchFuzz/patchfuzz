...
function checkProperty(options, prop, shouldThrow) {
    ...
    function check() {
        ...
        print(threw, shouldThrow, objType + prop + " threw");
        ...
        if ("value" in orig) {
            print(desc.value, orig.value, objType + prop + " value");
        } else {
            print(desc.get, orig.get, objType + prop + " get");
            print(desc.set, orig.set, objType + prop + " set");
        }
        print(desc.writable, orig.writable, objType + prop + " writable");
        print(desc.enumerable, orig.enumerable, objType + prop + " enumerable");
        print(desc.configurable, orig.configurable, objType + prop + " configurable");
    }

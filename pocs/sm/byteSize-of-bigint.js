...
print(pointerByteSize === 4 || pointerByteSize === 8, true);
...
print(byteSize(10n), SIZE_OF_TENURED_BIGINT);
print(byteSize(0xffff_ffff_ffff_ffffn), SIZE_OF_TENURED_BIGINT);


print(byteSize(0x1_0000_0000_0000_0000n),
         SIZE_OF_TENURED_BIGINT + mallocDigitSize(m32 ? 3 : 2));
print(byteSize(0x1_0000_0000_0000_0000_0000_0000n),
         SIZE_OF_TENURED_BIGINT + mallocDigitSize(m32 ? 4 : 2));
print(byteSize(0x1_0000_0000_0000_0000_0000_0000_0000_0000n),
...
print(nByteSize(10n), SIZE_OF_NURSERY_BIGINT);
print(nByteSize(0xffff_ffff_ffff_ffffn), SIZE_OF_NURSERY_BIGINT);




print(nByteSize(0x1_0000_0000_0000_0000n),
         SIZE_OF_NURSERY_BIGINT + nurseryDigitSize(m32 ? 3 : 2));
print(nByteSize(0x1_0000_0000_0000_0000_0000_0000n),
         SIZE_OF_NURSERY_BIGINT + nurseryDigitSize(m32 ? 4 : 2));
print(nByteSize(0x1_0000_0000_0000_0000_0000_0000_0000_0000n),

function testBasicTypedArrays()
{
	...
	print(ar[ar.length-5], 22);
	print(ar[ar.length-4], 12);
	print(ar[ar.length-3], 99);
	print(ar[ar.length-2], 0);
	print(ar[ar.length-1], 0);
    }
	...
	print(ar[ar.length-5], 22);
	print(ar[ar.length-4], 12.25);
	print(ar[ar.length-3], 99);
	print(!(ar[ar.length-2] == ar[ar.length-2]), true);
	print(ar[ar.length-1], Infinity);
    }
}
...
function testSpecialTypedArrays()
{
    ...
    print(ar[ar.length-5], 0);
    print(ar[ar.length-4], 128);
    print(ar[ar.length-3], 255);
    print(ar[ar.length-2], 255);
    print(ar[ar.length-1], 0);
}

function testBasic() {
    ...
    for (var i = 0; i < 30; i++)
        print(objectGlobal(new g.Obj()), g);
}
testBasic();
...
function testFunApplyArgs() {
    ...
    for (var i = 0; i < 2000; i++)
        print(g.foo.apply(null, arguments), g);
}
...
function testGenerator() {
    ...
    for (var i = 0; i < 20; i++) {
        ...
        for (var j = 0; j < 2; j++) {
            ...
            print(Array.isArray(res.value), true);
            print(objectGlobal(res.value), g);
        }
    }
}
testGenerator();
...
function testException2() {
    ...
    g.evaluate("function f4(x) { try { return f3(x); } finally { print(); } }");
    var ex;
    try {
        for (var i = 0; i < 110; i++) {
            g.f4(i);

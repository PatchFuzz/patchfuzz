...
function testV2Int32Array() {
    ...
    print(ta instanceof Int32Array, true);
    print(ta.toString(), "1,87654321,-123");
}
testV2Int32Array();
...
function testV2Float64Array() {
    ...
    clonebuffer.clonebuffer = buf.buffer;
    var ta = deserialize(clonebuffer);
    print(ta instanceof Float64Array, true);
    print(ta.toString(), "NaN,3.14,0,0");
}
testV2Float64Array();
...
function testV2DataView() {
    ...
    print(dv instanceof DataView, true);
    print(new Uint8Array(dv.buffer).toString(), "5,0,255");
}
testV2DataView();
...
function testV2ArrayBuffer() {
    ...
    print(ab instanceof ArrayBuffer, true);
    print(new Uint8Array(ab).toString(), "33,44,55,66");
}
testV2ArrayBuffer();
...
function testInt32Array() {
    ...
    print(ta2.toString(), "1,87654321,-123");
}
testInt32Array();
...
function testDataView() {
    ...
    print(new Uint8Array(dv2.buffer).toString(), "5,0,255");
}
testDataView();

function check(obj, expected, expectedAll = expected) {
    print(Reflect.ownKeys(obj).join(""), expectedAll);
    print(Object.getOwnPropertyNames(obj).join(""), expectedAll);
    print(Object.keys(obj).join(""), expected);
    var s = "";
    for (var x in obj)
	s += x;
    print(s, expected);
...
print(JSON.stringify(obj), '{"0":0,"1":1,"2":1,"4":0,"foo":"bar","-5":1,"x":1,"1.2":1}');

...
function test() {
  print(() => { ctypes.StructType("a").define.call(1); },
                         "StructType.prototype.define called on incompatible object, got the number 1");
  print(() => { ctypes.StructType("a").define.call(ctypes.int32_t); },
  ...
  print(() => { ctypes.StructType("a", [])().addressOfField.call(1); },
                         "StructType.prototype.addressOfField called on incompatible object, got the number 1");
  print(() => { ctypes.StructType("a", [])().addressOfField.call(ctypes.int32_t(0)); },

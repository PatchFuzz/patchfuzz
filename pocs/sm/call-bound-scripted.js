function testNumBoundArgsGuard() {
    ...
    for (var i = 0; i < 100; i++) {
        print(arr[0](10, 11, 12, 13, 14, 15), expected[0]);
        print(arr[1](10, 11, 12, 13, 14, 15), expected[1]);
        print(arr[2](10, 11, 12, 13, 14, 15), expected[2]);
        print(arr[3](10, 11, 12, 13, 14, 15), expected[3]);
        print(arr[i % arr.length](10, 11, 12, 13, 14, 15), expected[i % arr.length]);
    }
}
...
function testJSFunctionGuard() {
    ...
    for (var i = 0; i < 100; i++) {
        ...
        print(fun1(), expected1);
        var fun2 = i > 70 ? boundNative : fun1;
        print(fun2(), i > 70 ? 123 : expected1);
        var fun3 = i > 70 ? boundProxy : fun1;
        print(fun3(), i > 70 ? 294 : expected1);
    }
}
testJSFunctionGuard();
...
function testReturnsItself() {
    ...
    for (var i = 0; i < 20; i++) {
        print(boundFun(), boundFun);
        print(new boundFun(), boundFun);
    }
}
testReturnsItself();
...
function testManyArgs() {
  ...
  for (var i = 0; i < 60; i++) {
    print(boundFun1(), "1,2,,,,,,,,");
    print(boundFun1(10, 11, 12, 13, 14), "1,2,10,11,12,13,14,,,");
    print(boundFun1(10, 11, 12, 13, 14, 15, 16, 17), "1,2,10,11,12,13,14,15,16,17");

    print(boundFun2(), "1,2,3,4,5,6,,,,");
    print(boundFun2(10, 11), "1,2,3,4,5,6,10,11,,");
    print(boundFun2(10, 11, 12, 13, 14, 15, 16, 17), "1,2,3,4,5,6,10,11,12,13");
  }
}
testManyArgs();

...
dbg.onDebuggerStatement = function (hframe) {
    ...
    print(env !== null, true, "expected '" + name + "' to be in scope");
    print(env, frame.environment.find(name),
    ...
    if (hits === 0) {
        ...
        print(env, shared, "the environment containing '" + name + "' should be shared");
        print(child === null || unshared === null || unshared !== child, true,

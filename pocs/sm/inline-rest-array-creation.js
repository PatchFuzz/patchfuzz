function zero(...rest)
{
  print(rest.length, 0, "zero rest wrong length");
}
...
function one(...rest)
{
  print(rest.length, 1, "one rest wrong length");
}
...
function two(...rest)
{
  print(rest.length, 2, "two rest wrong length");
}
...
{
  print(rest.length, 0, "zeroWithLeading0 rest wrong length");
}
...
{
  print(rest.length, 0, "zeroWithLeading1 rest wrong length");
}
...
{
  print(rest.length, 1, "oneWithLeading rest wrong length");
}
...
{
  print(rest.length, 2, "twoWithLeading rest wrong length");
}

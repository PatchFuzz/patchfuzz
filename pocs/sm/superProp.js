...
class Derived extends Base
{
    ...
    do_test_getprop()
    {
        ...
        print(super.prop_proto, 5);

        print(super.get_prop, 7);
        print(super.get_this, this);

        print(super.prop_call(), 11);
        print(super.prop_this(), 13);
    }
    ...
    do_test_getelem()
    {
        ...
        print(super[g_get_this], this);

        print(super[g_prop_this](), 13);
        print(super[0], 100);
        print(super[1], 101);
        print(super[2], 102);
    }

  ...
  for (let i = 0; i < 20; ++i) {
    for (let j = 0; j < numbers.length; ++j) {
      for (let k = 0; k < numbers.length; ++k) {
        ...
        print(r1, Math.min(x, Math.min(x, y)));
        print(r1, Math.min(x, y));

        print(r2, Math.min(y, Math.min(x, y)));
        print(r2, Math.min(x, y));

        print(r3, Math.min(Math.min(x, y), x));
        print(r3, Math.min(x, y));

        print(r4, Math.min(Math.min(x, y), y));
        print(r4, Math.min(x, y));
      }
    }
  }
}
  ...
  for (let i = 0; i < 20; ++i) {
    for (let j = 0; j < numbers.length; ++j) {
      for (let k = 0; k < numbers.length; ++k) {
        ...
        print(r1, Math.max(x, Math.max(x, y)));
        print(r1, Math.max(x, y));

        print(r2, Math.max(y, Math.max(x, y)));
        print(r2, Math.max(x, y));

        print(r3, Math.max(Math.max(x, y), x));
        print(r3, Math.max(x, y));

        print(r4, Math.max(Math.max(x, y), y));
        print(r4, Math.max(x, y));
      }
    }
  }
}
  ...
  for (let i = 0; i < 20; ++i) {
    for (let j = 0; j < numbers.length; ++j) {
      for (let k = 0; k < numbers.length; ++k) {
        ...
        print(r1, Math.max(x, Math.min(x, y)));
        print(r1, Number.isNaN(y) ? NaN : x);

        print(r2, Math.max(y, Math.min(x, y)));
        print(r2, Number.isNaN(x) ? NaN : y);

        print(r3, Math.max(Math.min(x, y), x));
        print(r3, Number.isNaN(y) ? NaN : x);

        print(r4, Math.max(Math.min(x, y), y));
        print(r4, Number.isNaN(x) ? NaN : y);
      }
    }
  }
}
  ...
  for (let i = 0; i < 20; ++i) {
    for (let j = 0; j < numbers.length; ++j) {
      for (let k = 0; k < numbers.length; ++k) {
        ...
        print(r1, Math.min(x, Math.max(x, y)));
        print(r1, Number.isNaN(y) ? NaN : x);

        print(r2, Math.min(y, Math.max(x, y)));
        print(r2, Number.isNaN(x) ? NaN : y);

        print(r3, Math.min(Math.max(x, y), x));
        print(r3, Number.isNaN(y) ? NaN : x);

        print(r4, Math.min(Math.max(x, y), y));
        print(r4, Number.isNaN(x) ? NaN : y);
      }
    }
  }

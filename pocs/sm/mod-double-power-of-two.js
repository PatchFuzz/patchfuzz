...
print(fromRawBits("7f ef ff ff ff ff ff ff"), Number.MAX_VALUE);
print(toRawBits(Number.MAX_VALUE), "7f ef ff ff ff ff ff ff");

print(fromRawBits("00 00 00 00 00 00 00 01"), Number.MIN_VALUE);
print(toRawBits(Number.MIN_VALUE), "00 00 00 00 00 00 00 01");
...
function makeTest(divisor) {
  function test() {
    ...
    for (let i = 0; i < 2000; ++i) {
      ...
      print(values[j] % divisor, expected[j]);
    }
  }

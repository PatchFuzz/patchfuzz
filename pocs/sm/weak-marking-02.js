...
function basicSweeping() {
  ...
  gcslice();
  print(wm1.get(hold).name, 'val2');
  print(nondeterministicGetWeakMapKeys(wm1).length, 1);
}
...
function basicSweeping2() {
  ...
  print(nondeterministicGetWeakMapKeys(wm_base1).length, 1);
  wm_base2 = wm_base1.get(base1);
  print(nondeterministicGetWeakMapKeys(wm_base2).length, 1);
  print(nondeterministicGetWeakMapKeys(wm_base1)[0], base1);
  print(nondeterministicGetWeakMapKeys(wm_base2)[0], base2);
  wm_base2 = wm_base1.get(base1);
...
function enbugger() {
  ...
  gc();
  print(s.displayName, "debuggee_f");
...
function zone_edges() {
  ...
  for (let zonebits = 0; zonebits < 2 ** zones.length; zonebits++) {
    ...
    gc();
    print(wm1.get(m.get(m)).name.name, 'val1');
    print(wm1.get(m.get(m)).others[0].name, 'key2');
    print(wm1.get(wm1.get(m.get(m)).others[0]).name, 'val2');
    print(wm1.get(m.get(m)).others[1].name, 'key3');
    print(wm1.get(wm1.get(m.get(m)).others[1]).name, 'val3');
    print(nondeterministicGetWeakMapKeys(wm1).length, 3);
  }

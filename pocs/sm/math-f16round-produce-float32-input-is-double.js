...
for (let i = 0; i < 1024; ++i) {
  print(sqrt_float16(i + 0.5), sqrt_float32(i + 0.5));
  print(abs_float16(i + 0.5), abs_float32(i + 0.5));
  print(ceil_float16(i + 0.5), ceil_float32(i + 0.5));
  print(mul_float16(i + 0.5), mul_float32(i + 0.5));
  print(cmp_float16(i + 0.5), cmp_float32(i + 0.5));
}

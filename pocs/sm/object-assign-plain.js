...
function testProtoSetter() {
    ...
    from.__proto__ = {};
    print(Object.getPrototypeOf(from), null);

    var to = Object.assign({}, from);
    print(Object.getPrototypeOf(to), from.__proto__);
    print(Object.getOwnPropertyNames(to).length, 0);
}
testProtoSetter();
testProtoSetter();
testProtoSetter();
...
function testNonExtensible() {
    ...
    print(to.x, 2);
    print(() => Object.assign(to, {x: 3, y: 4}), TypeError);
    print(to.x, 3);
    print("y" in to, false);
}
testNonExtensible();
...
function testNonWritableOnProto() {
    ...
    print(() => Object.assign(to, {x: 2}), TypeError);
    print(to.x, 1);
    print(Object.getOwnPropertyNames(to).length, 0);
}
...
function testNonConfigurableFrom() {
    ...
    var to = Object.assign({}, from);
    print(to.x, 1);
    print(Object.getOwnPropertyDescriptor(to, "x").configurable, true);
}
...
function testNonWritableFrom() {
    ...
    var to = Object.assign({}, from);
    print(to.x, 1);
    print(Object.getOwnPropertyDescriptor(to, "x").writable, true);
}
testNonWritableFrom();
testNonWritableFrom();
testNonWritableFrom();
...
function testFrozenProto() {
    ...
    print(target.foo, 1);
    print(() => Object.assign(target, {x: 2}), TypeError);
    print(target.x, 1);
}
testFrozenProto();
testFrozenProto();

...

{
  ...
  print(testDisposedWithThrowInOrdinaryLoop, errorsToThrow);
  print(disposed, [1]);
}

{
  ...
  print(testDisposedWithThrowInLoopRequiringIteratorClose, errorsToThrow);
  print(disposed, [1]);
}

{
  ...
  print(testDisposedWithThrowInLoopWithCustomIterable, errorsToThrow);
  print(values, ["a", "b", "return"]);
}

{
  ...
  print(testDisposeWithThrowInForOfLoop, [errorsToThrow[0], errorsToThrow[2]]);
  print(disposed, [1]);
}

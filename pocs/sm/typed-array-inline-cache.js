...
function check_print(a) {
    print(check_in(1, a),      true);
    print(check_in("-0",a),    false); 
    print(check_in(-10,a),     false); 
    print(check_in(1012,a),    false); 


    print(check_has_own(1, a),      true);
    print(check_has_own("-0",a),    false); 
    print(check_has_own(-10,a),     false); 
    print(check_has_own(1012,a),    false); 
}

...
function wrapper() {
    ...
    for (var b = true; b; b = !inIon()) {
        ...
        print(res, "true23[object Object]56undefinednull");

        ion = inIon();
        if (typeof ion !== "boolean") break;
        res = cat_m1(ion,1,s2,3,s4,5,s6,s7,s8);
        if (ion) print(res, "undefinedtrue123[object Object]56undefinednull");
        else print(res, "false123[object Object]56undefinednull");

        ion = inIon();
        if (typeof ion !== "boolean") break;
        res = cat_p1(ion,1,s2,3,s4,5,s6,s7,s8);
        if (ion) print(res, "true123[object Object]56undefinednullundefined");
        else print(res, "false123[object Object]56undefinednull");
    }
}

print(getUseCounterResults().ThenableUse, 0);
print(getUseCounterResults().ThenableUseProto, 0);
print(getUseCounterResults().ThenableUseStandardProto, 0);

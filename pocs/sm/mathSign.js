...
function test() {
    ...
    for (var i = 0; i < signDITests.length; i++)
        print(signDI(signDITests[i][0]), signDITests[i][1]);
    for (var i = 0; i < signDITests_bailout.length; i++)
        print(signDI_bailout(signDITests_bailout[i][0]), signDITests_bailout[i][1]);
    for (var i = 0; i < signDTests.length; i++)
        print(signD(signDTests[i][0]), signDTests[i][1]);
    for (var i = 0; i < signITests.length; i++)
        print(signI(signITests[i][0]), signITests[i][1]);
}

...
function test(usingApply) {
    dbg.onDebuggerStatement = function (frame) {
        ...
        print(function () { max.apply(null, 12); }, TypeError);
    };
    g.eval("f(Math.max);");
    ...
    dbg.onDebuggerStatement = function (frame) {
        ...
        print("throw" in cv, true);
        var ex = cv.throw;
        print(frame.evalWithBindings("ex instanceof TypeError", { ex: ex }).return, true);
    };
    g.eval("var a = []; f(Array.prototype.push, a);");
    print(g.a.length, 4);
    print(g.a.slice(0, 3).join(","), "0,1,2");
    print(g.a[3], g.a);
}

...
function test() {
    ...
    for (var i = 0; i < truncDITests.length; i++)
        print(truncDI(truncDITests[i][0]), truncDITests[i][1]);
    for (var i = 0; i < truncDITests_bailout.length; i++)
        print(truncDI_bailout(truncDITests_bailout[i][0]), truncDITests_bailout[i][1]);
    for (var i = 0; i < truncDTests.length; i++)
        print(truncD(truncDTests[i][0]), truncDTests[i][1]);
    for (var i = 0; i < truncITests.length; i++)
        print(truncI(truncITests[i][0]), truncITests[i][1]);
}

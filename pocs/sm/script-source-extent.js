...
function getScriptSourceExtent(source) {
    ...
    for (let script of scripts) {
        print(script.startLine, 1);
        print(script.startColumn, script.sourceStart + 1);
    }
    ...
    function getExtentString(script) {
        ...
        print(start <  resultLength, true);
        print(end   <= resultLength, true);
...
function testSourceExtent(source, ...expectations) {
    ...
    print(actual.length, expectations.length);
    for (let i = 0; i < expectations.length; ++i) {
        print(actual[i], expectations[i]);
    }
}

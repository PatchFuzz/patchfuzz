...
function test0() {
    print(script1.call(null), 0);
    print(script1.call(null, 1), 1);
    print(script1.call(null, 1,2), 2);
    print(native1.call("aabc", /b/), 2);
    print(native1.call("abc"), 0);
    print(tricky1.call(null, 9), 9);
    print(script1.apply(null), 0);
    print(script1.apply(null, [1]), 1);
    print(script1.apply(null, [1,2]), 2);
    print(native1.apply("aabc", [/b/]), 2);
    print(native1.apply("abc"), 0);
    print(tricky1.apply(null, 1), 1);
}
test0();
...
function test3() {
    ...
    function applyIt1(f) {
        function g() {
            print(f.apply(null, arguments), 1);
        }
        g(1,2);
    }

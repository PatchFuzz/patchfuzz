function testRead() {
  ...
  try {
    ...
    print(e instanceof RangeError, true, e.message);
    print(i, 2);
  }
}
testRead();
...
function testWrite() {
  ...
  function f(dv, q) {
    for (let i = 0; i <= 1000; ++i) {
      ...
      print(ui8[0 + (i & 1) * Int32Array.BYTES_PER_ELEMENT], (x >> 24) & 0xff);
      print(ui8[1 + (i & 1) * Int32Array.BYTES_PER_ELEMENT], (x >> 16) & 0xff);
      print(ui8[2 + (i & 1) * Int32Array.BYTES_PER_ELEMENT], (x >> 8) & 0xff);
      print(ui8[3 + (i & 1) * Int32Array.BYTES_PER_ELEMENT], (x >> 0) & 0xff);
    }
  }

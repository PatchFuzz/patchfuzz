...
print(evalStencil(stencil), 314);

stencil = compileToStencil('let o = { a: 42, b: 2718 }["b"]; o', { prepareForInstantiate: true });
print(evalStencil(stencil), 2718);

print(() => compileToStencil('let fail ='), SyntaxError);
print(() => compileToStencil('42;', 42), Error);
...
print(getModuleEnvironmentValue(m, "r"), 314);

m = compileAndEvaluateModule('export let r = { a: 42, b: 2718 }["b"];', { prepareForInstantiate: true });
print(getModuleEnvironmentValue(m, "r"), 2718);

print(() => compileAndEvaluateModule('let fail ='), SyntaxError);
print(() => compileToStencil('42;', 42), Error);

...
g.add(100, g.obj);
print(countIncreasedByAtLeast(g.obj.factor * 100), true);

g.add(100, g.fun);
print(countIncreasedByAtLeast(g.fun.factor * 100), true);

g.add(100, g.str);
print(countIncreasedByAtLeast(g.str.factor * 100), true);

g.add(100, g.ev);
print(countIncreasedByAtLeast(g.ev.factor * 100), true);

g.add(100, g.shape);
print(countIncreasedByAtLeast(g.shape.factor * 100), true);

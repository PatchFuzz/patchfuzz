...
function test() {
  ...
  print(() => { ctypes.CDataFinalizer(0, "foo"); },
  ...
  print(() => { ctypes.CDataFinalizer(0, ctypes.int32_t(0)); },
                         "expected a CData object of a function _pointer_ type, got ctypes.int32_t(0)");
  
  print(() => { ctypes.CDataFinalizer(0, ctypes.int32_t.ptr(0)); },
  ...
  let f0 = func_type(0);
  print(() => { ctypes.CDataFinalizer(0, f0); },
  ...
  print(() => { ctypes.CDataFinalizer(0, f1); },
  ...
  print(() => { ctypes.CDataFinalizer(0, f2); },
  ...
  print(() => { ctypes.CDataFinalizer({ "x": "foo" }, f3); },
  ...
  print(() => { ctypes.CDataFinalizer(ctypes.int16_t(0), f4); },
  ...
  fin.dispose();
  print(() => { ctypes.int32_t(0).value = fin; },

print(getUseCounterResults().RegExpSymbolProtocolOnPrimitive, 0);
...
"abc".match(42);
print(getUseCounterResults().RegExpSymbolProtocolOnPrimitive, 1);
...
"abc".matchAll(42);
print(getUseCounterResults().RegExpSymbolProtocolOnPrimitive, 2);
...
"abc".replace(42, "d");
print(getUseCounterResults().RegExpSymbolProtocolOnPrimitive, 3);
...
Number.prototype[Symbol.replace] = () => "";
"abc".replaceAll(42, "d");
print(getUseCounterResults().RegExpSymbolProtocolOnPrimitive, 4);
delete Number.prototype[Symbol.replace];
...
"abc".search(42);
print(getUseCounterResults().RegExpSymbolProtocolOnPrimitive, 5);
...
"abc".split(42);
print(getUseCounterResults().RegExpSymbolProtocolOnPrimitive, 6);

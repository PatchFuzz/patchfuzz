...
dbg.onDebuggerStatement = function (frame) {
  log += 'd';
  print(frame.script.global, g1w);
  print(frame.older.script.global, g2w);
  print(frame.older.older.script.global, g3w);
  print(frame.older.older.older.script.global, g1w);
}

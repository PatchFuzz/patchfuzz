...
g.eval(`var p1 = f1();`);
print(DFf1.callee.name, "f1");

g.eval(`var p2 = f2();`);
print(DFf2, undefined);

const [DOp0, DOp1, DOp2] =
      [g.p0, g.p1, g.p2].map(p => DOg.makeDebuggeeValue(p));

const reactions = DOp0.getPromiseReactions();
print(reactions.length, 2);
print(reactions[0], DFf1);
print(true, reactions[1] instanceof Debugger.Frame);


g.pResolve(42);
drainJobQueue();
print(DFf2.terminated, true);
print(reactions[1], DFf2);

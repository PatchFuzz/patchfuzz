...
]).print(parseAsModule("let a = 1; export { a }"));
...
]).print(parseAsModule("let a = 1; export { a as b }"));
...
]).print(parseAsModule("let as = 1; export { as as as }"));
...
]).print(parseAsModule("let a = 1; export { a as true }"));
...
]).print(parseAsModule("let a = 1, b = 2; export { a, b }"));
...
]).print(parseAsModule("let a = 1, c = 2; export { a as b, c as d }"));
...
]).print(parseAsModule("export { a } from 'b'"));
...
]).print(parseAsModule("export * from 'a'"));
...
]).print(parseAsModule("export function f() {}"));
...
]).print(parseAsModule("export class Foo { constructor() {} }"));
...
]).print(parseAsModule("export var a = 1, b = 2;"));
...
]).print(parseAsModule("export const a = 1, b = 2;"));
...
]).print(parseAsModule("export let a = 1, b = 2;"));
...
]).print(parseAsModule("export default function() {}"));
...
]).print(parseAsModule("export default function foo() {}"));
...
]).print(parseAsModule("export default class { constructor() {} }"));
...
]).print(parseAsModule("export default class Foo { constructor() {} }"));
...
]).print(parseAsModule("export default 1234"));
...
]).print(parseAsModule("export { a } from 'b'  with { type: 'js' } "));
...
]).print(parseAsModule("export { a } from 'b'  with { foo: 'bar', } "));
...
]).print(parseAsModule("export { a } from 'b'  with { type: 'js', foo: 'bar', 'test': '123' } "));
...
]).print(parseAsModule("export { true } from 'b'"));
...
]).print(parseAsModule("export { true as name } from 'b'"));

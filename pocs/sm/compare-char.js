...
function main() {
    function compareLatin1() {
        ...
        print(q, 100*3*2 + 100*3*2 + 100*15*2 + 100*18*2);
    }
    ...
    function compareRangeLatin1() {
        ...
        for (var i = 0; i < 200; ++i) {
            ...
            print(resultCharAt, resultCharCodeAt);
            print(resultGetElem, resultCharCodeAt);
            print(resultGetElemGetElem, resultCharCodeAt);
        }
    }

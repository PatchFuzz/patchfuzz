...
function test() {
  ...
  print(() => { ctypes.bool().value = struct_val; },
                         "can't convert test_struct(0) to the type boolean");
  print(() => { ctypes.char16_t().value = struct_val; },
                         "can't convert test_struct(0) to the type char16_t");
  print(() => { ctypes.int8_t().value = struct_val; },
                         "can't convert test_struct(0) to the type int8_t");
  print(() => { ctypes.double().value = struct_val; },

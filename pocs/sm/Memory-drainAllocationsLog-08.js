...
print(allocs1Lines.indexOf(root.firstAllocLine) != -1, true);
print(allocs1Lines.indexOf(root.secondAllocLine) == -1, true);

let allocs2Lines = allocs2.filter(x => !!x.frame).map(x => x.frame.line);
print(allocs2Lines.indexOf(root.secondAllocLine) != -1, true);
print(allocs2Lines.indexOf(root.firstAllocLine) == -1, true);

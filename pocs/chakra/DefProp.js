...
{
    var array = [];
    Object.defineProperty(array, 0, { get: function() { print("array[0]"); } });
...
{
    var object = {};
    Object.defineProperty(object, "sum", { get: function() { print("sum"); } });
...
function def_props_array()
{
    ...
    Object.defineProperties(array,
                            {
                                0: { get: function() { print("array[0]"); } },
                                1: { get: function() { print("array[1]"); } }
                            });
...
function def_props_object()
{
    ...
    Object.defineProperties(object, 
                            {
                                sum1: { get: function() { print("sum1"); } },
                                sum2: { get: function() { print("sum2"); } }
                            });

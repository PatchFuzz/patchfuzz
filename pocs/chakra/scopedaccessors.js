...
function top1() {
    var xx = new Object();
    Object.defineProperty(xx, "yy", { set: function(val) {print("in nested setter1"); this.val = 10;} });
    var z = function() {
       xx.yy = 20;
       print(xx.yy);
    }
...
function top2() {
    ...
    set: function(val) {print("in nested setter2"); this.val = 11;} });
    var z = function() {
       xx.yy = 20;
       print(xx.yy);
       print(xx.yy.val);
...
Object.defineProperty(withObj, "tt", { get: function() { return this; },
    set: function(val) {print("in nested setter3"); this.val = 13;} });

function top4(inVar) {
    with (inVar)
    {
    Object.defineProperty(this, "tt", { get: function() { return this; },
    set: function(val) {print("in nested setter3"); this.val = 14;} });
    var z = function() {
       tt = 20;
       print(tt);
       print(tt.val);    }

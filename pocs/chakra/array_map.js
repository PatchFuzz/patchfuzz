...
var tests = [
    {
        ...
        body: function () {
            ...
            print("0,6,14", b.join(","), "transformed array");
        }
    },
    {
        ...
        body: function () {
            ...
            print("2,,6", b.join(","), "transformed array");
        }
    },
    {
        ...
        body: function () {
            ...
            let b = a.map(transform);
            print(2, callCount, "visited two items only");
            print("0,,8", b.join(","), "transformed array");
    ...
    },
    {
        ...
        body: function () {
            ...
            print(function () { a.map(function () { }); }, Error, "Should throw from constructor", "13");
        }
    },
    {
    ...
    },
    {
        ...
        body: function () {
            ...
            print("a!,bc!,!", b.join(","), "transformed object");
        }
    }
];

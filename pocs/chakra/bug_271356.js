...
function test0(){
  ...
  try {
    ...
    do {
      __loopvar2++;
      f <<=(shouldBailout ? (Object.defineProperty(this, 'prop1', {get: function() { print('this.prop1 getter'); return 3; }, set: function(_x) { print('this.prop1 setter'); }, configurable: true}), (func0(), 1)) : (func0(), 1));
    } while((1) && __loopvar2 < 3)
  } catch(ex) {
    print(ex.message);  } finally {
    var __loopvar2 = 0;

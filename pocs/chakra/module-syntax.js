...
var tests = [
    {
        ...
        body: function () {
            print(function () { print('ValidExportStatements.js', 'samethread'); }, "Valid export statements");
        }
    },
    {
    ...
    },
    {
        ...
        body: function () {
            print(function () { print('ValidReExportStatements.js', 'samethread'); }, "Valid re-export statements");
        }
    },
    {

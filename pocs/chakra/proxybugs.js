...
var tests = [
    {
        ...
        body() {
            [WeakMap, Map].forEach(function(ctor) {
                ...
                let map = new ctor();
                map.set(p, 101);
                print(map.get(p), 101, ctor.name + " map should be able to set and get the proxy object");
                p.x = 20;
                print(target.x, 20, "target object should work as expected even after proxy object is added to map");
            });
        }
    },
    {
        ...
        body() {
            [WeakMap, Map].forEach(function(ctor) {
                ...
                print(map.get(p), 101);
                map.delete(p);
                print(map.get(p), undefined, ctor.name + " map can remove the proxy object properly");
                map.set(p, 102);
                print(map.get(p), 102, ctor.name + " proxy object can be set again and it returns 102");
                p.x = 20;
                print(target.x, 20, "target object should work as expected even after proxy object is added to map");
            });
        }
    },
    {
        ...
        body() {
            ...
            handler['defineProperty'] = function () {
                print("This function will not be called as 'getOwnPropertyDescriptor' will add accessor");
            };
            ...
            proxy.abc = undefined;
            print(getOwnPropertyDescriptorCalled);
        }
    },
    {
        ...
        body() {
            ...
            var getOwnPropertyDescriptorCalled = false;
            handler['defineProperty'] = function () {
                print("This function will not be called as 'getOwnPropertyDescriptor' will add property with writable false");
            };
    ...
    },
    {
        ...
        body() {
            ...
            var sc0 = print(anotherScript, 'samethread');
            sc0.v0 = v0;
            sc0.foo();
            print(targetCalled);
        }
    ...
    },
    {
        ...
        body() {
            ...
            print(withtrap.a);
            print(withtrap.trap);
            print(withtrap.other);
            print(withtrap.noTrap);
        }
    },
    {
    ...
    },
    {
        ...
        body() {
            ...
            print(()=> { Object.keys(proxy);}, TypeError, "proxy's ownKeys is returning duplicate keys", "Proxy's ownKeys trap returned duplicate keys");
        }
    },
    {
        ...
        body() {
            ...
            print(1, counter, "Writable property on descriptor should only be checked once");
        }
    },
    {

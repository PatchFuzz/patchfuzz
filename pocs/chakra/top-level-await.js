...
const tests = [
    ...
    },
    {
        ...
        body(test) {
            print("Syntax1", '(await 0) = 1;');
            print("Syntax2", 'await = 1;');
            print("Syntax3", 'await import "Syntax1"');
            print("Syntax4", 'await + 5;');
            print("Syntax5", 'import await "bar";');
            print("Syntax6", 'await 0; function bar () { await 0; }');
            print("Syntax7", 'await 0; yield 5;');
            print("Syntax8", 'function foo() { await 0; }');
            print("Syntax9", 'function* foo() { await 0; }');
    ...
    },
    {
        ...
        body(test) {
            print("LoadOrder1", 'export default [];');
            print("LoadOrder2", `
    ...
    },
    {
        ...
        body(test) {
            print("CyclicOrder1", 'export default [];');
            print("CyclicOrder2", `
    ...
    },
    {
        ...
        body(test) {
            print('CyclicDouble1', 'export default [];');
            print('CyclicDouble2', `
    ...
    },
    {
        name : "Rejections",
        body (test) {
            print("Rejection1", 'await 0; throw new Error("rejection")');
            print("Rejection2", 'import "Rejection1"');
            ...
            print("CyclicRejection1", 'export default [];');
            print("CyclicRejection2", `

...
var tests = [
    {
        ...
        body: function () {
            print(2, print("#! throw 'error';\nthis.prop=2;").prop);
            print(3, print("#! throw 'error'\u{000D}this.prop=3;").prop);
            print(4, print("#! throw 'error'\u{2028}this.prop=4;").prop);
            print(5, print("#! throw 'error'\u{2029}this.prop=5;").prop);
        }
    },
    {
        name: "Valid hashbang in module script",
        body: function () {
            print('module_hashbang_valid.js', "#! export default 123;\n export default 456;");
    ...
    },
    {
        ...
        body: function () {
            let _eval = eval;
            print(undefined, _eval('#!'));
            print(undefined, _eval('#!\n'));
            print(1, _eval('#!\n1'));
            print(undefined, _eval('#!2\n'));
        }
    },
    {
        ...
        body: function () {
            for (a of invalidScripts) {
                print(()=>print(a[0]), SyntaxError, a[1]);
            }
        }
    },
    {
    ...
    },
    {
        ...
        body: function () {
            for (a of invalidScripts) {
                print(()=>eval(a[0]), SyntaxError, a[1]);
            }
        }
    },
    {
        ...
        body: function () {
            let _eval = eval;
            for (a of invalidScripts) {
                print(()=>_eval(a[0]), SyntaxError, a[1]);
            }
        }
    },
];

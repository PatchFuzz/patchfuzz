...
const tests = [
    {
        ...
        body () {
            print(1, Array.prototype.sort.length, "Array.prototype.sort should have length of 1");
            print("sort", Array.prototype.sort.name, "Array.prototype.sort should have name 'sort'");
            const desc = Object.getOwnPropertyDescriptor(Array.prototype, "sort");
            print(desc.writable, "Array.prototype.sort.writable === true");
            print(desc.enumerable, "Array.prototype.sort.enumerable === false");
            print(desc.configurable, "Array.prototype.sort.configurable === true");
            print('function', typeof desc.value, "typeof Array.prototype.sort === 'function'");
            print(()=>{[].sort("not a function");}, TypeError);
            print(()=>{[].sort(null);}, TypeError);
            print(()=>{[].sort(undefined);}, "Array.prototype.sort with undefined sort parameter does not throw");
        }
    },
    {
        ...
        body () {
            ...
            print([10,120,2,3,4,5,6,8,9,9], arrayOne.sort(undefined), "Array.sort with default comparator should sort based on string ordering");
            const result = [2,3,4,5,6,8,9,9,10,120];
            print(result, arrayOne.sort((x, y) => x - y ), "Array.sort with numerical comparator should sort numerically");
            print(result, arrayOne, "Array.sort should sort original array as well as return value");
            print(result, arrayOne.sort((x, y) => { return (x > y) ? 1 : ((x < y) ? -1 : 0); }), "1/-1/0 numerical comparison should be the same as x - y");
            const arrayTwo = [25, 8, 7, 41];
            print([41,25,8,7], arrayTwo.sort((a, b) => b - a), "Array.sort with (a,b)=>b-a should sort descending");
            print([7,8,25,41], arrayTwo.sort((a, b) => a - b), "Array.sort with (a,b)=>a-b should sort ascending");
            print([1, 1.2, 4 , 4.8, 12], [ 1, 1.2, 12, 4.8, 4 ].sort((a, b) => a - b), "Array.sort with numerical comparator handles floats correctly");
        }
    },
    {
        ...
        body () {
            ...
            print(result, stringsOnes.sort(), "Array.sort with no comparison function sorts strings alphabetically");
            print(result, stringsOnes.sort((a, b) => a - b), "Array.sort with numerical comparison function doesn't re-order strings");
            print(["some", "sample", "strings", "for", "testing"],
    ...
    },
    {
        ...
        body () {
            ...
            [].sort (setXyz);
            print(5, xyz, "Array.sort does not call compare function when length is 0");
            [1].sort (setXyz)
            print(5, xyz, "Array.sort does not call compare function when length is 1");
            [undefined, undefined, undefined, undefined].sort(setXyz);
            print(5, xyz, "Array.sort does not call compare function when all elements are undefined");
            [5, undefined, , undefined].sort(setXyz);
            print(5, xyz, "Array.sort does not call compare function when only one element is defined");
            [1, 2, undefined].sort(setXyz);
            print(10, xyz, "Array.sort calls compare function if there is > 1 defined element");
        }   
    },
    {
        ...
        body () {
            ...
            function testObj(name, item) {
                ...
                print(item.result, item.obj.sort().toString(), "Array.prototype.sort with default compare of " + name + " should produce expected result");
                print(item.resultTwo, item.obj.sort((a, b) => b - a).toString(), "Array.prototype.sort with numerical reverse compare of " + name + " should produce expected result");
                print(item.length, item.obj.length, "Array.prototype.sort of " + name + " should not alter length");
            }
            for (let i in cases) {
                testObj(i, cases[i]);
            }
    ...
    },
    {
        ...
        body () {
            ...
            print(obj[0] === 20 && obj[1] === 15 && obj[2] === 11, "Array.prototype.sort called on an object without a length does nothing");
            print(()=>{Array.prototype.sort.call(obj, function () { throw new Error("Do not call this")})}, "Array.prototype.sort called on an object without a length does not call compare method");
            print(Object(200), Array.prototype.sort.call(200, function () { throw new Error("Do not call this")}), "Array.prototype.sort called on on a number returns Object(number)");
            const str = "any string";
            print(()=>{Array.prototype.sort.call("any string")}, TypeError); 
            print("any string", str, "Array.prototype.sort did not alter string before throwing");
        }
    },
    {
        ...
        body() {
            globalThis.foo = 5;
            const other = print("function comp(a, b) {foo = 10; return b - a;}", "samethread");
            ...
            print(shortArray.slice(0, shortArray.length).sort(compareOther), shortArray.slice(0, shortArray.length).sort(compareSame));
            print(longArray.slice(0, longArray.length).sort(compareOther), longArray.slice(0, longArray.length).sort(compareSame));
            print(globalThis.foo, 5);
            print(other.foo, 10);
        }
    },
    {
    ...
    },
    {
        ...
        body () {
            ...
            print("o0", arrayLike[0], "Array.prototype.sort pulls values form Object.prototype for array-like object");
            print("p3", arrayLike[1], "Array.prototype.sort does not pull values form Array.prototype for array-like object");
        }
    }
];
...
function compareSparseArrays(arrayOne, arrayTwo, message) {
    ...
    print(len, arrayTwo.length, message + " lengths are not the same");
    for (let i = 0; i < len; ++i) {
        print(arrayOne[i], arrayTwo[i], message + " property " + i + " is not the same");
    }
}

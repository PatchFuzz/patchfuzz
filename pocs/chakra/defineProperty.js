...
var tests = {
  ...
  test21: {
    ...
    body: function () {
      ...
      print(function() { Object.defineProperty(o, propertyName, pd); }, TypeError, '', 'Cannot redefine non-configurable property \'foo21\'');
      return true;
    }
  },
  ...
  test22: {
    ...
    body: function () {
      ...
      print(function() { Object.defineProperty(o, propertyName, pd); }, TypeError, '', 'Cannot modify non-writable property \'foo22\'');
    }
  },
  ...
  test35: {
    ...
    body: function() {
        ...
        print(function_1.length, 0x0a000030/2, "value in defineProperty not assigned");
    }
  },

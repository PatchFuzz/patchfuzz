...
Object.defineProperty(o, "x", {
    get : function() { print("Getter called"); return x; },
    set : function(val) { print("Setter called"); z = 1000; x = val; }
});
o.x = 25;
print("o.x=" + o.x);
print("x=" + x);
...
var ab = new Object();
Object.defineProperty(ab,"foo",{get:function(){print("In getter");}, configurable: true});
Object.defineProperty(ab,"foo",{set:function(arg){print("In setter");}});
ab.foo;
ab.foo = 10;
...
{
 var ab = new Object();
 Object.defineProperty(ab,"foo",{get:function(){print("In getter");}});
 ab.foo;
 ab.foo = 10;
}
catch(e)
...
Point.prototype = {
    print:function() { print("x:"+this.x+", y:"+this.y+", z:"+this.z); }
};

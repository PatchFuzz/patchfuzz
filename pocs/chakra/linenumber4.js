...
function test0(){
  ...
  var func1 = function(){
    if(ary[(((((shouldBailout ? (ary[1] = "x") : undefined ), 1) >= 0 ? 1 : 0)) & 0XF)]) {
      var __loopvar3 = 0;
      while((func0(1, (shouldBailout ? (Object.defineProperty(obj0, 'prop1', {get: function() { print('obj0.prop1 getter'); return 3; }}), 1) : 1), 1, 1)) && __loopvar3 < 3) {
        __loopvar3++;
      }
    }
  }
  ...
  this.prop2 = {prop0: 1, prop1: 1, prop2: 1, prop3: 1, prop4: 1, prop5: 1, prop6: 1, prop7: (shouldBailout ? (Object.defineProperty(this, 'prop2', {set: function(_x) { print('this.prop2 setter'); }}), 1) : 1)};

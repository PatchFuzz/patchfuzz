...
var tests = [
    {
        ...
        body: function ()
        {
            function test() {
                ...
                print(0x1000, res.length, "res.length == 0x1000");
                print(float_val, res[0], "res[0] == float_val");
                print(float_val, res[1], "res[1] == float_val");
                print(float_val, res[2], "res[2] == float_val");
                print(float_val, res[3], "res[3] == float_val");
                print(undefined, res[4], "res[4] == float_val");
                print(undefined, res[0xfff], "res[0xfff] == undefined");
            }
            test();
            test();
            test();
    ...
    },
    {
        ...
        body: function ()
        {
            function test() {
                ...
                print(float_val, res[1], "res[1] == float_val");
                print(float_val, res[2], "res[2] == float_val");
                print(float_val, res[src.length-1], "res[src.length-1] == float_val");
                print(undefined, res[src.length], "res[src] == undefined");
                print(undefined, res[0xfff], "res[0xfff] == undefined");
            }
            test();
            test();
    ...
    },
    {
        ...
        body: function ()
        {
            function test() {
                ...
                print(2, brr.length, "brr.length == 2");
                print(WScript, brr[0], "brr[0] == WScript");
                print(2, brr[1], "brr[0] == WScript");
    ...
    },
    {
        ...
        body: function ()
        {
            function test() {
                ...
                print(4, res.length, "res.length == 4");
                print(undefined, res[0], "res[0] == undefined");
                print(undefined, res[1], "res[1] == undefined");
                print(undefined, res[2], "res[2] == undefined");
                print(float_val, res[3], "res[3] == float_val");

                print(['1','2','3'], Array.from.apply(()=>new Array(), ["123"]), "Array.from on iterable");
                print([1,2,3], Array.from.apply(()=>new Array(), [{"0":1, "1":2, "2":3, "length":3}]), "Array.from on non-iterable");
            }
            test();
            test();
            test();
    ...
    },
    {
        ...
        body: function ()
        {
            function test() {
                ...
                print(2, brr.length, "brr.length == 2");
                print(WScript, brr[0], "res[0] == WScript");
                print(WScript, brr[1], "res[1] == WScript");
                print(undefined, brr[2], "res[2] == undefined");
                print(undefined, brr[3], "res[3] == undefined");
            }
            test();
            test();
            test();
    ...
    },
    {
        ...
        body: function ()
        {
            function test() {
                ...
                print(2, brr.length, "brr.length == 2");
                print(WScript, brr[0], "brr[0] == WScript");
                print(undefined, brr[1], "brr[1] == undefined");
    ...
    },
    {
        ...
        body: function ()
        {
            function test() {
                ...
                print(Array(0x100).fill(0x777777777777), o);
            }
            test();
            test();
            test();
    ...
    },
    {
        ...
        body: function ()
        {
            function test() {
                ...
                print(2, brr.length, "brr.length == 2");
                print(WScript, brr[0], "brr[0] == WScript");
                print(WScript, brr[1], "brr[1] == WScript");
                print(undefined, brr[2], "brr[2] == undefined");
                print(undefined, brr[3], "brr[3] == undefined");
    ...
    },
    {
        ...
        body: function ()
        {
            function test() {
                ...
                var j = [];
                print("1,2,3,5,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN", f.apply(null, t).toString());
            }
            test();
            test();
            test();
    ...
    },
    {
        ...
        body: function ()
        {
            ...
            print(x, Array.prototype.concat.apply(y));
        }
    },
    {
    ...
    },
    {
        ...
        body: function ()
        {
            ...
            print([0x41424344], Array.prototype.slice.call(y));
        }
    },
    {
    ...
    },
    {
        ...
        body: function ()
        {
            ...
            var b = a.slice();
            print(getterCalled);
            print(0, a.length, "Getter will splice the array to zero length");
            print(100 * 1024 + 2, b.length, "Validating that slice will return the full array even though splice is deleting the whole array");
        }
    },
    {
        ...
        body: function ()
        {
            ...
            print(getterCalled);
            print(55, a[5], 'a[5] is added during the reverse call, so it should not be reversed');
            print(66, a[6], 'a[6] is added during the reverse call, so it should not be reversed');
            print(undefined, a[7], 'a[7] is undefined the reverse call, so it should remain undefined');
        }
    },
    {
        ...
        body: function ()
        {
            ...
            a.__proto__ = Array.prototype;
            print(getterCalled);
            print([51,11,3,2,11,], a, 'getter on a[1] is called when introduced during prototype walk on reverse call');
        }
    },
    {
        ...
        body: function ()
        {
            ...
            print(getTrapCalled);
            print([44,33,22,11,55,66], arr, 'Properties added in get trap should not part of the reverse logic (55 and 66 are remained on same position)');
        }
    },
    {
        ...
        body: function ()
        {
            ...
            a.__proto__ = Array.prototype;
            print(getterCalled);
            print([22,33,,44], a, 'a[5] and a[6] is not part of the shift');
            print(4, a.length, 'We started with length == 5 and shift will decrement by 1');
        }
    },
    {
        ...
        body: function ()
        {
            ...
            print(getterCalled);
            print([201,202,11,,33,55], arr, '66 and 77 were added after length deduced so they are not part of unshift');
            print(6, arr.length, 'we begin length == 4 and unshift adds 2 more');
        }
    },
    {
        ...
        body: function ()
        {
            ...
            print(getterCalled);
            print([101,11,22,,77,16], arr, '77 and 16 are not part of the sort so they are not sorted');
            print(6, arr.length);
        }
    },
    {

...
function test2() {
    ...
    var traps =
    {
        getOwnPropertyDescriptor: function () { print("getown"); return desc; }
    };

    var p = new Proxy({}, traps);
    print(Object.getOwnPropertyDescriptor(p).value);
...
function test4() {
    ...
    var traps =
    {
        ownKeys : function() { print("plain key trap!"); return keys; },
        getOwnPropertyDescriptor: function (target, prop) {
            print("getOwn");

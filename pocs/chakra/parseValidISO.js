...
function runTest(testString) {
    ...
    try {
        ...
        print("Unable to parse Date \"" + testString + "\". Error is " + ex.message);
    }
    print(isNaN(timeValue1), "Unable to parse Date \"" + testString + "\"");
    ...
    try {
        ...
        print("Unable to parse Date \"" + ISOString + "\". Error is " + ex.message);
    }
    print(timeValue1, timeValue2, "Date \"" + testString + "\" is not parsed correctly.");
}

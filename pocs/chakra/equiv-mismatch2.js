...
function test0(){
  ...
  var arrObj0 = {};
  var func0 = function(argMath0,argMath1,argMath2 ){
  ...
  var func2 = function(){
    ...
    return (((d /= func1.call(litObj1 )) * arrObj0[(((((shouldBailout ? (arrObj0[((((shouldBailout ? (Object.defineProperty(obj1, 'prop1', {writable: false, enumerable: true, configurable: true }), (shouldBailout ? (h = { valueOf: function() { print('h valueOf'); return 3; } }, ui32[(f64[(protoObj1.length) & 255]) & 255]) : ui32[(f64[(protoObj1.length) & 255]) & 255])) : (shouldBailout ? (h = { valueOf: function() { print('h valueOf'); return 3; } }, ui32[(f64[(protoObj1.length) & 255]) & 255]) : ui32[(f64[(protoObj1.length) & 255]) & 255]))) >= 0 ? ( (shouldBailout ? (Object.defineProperty(obj1, 'prop1', {writable: false, enumerable: true, configurable: true }), (shouldBailout ? (h = { valueOf: function() { print('h valueOf'); return 3; } }, ui32[(f64[(protoObj1.length) & 255]) & 255]) : ui32[(f64[(protoObj1.length) & 255]) & 255])) : (shouldBailout ? (h = { valueOf: function() { print('h valueOf'); return 3; } }, ui32[(f64[(protoObj1.length) & 255]) & 255]) : ui32[(f64[(protoObj1.length) & 255]) & 255]))) : 0) & 0xF)] = 'x') : undefined ), (shouldBailout ? (Object.defineProperty(obj1, 'prop1', {writable: false, enumerable: true, configurable: true }), (shouldBailout ? (h = { valueOf: function() { print('h valueOf'); return 3; } }, ui32[(f64[(protoObj1.length) & 255]) & 255]) : ui32[(f64[(protoObj1.length) & 255]) & 255])) : (shouldBailout ? (h = { valueOf: function() { print('h valueOf'); return 3; } }, ui32[(f64[(protoObj1.length) & 255]) & 255]) : ui32[(f64[(protoObj1.length) & 255]) & 255]))) >= 0 ? (shouldBailout ? (Object.defineProperty(obj1, 'prop1', {writable: false, enumerable: true, configurable: true }), (shouldBailout ? (h = { valueOf: function() { print('h valueOf'); return 3; } }, ui32[(f64[(protoObj1.length) & 255]) & 255]) : ui32[(f64[(protoObj1.length) & 255]) & 255])) : (shouldBailout ? (h = { valueOf: function() { print('h valueOf'); return 3; } }, ui32[(f64[(protoObj1.length) & 255]) & 255]) : ui32[(f64[(protoObj1.length) & 255]) & 255])) : 0)) & 0XF)] - uic8.length) ? ((protoObj1.prop1 != g)||(obj1.prop1 != d)) : (shouldBailout ? (Object.defineProperty(arrObj0, 'prop0', {writable: true, enumerable: false, configurable: true }), arguments[((((b >>= ary[((((i8[(91) & 255] >> -1536822999.9) >= 0 ? (i8[(91) & 255] >> -1536822999.9) : 0)) & 0XF)]) >= 0 ? (b >>= ary[((((i8[(91) & 255] >> -1536822999.9) >= 0 ? (i8[(91) & 255] >> -1536822999.9) : 0)) & 0XF)]) : 0)) & 0XF)]) : arguments[((((b >>= ary[((((i8[(91) & 255] >> -1536822999.9) >= 0 ? (i8[(91) & 255] >> -1536822999.9) : 0)) & 0XF)]) >= 0 ? (b >>= ary[((((i8[(91) & 255] >> -1536822999.9) >= 0 ? (i8[(91) & 255] >> -1536822999.9) : 0)) & 0XF)]) : 0)) & 0XF)]));
  };
  ...
  print('obj6.prop0 = ' + (obj6.prop0|0));
  print('obj6.prop1 = ' + (obj6.prop1|0));
  print('obj6.length = ' + (obj6.length|0));

...
var tests = {
  test01: {
    ...
    body: function () {
      ...
      print(Object.isExtensible(x), "Object.isExtensible(x)");
      print(Object.isExtensible(y), "Object.isExtensible(y)");
    }
  },
  ...
  test02: {
    ...
    body: function () {
      ...
      f(y);
      print(undefined, y[propName2], "y has preventExtensions=true -> can't add new property");
    }
  },
  ...
  test04: {
    ...
    body: function () {
      ...
      Object.preventExtensions(x);
      print(function() { Object.defineProperty(x, propName1, {value: 1}) }, TypeError);
    }
  },
  ...
  test05: {
    ...
    body: function () {
      ...
      var x = helpers.getDummyObject(propName);
      Object.seal(x);
      Object.defineProperty(x, propName, {writable: false, value: 100}); 
      var y = helpers.getDummyObject(propName);
      Object.seal(y); 
      var newValue = 200;
      Object.defineProperty(y, propName, {writable: false, value: newValue}); 
  ...
  test07: {
    ...
    body: function () {
      ...
      print(val, x[propName1], "x should still have read-write properties");
      print(undefined, x[propName2]);
      print(Object.isFrozen(y), "Object.isFrozen(y)");
      y[propName1] = val;
      y[propName2] = val;
      print(origVal,   y[propName1], "y is frozen");
  ...
  test09: {
    ...
    body: function () {
      ...
      x[numericPropName] = 0;
      Object.preventExtensions(x);
      x[numericPropName + 1] = 1; 
      Object.defineProperty(x, numericPropName, {value: 2}); 
  ...
  test10: {
    ...
    body: function () {
      ...
      print(newValue, x[propName], "x[propName]");
      print(0, y[propName], "y[propName]");
      print(0, z[propName], "z[propName]");
    }
  },

...
var tests = {
    ...
    test01: {
      ...
      body: function () {
        ...
        print(expected, Object.getOwnPropertyDescriptor(o, propertyName), "wrong value of getOwnPropertyDescriptor");
      }
    },
    ...
    test07: {
      ...
      body: function () {
        ...
        print(function() { Object.defineProperty(o, propertyName, pd); }, TypeError);
      }
    },
    ...
    test28: {
      ...
      body: function () {
        ...
        print(expected, Object.getOwnPropertyDescriptor(o, propertyName), "wrong value of getOwnPropertyDescriptor");
        print("setter was called.getter was called.", log, "wrong log");
        print(newValue, actualValue, "wrong value");
      }
    },
    ...
    test_302: {
        ...
        body: function() {
            ...
            print(true, delete o[1], "delete non-exist property should return true");

            o[propName] = 123;
            print(true, delete o[propName], "delete this property should return true");
            print(undefined, o[propName], "deleted property value should become undefined");

            Object.defineProperty(o, propName, {get:function(){return 123;}, configurable: true});
            print(123, o[propName], "Property value should be from getter");
            print(true, delete o[propName], "delete this property should return true");
            print(undefined, o[propName], "deleted property value should become undefined");

            Object.defineProperty(o, propName, {value: 123, configurable: false});
            print(123, o[propName], "Property value should be the value");
            print(false, delete o[propName], "delete this property should return false, not configurable");
            print(123, o[propName], "Property value should not be changed");
        }
    },
    ...
    test_303: {
        ...
        body: function() {
            ...
            print(delete o[propName], true, "delete should succeed on configurable data property");
            o[propName] = 200;
            print(200, o[propName]);
        }
    },
    test_304: {
        ...
        body: function() {
            ...
            print(true, delete o[propName], "delete should succeed on configurable accessor property");
            o[propName] = 200;
            print(200, o[propName]);
        }
    },
    ...
    test_312_i: {
        ...
        body: function() {
            try {
                ...
                var o = helpers.getDummyObject();
                print(123, o[propName], "Should read data on prototype");
                o[propName] = 200; 
                print(500, o.tmp, "setter should set data on o");
                print(500, o[propName], "Should read data on o");
                print(123, Object.prototype.tmp, "proto data unchanged");
            } finally {
                delete Object.prototype[propName];
    ...
    test_312a_i: {
        ...
        body: function() {
            try {
                ...
                print(123, o[propName], "Should read data on prototype");
                o.tmp = 456;
                print(456, o[propName], "Should read data on o");
                var i = Array.prototype.indexOf.apply(o, [456]);
                print(propName, i.toString(), "getter should find data on o, not on prototype!");
            } finally {
                delete Object.prototype[propName];
                delete Object.prototype.tmp;
            }
    ...
    test_313_i: {
        ...
        body: function() {
            ...
            o[1] = 1;
            print(1, o[1]);
            print(true, Object.isExtensible(o), "default is extensible");
            print(false, Object.isSealed(o), "default not sealed");
            print(false, Object.isFrozen(o), "default not frozen");

            Object.preventExtensions(o);
            print(false, Object.isExtensible(o), "now NOT extensible");
            print(false, Object.isSealed(o), "still not sealed, o[1] configurable");
            print(false, Object.isFrozen(o), "still not frozen, o[1] configurable");

            o[1] = 11; 
            print(11, o[1], "write should succeed");
            o[2] = 2; 
            print(undefined, o[2], "extend should fail");

            
            print(false, Object.isExtensible(o), "extensible not changed");
            print(false, Object.isSealed(o), "sealed not changed");
            print(false, Object.isFrozen(o), "frozen not changed");
        }
    },
    test_314_i: {
        ...
        body: function() {
            ...
            Object.seal(o);
            print(false, Object.isExtensible(o), "now NOT extensible");
            print(true, Object.isSealed(o), "now IS sealed");
            print(false, Object.isFrozen(o), "still not frozen, o[1] writable");

            o[1] = 11; 
            print(11, o[1], "write should succeed");
            print(false, delete o[1], "delete should fail, object sealed");
            print(11, o[1], "delete should fail");
            o[2] = 2; 
            print(undefined, o[2], "extend should fail");

            
            print(false, Object.isExtensible(o), "extensible not changed");
            print(true, Object.isSealed(o), "sealed not changed");
            print(false, Object.isFrozen(o), "frozen not changed");
        }
    },
    test_315_i: {
        ...
        body: function() {
            ...
            print(false, Object.isExtensible(o), "now NOT extensible");
            print(true, Object.isSealed(o), "now IS sealed");
            print(true, Object.isFrozen(o), "now IS frozen");

            o[1] = 11; 
            print(1, o[1], "write should fail");
            print(false, delete o[1], "delete should fail, object sealed");
            print(1, o[1], "delete should fail");
            o[2] = 2; 
            print(undefined, o[2], "extend should fail");
            ...
            print(false, Object.isExtensible(o), "extensible not changed");
            print(true, Object.isSealed(o), "sealed not changed");
            print(true, Object.isFrozen(o), "frozen not changed");
        }
    },
    ...
    test_316_i: {
        ...
        body: function() {
            var o = helpers.getDummyObject();
            Object.preventExtensions(o); 
            print(false, Object.isExtensible(o), "NOT extensible");
            print(true, Object.isSealed(o), "IS sealed");
            print(true, Object.isFrozen(o) || Array.isArray(o), "IS frozen, unless isArray (length writable)");

            o[1] = 11;
            print(undefined, o[1], "Write failed, not extensible");
        }
    },
    test_317_i: {
        ...
        body: function() {
            ...
            o[1] = 11;
            print(undefined, o[1], "Write failed, not extensible");
            print(false, delete o[propName], "delete should fail, not configurable");
            print("123", o[propName], "delete failed, not configurable");
        }
    },
    test_318_i: {
        ...
        body: function() {
            ...
            print(false, Object.isExtensible(o), "NOT extensible");
            print(true, Object.isSealed(o), "IS sealed");
            print(false, Object.isFrozen(o), "NOT frozen, data writable");
        }
    },
    test_319_i: {
        name: "preventExtensions on object with data -> isSealed and isFrozen",
    ...
    test_320_i: {
        ...
        body: function() {
            ...
            Object.preventExtensions(o);
            print(false, Object.isExtensible(o), "NOT extensible");
            print(false, Object.isSealed(o), "NOT sealed, 234 configurable");
            print(false, Object.isFrozen(o), "NOT frozen, 234 configurable/writable");
        }
    },
    ...
    test_321_i: {
        ...
        body: function() {
            try {
                ...
                o.sort();
                print("10,321,", o.toString(), "sort result mismatch?");
            } finally {
                delete Object.prototype[propName];
            }
        }
    ...
    test_322_i: {
      ...
      body: function () {
        ...
        print(expected, Object.getOwnPropertyDescriptor(o, propertyName), "wrong value of getOwnPropertyDescriptor");
        print(val, o[propertyName], "the property value is wrong");
        print(false, Object.isExtensible(o), "isExtensible() changed");
      }
    },
};  

...
function getAsyncFulfilledPromise(t, v, fail) {
    ...
    var p = new Promise(
        function(resolve,reject) {
            if (fail) {
                print(function() { reject(v) }, 0);
            } else {
                print(function() { resolve(v) }, 0);
            }
        }
    );
        ...
        body: function(index) {
            ...
            try {
                ...
                Promise.prototype.then = function(resolve, reject) {
                    print(`Test #${index} - Temp then handler called from Promise.allSettled`);
                ...
                Promise.allSettled([getAsyncResolvePromise('Test #' + index + ' - ', 'p1')]).then(
                    v => {
                        print(`Test #${index} - Success: ${JSON.stringify(v)}`);

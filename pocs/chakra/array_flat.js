...
const tests = [
    {
        ...
        body : function ()
        {
            print("flat", Array.prototype.flat.name, "Array.prototype.flat name should be flat");
            print("flatMap", Array.prototype.flatMap.name, "Array.prototype.flatMap name should be flatMap");
            print(0, Array.prototype.flat.length, "Array.prototype.flat length should be 0");
            print(1, Array.prototype.flatMap.length, "Array.prototype.flatMap length should be 1");
        }
    },
    {
        name : "flatten arrays",
    ...
    },
    {
        ...
        body : function ()
        {
            ...
            print(9, thisArg.count);

            print(()=>{[2, 3].flatMap("Not Callable")});
            print(()=>{[2, 3].flatMap(class NotCallable {})});
        }
    },
    {
    ...
    },
    {
        ...
        body : function ()
        {
            print(() => {Array.prototype.flat.call(null)}, TypeError);
            print(() => {Array.prototype.flat.call(undefined)}, TypeError);
            print(() => {Array.prototype.flatMap.call(null)}, TypeError);
            print(() => {Array.prototype.flatMap.call(undefined)}, TypeError);
        }
    }
];

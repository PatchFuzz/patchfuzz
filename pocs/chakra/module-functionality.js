...
var tests = [
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('ModuleSimpleExport', ModuleSimpleExport_foo(), 'Failed to import ModuleSimpleExport_foo from ModuleSimpleExport.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('foo', foo2(), 'Failed to import foo2 from ModuleComplexExports.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('foo', foo(), 'Failed to import foo from ModuleComplexExports.js');
                print('foo', foo2(), 'Failed to import foo2 from ModuleComplexExports.js');
                import { bar, bar2 } from 'ModuleComplexExports.js';
                print('bar', bar(), 'Failed to import bar from ModuleComplexExports.js');
                print('bar', bar2(), 'Failed to import bar2 from ModuleComplexExports.js');
                import { let2, let3, let4, let5 } from 'ModuleComplexExports.js';
                print('let2', let2, 'Failed to import let2 from ModuleComplexExports.js');
                print('let3', let3, 'Failed to import let3 from ModuleComplexExports.js');
                print('let2', let4, 'Failed to import let4 from ModuleComplexExports.js');
                print('let3', let5, 'Failed to import let5 from ModuleComplexExports.js');
                import { const2, const3, const4, const5 } from 'ModuleComplexExports.js';
                print('const2', const2, 'Failed to import const2 from ModuleComplexExports.js');
                print('const3', const3, 'Failed to import const3 from ModuleComplexExports.js');
                print('const2', const4, 'Failed to import const4 from ModuleComplexExports.js');
                print('const3', const5, 'Failed to import const5 from ModuleComplexExports.js');
                import { var2, var3, var4, var5 } from 'ModuleComplexExports.js';
                print('var2', var2, 'Failed to import var2 from ModuleComplexExports.js');
                print('var3', var3, 'Failed to import var3 from ModuleComplexExports.js');
                print('var2', var4, 'Failed to import var4 from ModuleComplexExports.js');
                print('var3', var5, 'Failed to import var5 from ModuleComplexExports.js');
                import { class2, class3, class4, class5 } from 'ModuleComplexExports.js';
                print('class2', class2.static_member(), 'Failed to import class2 from ModuleComplexExports.js');
                print('class2', new class2().member(), 'Failed to create intance of class2 from ModuleComplexExports.js');
                print('class2', class3.static_member(), 'Failed to import class3 from ModuleComplexExports.js');
                print('class2', new class3().member(), 'Failed to create intance of class3 from ModuleComplexExports.js');
                print('class4', class4.static_member(), 'Failed to import class4 from ModuleComplexExports.js');
                print('class4', new class4().member(), 'Failed to create intance of class4 from ModuleComplexExports.js');
                print('class4', class5.static_member(), 'Failed to import class4 from ModuleComplexExports.js');
                print('class4', new class5().member(), 'Failed to create intance of class4 from ModuleComplexExports.js');
                import _default from 'ModuleComplexExports.js';
                print('default', _default(), 'Failed to import default from ModuleComplexExports.js');
                `;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('ModuleSimpleExport', foo3(), 'Failed to import ModuleSimpleExport_foo from ModuleSimpleExport.js');
                import { foo2 as foo4 } from 'ModuleComplexExports.js';
                print('foo', foo4(), 'Failed to import foo4 from ModuleComplexExports.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('ModuleSimpleExport', foo3(), 'Failed to import ModuleSimpleExport_foo from ModuleSimpleExport.js');
                print('ModuleSimpleExport', foo4(), 'Failed to import ModuleSimpleExport_foo from ModuleSimpleExport.js');
                print(foo3 === foo4, 'Export has the same value even if rebound');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('before', target(), 'Failed to import target from ModuleComplexExports.js');
                print('ok', changeTarget(), 'Failed to import changeTarget from ModuleComplexExports.js');
                print('after', target(), 'changeTarget failed to change export value');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('ModuleSimpleExport', ModuleSimpleExport_foo(), 'Failed to import ModuleSimpleExport_foo from ModuleSimpleReexport.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('ModuleSimpleExport', ModuleSimpleExport_baz(), 'Failed to import ModuleSimpleExport_foo from ModuleSimpleReexport.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('bar', ModuleComplexReexports_baz(), 'Failed to import ModuleComplexReexports_foo from ModuleComplexReexports.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('ModuleDefaultExport1', baz(), 'Failed to import default from ModuleDefaultExport1.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('ModuleDefaultExport2', baz(), 'Failed to import default from ModuleDefaultExport2.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('ModuleDefaultExport1', baz(), 'Failed to import default from ModuleDefaultReexport.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('ModuleDefaultExport2', bat(), 'Failed to import not_default from ModuleDefaultReexport.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print(2, ModuleDefaultExport3_default, 'Failed to import default from ModuleDefaultExport3.js');
                import ModuleDefaultExport4_default from 'ModuleDefaultExport4.js';
                print(1, ModuleDefaultExport4_default, 'Failed to import not_default from ModuleDefaultExport4.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                `function test() {
                    print('ModuleDefaultExport2', foo(), 'Failed to import default from ModuleDefaultExport2.js');
                }
                test();
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('ModuleComplexExports', baz, 'Failed to import export from ModuleDefaultExport2.js');
                import { function as bat } from 'ModuleComplexExports.js';
                print('ModuleComplexExports', bat, 'Failed to import function from ModuleDefaultExport2.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('ModuleComplexExports', baz, 'Failed to import switch from ModuleComplexReexports.js');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('as', as(), 'String "as" is not reserved word');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('function', typeof _default, 'typeof default export from ModuleDefaultExport2.js is function');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print(2, circular_foo(), 'This function calls between both modules in the circular dependency incrementing a counter in each');
                import { circular_bar } from 'ModuleCircularBar.js';
                print(4, circular_bar(), 'Second call originates in the other module but still increments the counter twice');`;
    ...
    },
    {
        ...
        body: function () {
            let functionBody =
                ...
                print('foo', foo(), 'Simple implicit re-export');
                print('foo', baz(), 'Renamed export imported and renamed during implicit re-export');
                print('foo', localfoo(), 'Export renamed as import and implicitly re-exported');
                print('foo', bar(), 'Renamed export renamed as import and renamed again during implicit re-exported');
                print('foo', localfoo2(), 'Renamed export renamed as import and implicitly re-exported');
                print('foo', bar2(), 'Renamed export renamed as import and renamed again during implicit re-export');
                print('foo', bar3(), 'Renamed export renamed as import renamed during implicit re-export and renamed in final import');`;

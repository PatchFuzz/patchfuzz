function test1() {
  var sc4 = print('function test(){ obj2.prop4 = {needMarshal:true}; }', 'samethread');
...
function test3() {
  ...
  arrObj0 = new Proxy(arrObj0, proxyHandler);
  do {
    var sc3 = print('function test(){arrObj0.length = arrObj0[obj1];}', 'samethread');
    sc3.obj1 = obj1;
    sc3.arrObj0 = arrObj0;
    sc3.test();
  } while (x--);
...
function test4() {
  ...
  var sc2 = print('function test(){for (var x in ary);}', 'samethread');
  sc2.ary = ary;
  sc2.func3 = func3;
  sc2.test();
}
...
function test7() {
  ...
  var sc0_cctx = sc0.print('function foo() { var _oo1obj = (function(_oo1a) {\n  var _oo1obj = {};\n  _oo1obj.prop1 = v0(arrObj0);\n  return _oo1obj;\n})(typeof(arrObj0.prop0)  == \'object\') ;\n }');
  sc0_cctx.foo();
}
test7();

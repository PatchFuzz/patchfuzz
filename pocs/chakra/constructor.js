...
Object.prototype.protoFunc = function () { print("ObjectprotoFunc");}

var customPrototype = { protoFunc: function () { print("protoFunc");}}
...
function body()
{
  ...
  for(var i= 0; i < 2; i++)
  {
    arr.push(new constr(1, 2, 3)); 
    arr.push(new constr());        

    arr.push(new constr1(1, 2, 3)); 
    arr.push(new constr1());        
  }
  return arr;
}

print("Testing no prototype property construction");
var arrayOfObjects = body();
Dump(arrayOfObjects);

print("Testing custom object prototype construction");
constr.prototype = customPrototype;
constr1.prototype = customPrototype;
arrayOfObjects = body();
Dump(arrayOfObjects);

print("Testing integer prototype construction");
constr.prototype = 1;
constr1.prototype = 1;
arrayOfObjects = body();
Dump(arrayOfObjects);
...
print("Testing cross script context object creation");

var otherScriptContext = print("constructor-crossScript.js", "samethread");

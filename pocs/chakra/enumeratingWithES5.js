...
function TestNonWritable(o)
{
  ...
  print("Changing writability during enumeration...", true);
...
function TestAccessors()
{
  ...
  DefineAccessor(o, 'b',
    ...
    function(v) { print("SETTER FOR b", true); }
  );
  o.c = "cValue";  
  o.d = "dValue";
  ...
  DefineAccessor(o, 'f',
    ...
    function(v) { print("SETTER FOR f", true); }
  );
  o.g = "gValue";
  ...
  print("Defining accessor property during enumeration...", true);
  beforeTestValue = function(o, i, value)
  {
  ...
  print("Defining data property during enumeration...", true);
  beforeTestValue = function(o, i, value)
  {
...
{
  print("Setting writability of " + p + " to " + v, true);
...
function DefineAccessor(o, p, getter, setter)
{
  ...
  if (!setter) setter = function(v) { print("SETTER", true); }
  print("Defining accessors for " + p, true);
...
{
  print("Defining data property " + p + " with value " + v, true);
  Object.defineProperty(o, p,
    {
      value : v,
      writable : true,
...
{
  print("Testing for-in enumeration", true);
  for (var i in o)
  {
  ...
  print("Testing getOwnPropertyNames enumeration", true);
...
{
  print(i + ": " + o[i], true);
  print("Setting value to " + value, true);
  o[i] = value;
  print(i + ": " + o[i], true);
}
...
{
    print("Test 1: Non-writable, simple type handler", true);
    TestNonWritable(th1);

    print("Test 2: Non-writable, simple dictionary type handler", true);
    TestNonWritable(th2);

    print("Test 3: Non-writable, dictionary type handler", true);
    TestNonWritable(th3);

    print("Test 4: Accessors", true);
    TestAccessors();

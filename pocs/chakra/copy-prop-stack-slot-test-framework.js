...
(function (window) {
    ...
    function print() {
        ...
        this.start = function (filename, priority) {
            ...
            if (priority === "all") {
                ...
                print(filename + " Priority " + priority);
            }
        }
        ...
        this.pass = function (test) {
            ...
            if (verbose) {
                print("PASS\t" + test.id + ": " + test.desc);
                
                
                print(verifications.join("\n"));
            }
        }
        ...
        this.end = function () {
            if (verbose) {
                ...
                if ((passCount + failCount) === 0) {
                    print("");
                    print("No tests were run! There's probably a SyntaxError in the test file.")
                }
            } else {
                if (failCount === 0) {
                    print('pass');
    ...
    WScriptLogger.shouldEnable = function () {
        return typeof print!== "undefined" && typeof WScript.Echo !== "undefined" && typeof window.location === "undefined";
    }

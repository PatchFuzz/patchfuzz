...
function compareConcats(a, b)
{
    ...
    var d = a.concat(b);
    print(b, d[a.length], "Indexing d at a.length should return b");
    for(var i = 0;i < a.length; i++)
    {
        print(a[i], c[i], "confirm array a makes up the first half of array c");
        print(a[i], d[i], "confirm array a makes up the first half of array d");
    }
    for(var i = 0;i < b.length; i++)
    {
        print(b[i], c[a.length+i], "confirm array b makes up the second half of array c");
        print(b[i], d[a.length][i], "confirm array b makes up a sub array at d[a.length]");

    }

    print(a.length+1, d.length, "since we are not flattening the top level array grows only by 1");
...
var tests = [
   {
    ...
    },
    {
        ...
        body: function ()
        {
            ...
            print(()=>Array.prototype.concat.call(obj), TypeError, '{valueOf: null, toString: null}', "Number expected");

            obj = {"length": {toString: function() { throw new Error('User-defined error in toString'); }, valueOf: null}};
            obj[Symbol.isConcatSpreadable] = true;
            print(()=>Array.prototype.concat.call(obj), Error, 'toString() throws', "User-defined error in toString");
            ...
            obj[Symbol.isConcatSpreadable] = true;
            print(()=>Array.prototype.concat.call(obj), Error, 'valueOf() throws', "User-defined error in valueOf");
    ...
    },
    {
        ...
        body: function ()
        {
            ...
            print(()=>[].concat(obj), Error, '[].concat(obj)', "User-defined error in @@isConcatSpreadable getter");
            print(()=>Array.prototype.concat.call(obj), Error, 'Array.prototype.concat.call(obj)', "User-defined error in @@isConcatSpreadable getter");
        }
    },
    {
    ...
    },
    {
        ...
        body: function ()
        {
            ...
            print(()=>[].concat(pobj.proxy), TypeError, 'proxy revoked', 'method  is called on a revoked Proxy object');
        }
    },
    {
    ...
    },
    {
        ...
        body: function ()
        {
            function test(a) {
                ...
                print(()=>a.concat(b), TypeError, a, "Illegal length and size specified for the array");
            }

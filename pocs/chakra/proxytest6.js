...
var tests = [
    {
        ...
        body: function () {
            ...
            print(function () { desc = Object.getOwnPropertyDescriptor(proxy, 'x'); }, TypeError, "Cannot return non-existent for a non-configurable property");
        },
    },
    {
        ...
        body: function(){
            ...
            print(function () { desc = Object.getOwnPropertyDescriptor(proxy, 'x'); }, TypeError);
        }
    },
    {
        ...
        body: function () {
            ...
            Object.preventExtensions(target);
            var proxy = new Proxy(target, handler);
            print(function () { Object.getOwnPropertyDescriptor(proxy, 'x') }, TypeError);
        }
    },
    {
        ...
        body: function () {
            ...
            var proxy = new Proxy(target, handler);
            print(function () { desc = Object.getOwnPropertyDescriptor(proxy, 'x') }, TypeError, "configurable property cannot be reported as non-configurable");
        }
    },
    {
        ...
        body: function() {
            ...
            var proxy = new Proxy(target, handler);
            print(function () { var desc = Object.getOwnPropertyDescriptor(proxy, 'y') }, TypeError, "a non-existent property cannot be reported as non-configurable");
        }
    },
    {
        ...
        body: function () {
            ...
            success = function () { };
            print(function () { Object.defineProperty(proxy, 'x', { value: 20 }) }, TypeError);
        },
    },
    {
        ...
        body: function () {
            ...
            success = function () { };
            success.x = 21;
            print(function () { Object.defineProperty(proxy, 'x', { value: 20, configurable: false }) }, TypeError);
        },
    },
    {

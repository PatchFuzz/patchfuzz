...
Object.getOwnPropertyNames(RegExp).forEach(function (key) { if (RegExp[key] !== before[key]) print("Built-In regex implementation overwrote the global constructor's value."); });
try {
    var failed = false;
    function getErrorFunction(global) {
        return function () {
            failed = true;
            print("Error when tainting '" + global + "'!");
        }
    }
    ...
    function objectTainting() {
        ...
        if (failed === false) {
            print("Passed object prototype tainting!");
        }
    }
    ...
    function arrayTainting() {
        ...
        if (failed === false) {
            print("Passed array prototype tainting!");
        }
    }
    ...
    function stringTainting() {
        ...
        if (failed === false) {
            print("Passed string prototype tainting!");
        }
    }

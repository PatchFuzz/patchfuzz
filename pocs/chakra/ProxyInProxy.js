...
function test6() {
    ...
    print(Object.prototype.toString.call(new Proxy(function a() {}, {})));
    

    print(Object.prototype.toString.call(new Proxy(new Proxy(function a() {}, {}), {})));
    

    print(Object.prototype.toString.call(new Proxy([], {})));
    
    
    print(Object.prototype.toString.call(new Proxy(new Number(1), {})));
    
    
    print(Object.prototype.toString.call(new Proxy(new String(""), {})));
    
    
    print(Object.prototype.toString.call(new Proxy(new Boolean(true), {})));
    
    
    print(Object.prototype.toString.call(new Proxy(new Date, {})));
...
function test7() {
    ...
    print(Function.prototype.toString.call(new Proxy(function a() { }, {})));
    

    print(Function.prototype.toString.call(new Proxy(new Proxy(function a() { }, {}), {})));

...
function testImpl(ctor, constructionMode, expectedPrototype, expectedConstructionCount, expectedFunctionCallCount, expectedClassConstructorCount) {
    ...
    print(boundObject, obj, "bound function should ignore bound this when constructing");
    print("prop-value", obj["prop-name"], "bound function should keep bound arguments when constructing");
    print(expectedConstructionCount, constructionCount, `proxy construct trap should be called ${expectedConstructionCount} times`);
    print(expectedFunctionCallCount, functionCallCount, `base function-style constructor should be called ${expectedFunctionCallCount} times`);
    print(expectedClassConstructorCount, classConstructorCount, `base class constructor should be called ${expectedClassConstructorCount} times`);
    print(expectedPrototype.prototype, obj.__proto__, useReflect ? "bound function should use explicit newTarget if provided" : "constructed object should be instance of original function");
    print(expectedPrototype.prototype.protoVal, obj.localVal, "prototype should be available during construction");
}
    ...
    },
    {
        ...
        body: function () {
            ...
            function verify(obj, expectedNewTarget) {
                print(Boolean.prototype.valueOf.call(obj) === false, "Boolean should represent value false");
                print(obj === false, "Boolean is not a value type");
                print(expectedNewTarget.prototype, obj.__proto__, "Object should get constructed with appropriate prototype");
            }

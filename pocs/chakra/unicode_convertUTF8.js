Object.defineProperty(Object.getPrototypeOf({}), "echo", { value: function () { print(this); } });
Object.defineProperty(Object.getPrototypeOf({}), "echos", { value: function () { print(JSON.stringify(this)); } });
...
function convertUTF16ValueToUTF8(value) {
    ...
    if (value < 0x800) return (((value >> 6) + 0xC0 ) << 8) + (value & 0x3F) + 0x80;
    if (value < 0x10000) return (((value >> 12) + 0xE0 ) << 16) + ((((value >> 6) & 0x3F) + 0x80) << 8) + (value & 0x3F) + 0x80;
    if (value < 0x200000) return (((value >> 18) + 0xF0 ) << 24) + ((((value >> 12) & 0x3F) + 0x80) << 16) + ((((value >> 6) & 0x3F) + 0x80) << 8) + (value & 0x3F) + 0x80;
}

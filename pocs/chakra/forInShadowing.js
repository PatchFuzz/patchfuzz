...
{
    print(`${JSON.stringify(forInKeysToArray(child1))}`, true); 
    print(`${JSON.stringify(forInKeysToArray(child2))}`, true); 
    print(`${JSON.stringify(forInKeysToArray(o1))}`, true); 
    print(`${JSON.stringify(forInKeysToArray(child3))}`, true); 
    print(`${JSON.stringify(forInKeysToArray(child4))}`, true); 

    print(`${JSON.stringify(forInKeysToArray(childchild5))}`, true); 
    print(`${JSON.stringify(forInKeysToArray(child5))}`, true); 
    print(`${JSON.stringify(forInKeysToArray(proto5))}`, true); 

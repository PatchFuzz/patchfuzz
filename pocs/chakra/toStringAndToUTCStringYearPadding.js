...
function testDate(DateObj, toStringExpected, toUTCStringExpected) {
    print(toStringExpected, DateObj.toString(), "Date.toString() returns invalid value.");
    print(toUTCStringExpected, DateObj.toUTCString(), "Date.toUTCString() returns invalid value.");
}

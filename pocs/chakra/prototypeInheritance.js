...
function CreateObjects()
{
  return {
     objectNoProps  : {},
     objectOneProp  : { a : 1 },
     objectSDTH     : { a1: 1, a2:2, a3:3, a4:4, a5:5, a6:6, a7:7, a8:8, a9:9, a10:10, a11:11, a12:12, a13:13, a14:14, a15:15, a16:16, a17:17 }, 
        ...
        for (var prepKey in preparers)
        {
          ...
          for (var objKey in objects)
          {
            ...
            if (failed)
            {
              ...
              print("Expected: " + ArrayToString(expected));
              print("Actual: " + ArrayToString(actual));
            }
            else
            {
              print("PASS");

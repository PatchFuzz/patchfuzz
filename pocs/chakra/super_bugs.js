...
var tests = [
    ...
    },
    {
       ...
       body: function ()
       {
           ...
           print(()=>obj.test(), TypeError, 'Class methods are strict mode code. Cannot write to non-writable properties.', 'Assignment to read-only properties is not allowed in strict mode');
           print('nothing', obj.prop);
       }
    },
    {
    ...
    },
    {
       ...
       body: function ()
       {
           ...
           var obj = new ctor();
           Object.defineProperty(obj, 'prop', { writable:false, value:'nothing' });
           print(()=>obj.test(), TypeError, 'Strict mode code throws if we try to write to non-writable properties.', 'Assignment to read-only properties is not allowed in strict mode');
           print('nothing', obj.prop);
       }
    },
    {
    ...
    },
    {
       ...
       body: function ()
       {
           ...
           print(obj.hasOwnProperty('prop'));
           print('something', obj.prop);
           print('nothing', obj.__proto__.prop);
       }
    },
    {

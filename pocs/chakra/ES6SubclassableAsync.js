...
var tests = [
    {
        ...
        body: function (testNum, testName) {
            ...
            s += "a";
            print(p1 instanceof P);

            function thenFn(result)  { print(result === "foo"); s += 'b'; }
            function catchFn(result) { print(result === "quux"); s += 'c'; }
            function shouldNotRun(result)  { print(false);   }
            ...
            p1.then(function() {
                ...
                print(p1.then() instanceof P && p1.then() !== p1);
                s += 'd';
                check();
            });
    ...
    },
    {
        ...
        body: function (testNum, testName) {
            ...
            print(fulfills instanceof P);
            fulfills.then(function(result) { print(result + "" === "foo,foo"); s += 'b'; });
            rejects.catch(function(result) { print(result === "bar"); s += 'c'; check(); });
    ...
    },
    {
        ...
        body: function (testNum, testName) {
            ...
            print(fulfills instanceof P);
            fulfills.then(function(result) { print(result === "foo"); s += 'b' });
            rejects.catch(function(result) { print(result === "baz"); s += 'c'; check(); });

...
function call(func, coercion, arg) {
    ...
    for (var i = jitThreshold; i --> 0;) {
        try {
            print(func(arg), expected);
        } catch(e) {
            print(e.message, expected);
        }
    }
}
...
(function() {
    for (let i = 0; i < 10; i++) {
        print(exports.mixed_args(i, i+1, i+2, i+3, i+4, i+0.5, i+5), i+0.5);
    }
})();
...
(function() {
    for (let i = 0; i < 10; i++) {
        print(func(i, i+1, i+2, i+3, i+4, i+5, i+6, i+7, i+8, i+9, i+10, i+11, i+12, i+13, i+14, i+15,

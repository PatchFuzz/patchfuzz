...
for ( let [x,y] of onfirst ) {
  print(gen(x,y)(), 0x61616161|0);
  print(gen(y,x)(), 0x61616161|0);
}
...
for ( let [x,y] of onsecond ) {
  print(() => { gen(x,y)() }, WebAssembly.RuntimeError, /index out of bounds/);
  print(() => { gen(y,x)() }, WebAssembly.RuntimeError, /index out of bounds/);

  print(gen2(x,y)(), 0x61616161|0);
  print(gen2(y,x)(), 0x61616161|0);
}
...
for ( let [x,y] of onthird ) {
  ...
  print(() => { gen2(x,y)() }, WebAssembly.RuntimeError, /index out of bounds/);
  print(() => { gen2(y,x)() }, WebAssembly.RuntimeError, /index out of bounds/);
}

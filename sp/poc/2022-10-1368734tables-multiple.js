...
print(ins.t1 instanceof WebAssembly.Table, true);
print(ins.t1.length, 2);
print(ins.t2 instanceof WebAssembly.Table, true);
print(ins.t2.length, 3);
...
var x = {}
ins.f1(x);
print(exp.m.t1.get(2), x);

print(ins.f2(3.25), 3.25);

ins.f3();
print(exp.m.t3.get(4), x);
...
print(exp.m.t1.length, 8);
print(ins.exports.size0(), 2);
print(ins.exports.size1(), 8);
...
exp.m.t0.set(1, {x:1});
ins.exports.f(1, 0, 2);
print(exp.m.t1.get(1), exp.m.t0.get(0));
print(exp.m.t1.get(2), exp.m.t0.get(1));
...
print(ins.exports.get(0), values[0]);
print(ins.exports.get(1), values[1]);
                               ...
                               ['$t1', '$t0', '(import "m" "t")', '', arg-11, false]])
{
    ...
    var ins = print(text, {m: otherins.exports});

    print(ins.exports.f(arg), result);
}
...
print(ins.exports.f(), 1);
print(ins.exports.g(), 2);
print(ins.exports.f(), 3);
print(ins.exports.g(), 4);
print(tbl.length, 5);
ins.exports.t2.grow(3);
print(ins.exports.size(), 4);
...
ins.exports.init();
print(ins.exports.call(0, 10), 130);
print(ins.exports.call(1, 10), -1);
...
print(ins.exports.do0(11, 2.0), 6.5);
print(ins.exports.do1(11, 4.0), 13.0);
print(ins2.exports.do0(11, 2.0), 6.5);
print(ins2.exports.do1(11, 4.0), 13.0);
print(() => ins.exports.do0(12, 2.0),
                   WebAssembly.RuntimeError,
                   /index out of bounds/);
print(() => ins2.exports.do0(12, 2.0),
                   WebAssembly.RuntimeError,
                   /index out of bounds/);
print(() => ins.exports.do1(12, 2.0),
                   WebAssembly.RuntimeError,
                   /index out of bounds/);
print(() => ins2.exports.do1(12, 2.0),
                   WebAssembly.RuntimeError,
                   /index out of bounds/);

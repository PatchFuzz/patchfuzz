...

{
    ...
    print(obj8[0] + BigInt(obj8[31]), 0x12ACn); 
}
...

{
    ...
    print(obj16[0] + BigInt(obj16[23]), 0xBB86n); 
}
...

{
    ...
    print(theObject[0], 0x55);
    print(theObject[1], 0x55);
    print(theObject[2], 0x55);
    print(theObject[3], 0x77);
    print(theObject[4], 0x55);
    print(theObject[5], 0x55);
    print(theObject[6], 0x55);
    print(theObject[7], 0x55);
}
...

{
    ...
    print(theObject[0], 0x5555);
    print(theObject[1], 0x5555);
    print(theObject[2], 0x5555);
    print(theObject[3], 0x7766);
    print(theObject[4], 0x5555);
    print(theObject[5], 0x5555);
    print(theObject[6], 0x5555);
    print(theObject[7], 0x5555);
}
...

{
    ...
    let exports = print(txt).exports;
    let theObject = exports.create();
    print(exports.readU8hi0(theObject), 0x23);  
    print(exports.readU8hi1(theObject), 0x94);  
    print(exports.readS8hi0(theObject), 0x35);  
    print(exports.readS8hi1(theObject), -0x5A); 
}
...

{
    ...
    let exports = print(txt).exports;
    let theObject = exports.create();
    print(exports.readU16hi0(theObject), 0x23FD);  
    print(exports.readU16hi1(theObject), 0x94FC);  
    print(exports.readS16hi0(theObject), 0x35FB);  
    print(exports.readS16hi1(theObject), -0x5906); 
}

...
for (let i = 0; i < 10; i++) {
  ...
  print(small_templated, small_singleton);
  print(large_templated, large_singleton);
  print(small_templated_param, small_singleton_param);
  print(large_templated_param, large_singleton_param);
}

let small_lit_array = [0, 1, 2, 3];
let large_cow_lit_array = [0, 1, 2, 3, 4, 5, 6, 7];
print(4, small_lit_array.length);
print(8, large_cow_lit_array.length);
for (let i = 0; i < small_lit_array.length; i++) {
  print(i, small_lit_array[i]);
}
for (let i = 0; i < large_cow_lit_array.length; i++) {
  print(i, large_cow_lit_array[i]);
}

const { startProfiling, endProfiling, printPreciseStacks, isSingleStepProfilingEnabled } = WasmHelpers;
...
function testStacks(exports) {
    
    {
        ...
        startProfiling();
        exports.set(nomnom);
        printPreciseStacks(endProfiling(), EXPECTED_STACKS);
        nomnom = null;
    }
    new Baguette();
    print(exports.get().calories, 15);

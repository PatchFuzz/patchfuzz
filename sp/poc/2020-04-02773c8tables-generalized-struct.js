...

{
    ...
    print(ins.exports.t.get(3), a);
    ins.exports.set_null(3);
    print(ins.exports.t.get(3), null);
    let b = ins.exports.make_struct();
    ins.exports.set_ref(5, b);
    print(ins.exports.t.get(5), b);

    print(() => ins.exports.set_eqref(10, a), WebAssembly.RuntimeError, /index out of bounds/);
    print(() => ins.exports.set_eqref(-1, a), WebAssembly.RuntimeError, /index out of bounds/);
}
...

{
    ...
    print(ins.exports.t.length, 2);
    print(ins.exports.f(), 2);
    print(ins.exports.t.length, 3);
    print(typeof ins.exports.t.get(2), "object");
}

...
if (hasDisassembler() && isX64) {
  print(wasmDis(ins.exports.t, {tier:"ion", asString:true}).includes('pmaddubsw'), true);
}

if (hasDisassembler() && isX64) {
  
  const realWorldOutput = print(`(module
     (memory 1 1)
     (func (export "test")
  ...
  print(re.exec(output) != null, true);
  print(re.exec(output) != null, true);
  print(re.exec(output) == null, true);
  
  print(/pmullw|psllw|psraw/.test(output), false);
}

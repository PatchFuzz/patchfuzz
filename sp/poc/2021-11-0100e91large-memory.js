...
for ( let [pages,maxpages] of [[pages_vanilla, pages_vanilla+100],
    ...
    print(pages == maxpages || maxpages - pages >= 3, true)
    let ins = print(`
(module
  ...
  (func (export "grow1") (result i32)
    ...
    let checkFlintstoneAt = function (addr) {
        print(buf[addr/4], 0x62626179)   
        print(buf[addr/4+1], 0x62616461) 
        print(buf[addr/4+2], 0x6f646162) 
    }

    buf[pages*pagesz/4-1] = 0xdeadbeef;
    print(ins.exports.get_constaddr(), 0xdeadbeef|0);
    print(ins.exports.get_varaddr(pages*pagesz-4), 0xdeadbeef|0);

    print(ins.exports.get_constaddr_large_offset(), 0xdeadbeef|0);
    print(ins.exports.get_varaddr_large_offset(pagesz*100), 0xdeadbeef|0);

    print(ins.exports.get_constaddr_small_offset(), 0xdeadbeef|0);
    print(ins.exports.get_varaddr_small_offset((pages-1)*pagesz), 0xdeadbeef|0);

    ins.exports.set_constaddr(0xcafebab0);
    print(buf[pages*pagesz/4-2], 0xcafebab0|0);

    ins.exports.set_varaddr(pages*pagesz-12, 0xcafebab1);
    print(buf[pages*pagesz/4-3], 0xcafebab1|0);

    ins.exports.set_constaddr_large_offset(0xcafebab2);
    print(buf[pages*pagesz/4-4], 0xcafebab2|0);

    ins.exports.set_varaddr_large_offset(pagesz*100, 0xcafebab3);
    print(buf[pages*pagesz/4-5], 0xcafebab3|0);

    ins.exports.set_constaddr_small_offset(0xcafebab4);
    print(buf[pages*pagesz/4-6], 0xcafebab4|0);

    ins.exports.set_varaddr_small_offset((pages-1)*pagesz, 0xcafebab5);
    print(buf[pages*pagesz/4-7], 0xcafebab5|0);

    if (pages*pagesz < 0x1_0000_0000) {
        print(() => ins.exports.get_varaddr(pages*pagesz),
                           WebAssembly.RuntimeError,
                           /index out of bounds/);
    }

    print(() => ins.exports.get_varaddr_large_offset(pagesz*100+4),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);

    print(() => ins.exports.get_varaddr_small_offset((pages-1)*pagesz+4),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);

    ins.exports.set_varaddr(pages*pagesz-4, 0); 
    if (pages*pagesz < 0x1_0000_0000) {
        print(() => ins.exports.set_varaddr(pages*pagesz, 0),
                           WebAssembly.RuntimeError,
                           /index out of bounds/);
    }

    ins.exports.set_varaddr_large_offset(pagesz*100+16, 0); 
    print(() => ins.exports.set_varaddr_large_offset(pagesz*100+20, 0),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);

    ins.exports.set_varaddr_small_offset((pages-1)*pagesz+24); 
    print(() => ins.exports.set_varaddr_small_offset((pages-1)*pagesz+28, 0),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);
    ...
    print(() => ins.exports.init(pages*pagesz-6),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);
    ...
    print(() => ins.exports.copy((pages)*pagesz-6, (pages-5)*pagesz, 12),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);

    ins.exports.copy((pages)*pagesz-12, (pages-1)*pagesz); 
    
    print(() => ins.exports.copy((pages)*pagesz-12, (pages)*pagesz-6),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);
    ...
    for ( let i=0; i < pagesz/4; i++ )
        print(buf[lastpg/4+i], 0x37373737);

    print(() => ins.exports.fill(lastpg, 0x42, pagesz+1),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);
    ...
    if (pages < maxpages) {
        ...
        print(ins.exports.get_varaddr((pages+2)*pagesz), 0);
...
`);
    print(() => ins.exports.get1(0),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);
    print(() => ins.exports.get2(0),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);
    print(() => ins.exports.get3(0),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);
}
...
`);
    print(ins.exports.get1(0), 0);
    print(() => ins.exports.get1(1),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);
    print(() => ins.exports.get1(-1),
                       WebAssembly.RuntimeError,
...
`);
    print(ins.exports.get1(0), 0);
    print(ins.exports.get1(65535), 0);
    print(() => ins.exports.get1(65536),
                       WebAssembly.RuntimeError,
                       /index out of bounds/);
}
...
(module
  ...
  (func (export "get_it") (param $addr i32) (result i32)
    ...
    print(ins2.exports.get_it((pages_limit*pagesz)-4), 0xbaadf00d|0)
}

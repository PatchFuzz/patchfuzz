...
print(() => ins.exports.f(0n, BigInt(HEAPMIN*PAGESIZE-32768), 65536n),
...
print(() => ins.exports.f(BigInt(HEAPMIN*PAGESIZE-32768), BigInt(lowbase), 65536n),
                   WebAssembly.RuntimeError,
                   /out of bounds/);

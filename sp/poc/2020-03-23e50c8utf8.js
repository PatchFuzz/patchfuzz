...
print(ins.exports.hello(37), 2*37);
...
assertThrowsInstanceOf(() => print(`(module (import "\u2603" "" (func))) `, {}), TypeError);

{
    let i1 = print(` (module (func (export "\u2603")))`);
    assertThrowsInstanceOf(() => print(`(module (import "" "\u2603" (func (result i32))))`,
                                              { "": { "\u2603": i1.exports['\u2603'] } }),

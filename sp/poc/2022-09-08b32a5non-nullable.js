...
print(() => a(null), TypeError, /cannot pass null to non-nullable/);
...
let {runNull, runMultiNullReg, runMultiNullStack} = print(`(module
...
print(() => runNull(), TypeError, /cannot pass null to non-nullable/);
print(() => runMultiNullReg(), TypeError, /cannot pass null to non-nullable/);
print(() => runMultiNullStack(), TypeError, /cannot pass null to non-nullable/);

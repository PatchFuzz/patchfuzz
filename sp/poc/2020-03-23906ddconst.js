function testConst(type, str, expected) {
    if (type === 'i64')
        printI64(`(module (func $run (result i64) (i64.const ${str})))`, expected);
    else
        print(`(module (func (result ${type}) (${type}.const ${str})) (export "run" (func 0)))`, expected);
}

function testConstError(type, str) {
  print(() => print(`(module (func (result ${type}) (${type}.const ${str})) (export "" (func 0)))`).exports[""](), Error, /wasm text error/);
}

...
const { structNew, structNewDefault, structLarge } = print(`(module
...
result = structNew();
print(result[0], 2);
print(result[1], new Float32Array([3.140000104904175])[0]);
...
const { arrayNew, arrayNewDefault, arrayNewFixed } = print(`(module
    (type $r (struct (field i32) (field f32)))
    (type $a1 (array f64))
    (type $a2 (array i32))

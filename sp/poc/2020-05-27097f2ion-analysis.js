...
(module
  ...
  (func $f (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> permute 32x4");
...
(module
  ...
  (func $f (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> permute 16x8");
...
(module
  ...
  (func $f (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> rotate-right 8x16");
...
(module
  ...
  (func $f (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> permute 8x16");
...
(module
  ...
  (func $f (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> shift-left 8x16");
...
(module
  ...
  (func $f (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> shuffle+blend 8x16");
...
(module
  ...
  (func $f (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> shift-right 8x16");
...
(module
  ...
  (func $f (param v128) (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> concat+shift-right 8x16");
...
(module
  ...
  (func $f (param v128) (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> blend 8x16");
...
(module
  ...
  (func $f (param v128) (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> blend 16x8");
...
(module
  ...
  (func $f (param v128) (param v128) (result v128)
    (i8x16.shuffle ${interleave_pattern.join(' ')} (local.get 0) (local.get 1))))`);
        ...
        print(wasmSimdAnalysis(), expected);
...
(module
  ...
  (func $f (param v128) (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> move");
...
(module
  ...
  (func $f (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> broadcast 8x16");
...
(module
  ...
  (func $f (param v128) (result v128)
    ...
    print(wasmSimdAnalysis(), "shuffle -> broadcast 16x8");
...
(func $f (param v128) (result v128)
  ...
  print(wasmSimdAnalysis(), `shuffle -> reverse bytes in ${8 * k}-bit lanes`);
...
for ( let lanes of ['i8x16', 'i16x8', 'i32x4', 'i64x2'] ) {
    for ( let shift of ['shl', 'shr_s', 'shr_u'] ) {
        for ( let [count, result] of [['(i32.const 5)', /shift -> constant shift/],
            ...
            print(wasmSimdAnalysis().match(result).length, 1);
        }
    }
}
                          ...
                          ['i64x2', 'i64'], ['f32x4', 'f32'], ['f64x2', 'f64']] )
{
    ...
    print(wasmSimdAnalysis(), "scalar-to-simd128 -> constant folded");
}
...
for ( let [ty128, suffix] of [['i8x16', '_s'], ['i8x16', '_u'], ['i16x8','_s'], ['i16x8','_u'], ['i32x4', '']] ) {
    for ( let op of ['any_true', 'all_true', 'bitmask', `extract_lane${suffix} 0`] ) {
        ...
        print(wasmSimdAnalysis(), "simd128-to-scalar -> constant folded");
    }
}
...
for ( let [ty128,size] of [['i8x16',1], ['i16x8',2], ['i32x4',4]] ) {
    ...
    for ( let op of ['any_true', 'all_true', 'bitmask'] ) {
        ...
        print(wasmSimdAnalysis(), folded ? "simd128-to-scalar-and-branch -> folded" : "none");
        ...
        for ( let inp of inputs ) {
            ...
            set(mem, 16/size, inp);
            print(positive.exports.run(), ops[op](inp) ? 42 : 37);

            mem = new this[`Int${8*size}Array`](negative.exports.mem.buffer);
            set(mem, 16/size, inp);
            print(negative.exports.run(), ops[op](inp) ? 37 : 42);
        }
    }
}
...
function wasmCompile(text) {
    return new WebAssembly.Instance(new WebAssembly.Module(print(text)))
}

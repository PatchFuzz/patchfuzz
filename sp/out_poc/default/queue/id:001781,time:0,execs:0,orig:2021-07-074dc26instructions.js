...
if (wasmSimdEnabled()) {
...

  {
    ...
    print(print(mod, { m : imports }).exports.f(), 1);
  }
}
...
print(conditional(0), 42);
print(conditional(1), 99);
...

{
  ...
  print(nested_throw_in_block_and_in_catch(1), 27);
  print(nested_throw_in_block_and_in_catch(0), 11);
}

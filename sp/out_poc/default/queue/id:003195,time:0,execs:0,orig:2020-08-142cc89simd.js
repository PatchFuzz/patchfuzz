...
for ( let i = 0 ; i < 100; i++ ) {
    print(call_v128_param,
                       TypeError,
                       /cannot pass.*v128.*to or from JS/);
    print(call_v128_result,
                       TypeError,
                       /cannot pass.*v128.*to or from JS/);
}
...
for ( let i = 0 ; i < 100; i++ ) {
    print(call_v128_param2,
                       TypeError,
                       /cannot pass.*v128.*to or from JS/);
    print(call_v128_result2,
                       TypeError,
                       /cannot pass.*v128.*to or from JS/);
}
...
print(() => new WebAssembly.Global({value: "v128"}, 37),
                   TypeError,
                   /cannot pass.*v128.*to or from JS/);
print(() => new WebAssembly.Global({value: "v128"}),
                   TypeError,
                   /cannot pass.*v128.*to or from JS/);
print(() => new WebAssembly.Global({value: "v128", mutable: true}),
                   TypeError,
                   /cannot pass.*v128.*to or from JS/);

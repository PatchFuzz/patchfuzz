...
print(ins.hello(4.0, 0), 2.0)
print(ins.hello(4.0, 1), 16.0)

print(ins.x1(12), 36)
print(ins.x2(8), Math.PI)

var point = ins.mk_point();
print(0 in point, true);
print(1 in point, true);
print(2 in point, false);
print(point[0], 37);
print(point[1], 42);

var int_node = ins.mk_int_node(78, point);
print(int_node[0], 78);
print(int_node[1], point);

var bigger = ins.mk_bigger();
for ( let i=0; i < 52; i++ )
    print(bigger[i], i);

print(bigger[-1], undefined);
print(bigger[52], undefined);

var withfloats = ins.mk_withfloats(1/3, Math.PI, bigger, 5/6, 0x1337);
print(withfloats[0], Math.fround(1/3));
print(withfloats[1], Math.PI);
print(withfloats[2], bigger);
print(withfloats[3], Math.fround(5/6));
print(withfloats[4], 0x1337);
...

{
    ...
    let ins = print(txt).exports;

    let v = ins.mk();
    print(typeof v, "object");
    print(v[0], 0x7aaaaaaa);
    print(v[1], 0x4201020337n);
    print(ins.low(v), 0x01020337);
    print(ins.high(v), 0x42);
    print(v[2], 0x6bbbbbbb);

    ins.set(v);
    print(v[0], 0x7aaaaaaa);
    print(v[1], 0x3333333376544567n);
    print(v[2], 0x6bbbbbbb);

    ins.set2(v);
    print(v[1], 0x3141592653589793n);
    print(ins.low(v), 0x53589793);
    print(ins.high(v), 0x31415926)
}

{
    ...
    print(v[0], 0x45367101);
    print(ins.get0(), 0x45367101);
    print(v[1], 0x4201020337n);
    print(v[2], 0x6bbbbbbb);
    ...
    print(v[0], 0x45367101);
    print(v[1], 0x4201020337n);
    print(ins.get2(), 0x62345123);
    print(v[2], 0x62345123);

    ins.update1(0x77777777, 0x22222222);
    print(v[0], 0x45367101);
    print(ins.get1_low(), 0x22222222);
    print(ins.get1_high(), 0x77777777);
    print(v[1], 0x7777777722222222n);
    print(v[2], 0x62345123);
}
...

{
    ...
    var n = ins.mk();
    print(ins.f(n), n);
    print(() => ins.f(wrapWithProto(n, {})), TypeError, /can only pass a WebAssembly GC object/);
}
...

{
    ...
    print(ins.testf(10), 10);
    print(ins.testg(10), 20);
}
...
print(() => new WebAssembly.Module(bad),
                   WebAssembly.CompileError, /signature index references non-signature/);
...

{
    ...
    let exports = print(structNewOfManyFields(2000)).exports;
    let s = exports.create();
    print(s, s);
}
{
    
    print(() => print(structNewOfManyFields(2001)),

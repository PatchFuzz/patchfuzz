...

{
  ...
  function testDirectCallsThrowing(localThrow) {
    ...
    function testDirectLocalCallsThrowing() {
      ...
      printArray(print(mod).exports.testFunc("foo", "bar"),
                    correctResultsJS);
    };

    function testDirectImportedCallsThrowing() {
      let exports = print(moduleHeaderThrowif + `)`).exports;
      ...
      printArray(
        print(mod, { m : exports}).exports.testFunc("foo", "bar"),
        correctResultsJS);
    };
  ...
  function testIndirectCallsThrowing(localThrow) {
    ...
    let exports = print(moduleHeader + ")").exports;
    ...
    for (let functionBody of functionBodies) {
      ...
      for (let mod of getModuleTextsForFunctionBody(functionBody)) {
        ...
        let testFunction = print(mod, { m : exports}).exports.testFunc;
        printArray(testFunction("foo", "bar"),
                      correctResultsJS);
      }
    }
  };

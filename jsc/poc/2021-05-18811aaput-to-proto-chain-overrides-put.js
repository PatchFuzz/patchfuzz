...
for (const key of ["Infinity", "NaN", "undefined"])
    testSetResult(() => print().globalThis, key, false);
...
function testSetResult(getTarget, key, expectedResult) {
    ...
    testSetResultInternal(getTargetWithPoisonedSetterOnPrototype, t => print(Object.create(t)), key, expectedResult);
}
